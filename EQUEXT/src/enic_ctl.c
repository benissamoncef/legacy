/*E*/
/*Fichier : $Id: enic_ctl.c,v 1.4 1995/05/29 14:38:00 volcic Exp $      Release : $Revision: 1.4 $        Date : $Date: 1995/05/29 14:38:00 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME : EQUEXT
------------------------------------------------------
* MODULE TENIC * FICHIER enic_ctl.c
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
* Module de gestion cyclique de la tache TENIC, gtc Nice
*
------------------------------------------------------
* HISTORIQUE :
*
...
* Mismer.D	version 1.4	18 Mai 1995	: Lancement demande relecture des flags cycliquement
*
------------------------------------------------------*/
...
static char *version = "$Id: enic_ctl.c,v 1.4 1995/05/29 14:38:00 volcic Exp $ : enic_ctl" ;
...
------------------------------------------------------*/
{
   static char *version = "$Id: enic_ctl.c,v 1.4 1995/05/29 14:38:00 volcic Exp $ : et_controle" ;
...
------------------------------------------------------*/
{
   static char *version = "$Id: enic_ctl.c,v 1.4 1995/05/29 14:38:00 volcic Exp $ : et_init" ;
    ...
    */
         ...
         /* Construction du message d'arret */
            sprintf ( pl_message, "%s %s %s", XZEXC_DEMANDE_INIT, vg_SockTEXA0, XZEXC_FIN_MSG_SOCK );
         /* Envoie de la demande d'init */
         sem_wait(&vg_semaphore); 
         if ( write ( vg_SockTEXA0, pl_message, strlen (pl_message) ) == XDC_NOK )
         { 
...
------------------------------------------------------*/
{
   static char *version = "$Id: enic_ctl.c,v 1.4 1995/05/29 14:38:00 volcic Exp $ : et_sortir" ;
   ...
   */
    ...
    */
         ...
         /* Construction du message d'arret */
            sprintf ( pl_message, "%s %s %s", XZEXC_DEMANDE_ARRET, vg_SockTEXA0, XZEXC_FIN_MSG_SOCK );
