/*E*/
/*Fichier : $Id: enic_cfg.c,v 1.8 1997/05/06 19:54:31 mismer Exp $      Release : $Revision: 1.8 $        Date : $Date: 1997/05/06 19:54:31 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME : EQUEXT
------------------------------------------------------
* MODULE TENIC * FICHIER enic_cfg.c
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
*   Module de configuration de la tache TENIC, gtc Nice
*
------------------------------------------------------
* HISTORIQUE :
*
...
* Mismer.D	version 1.5	17 Mar 1995	:
* Fontaine.C	version 1.6	22 Mai 1995	: Reprise entete, historique
* Mismer.D	version 1.7	02 Oct 1995	: Ajout fichier de memorisation des sequences actuelles
* Mismer.D      version 1.8     24 Avr 1997     : Ajout colonne alerte (DEM/1421)
*
------------------------------------------------------*/
...
static char *version = "$Id: enic_cfg.c,v 1.8 1997/05/06 19:54:31 mismer Exp $ : enic_cfg" ;
...
------------------------------------------------------*/
{
   static char *version = "$Id: enic_cfg.c,v 1.8 1997/05/06 19:54:31 mismer Exp $ : et_lire_config_GTCNice " ;

   int				vl_ValRet = XDC_OK;
   int				vl_Fd;
   char 			pl_PathEtFic[XDC_PATH_ABS_SIZE];
   XDY_Texte			pl_LigneFich;
   ENIC_DONNEES_Tube		vl_DonneesTube = {0},
   				*pl_DonCrtTube,
   				*pl_DonSupTube;
   ENIC_DONNEES_Echangeur	vl_DonneesEch  = {0},
   				*pl_DonCrtEch,
   				*pl_DonSupEch;
...
------------------------------------------------------*/
{
   static char *version = "$Id: enic_cfg.c,v 1.8 1997/05/06 19:54:31 mismer Exp $ : et_lire_config_Sequence" ;

   int				vl_ValRet = XDC_OK;
   int				vl_Fd;
   char 			pl_PathEtFic[XDC_PATH_ABS_SIZE];
   XDY_Texte			pl_LigneFich;
   ENIC_DONNEES_Sequence	vl_DonneesSeq = {0};
   short			vl_NumMaitre;
...
------------------------------------------------------*/
{
   static char *version = "$Id: enic_cfg.c,v 1.8 1997/05/06 19:54:31 mismer Exp $ : et_lire_config_Capt_Pan " ;

   int				vl_ValRet = XDC_OK;
   int				vl_Fd;
   char 			pl_PathEtFic[XDC_PATH_ABS_SIZE];
   XDY_Texte			pl_LigneFich;
   ENIC_DONNEES_Panneau		vl_DonneesPn   = {0};
   ENIC_DONNEES_Capteur		vl_DonneesCapt = {0};
   short			vl_NumMaitre,
   				vl_TypeMaitre;
...
------------------------------------------------------*/
{
static char *version = "$Id: enic_cfg.c,v 1.8 1997/05/06 19:54:31 mismer Exp $ : et_wfic_derniere_seq " ;
int                     vl_Fd 	     = 0;
int 			vl_Compteur  = 0;
...
------------------------------------------------------*/
{
static char *version = "$Id: enic_cfg.c,v 1.8 1997/05/06 19:54:31 mismer Exp $ : et_rfic_derniere_seq " ;
int                     vl_Fd 	      = 0;
char                    pl_NomFichier[XDC_PATH_ABS_SIZE];
XDY_Texte		pl_LigneFich  = "";
int 			vl_Index      = 0;
