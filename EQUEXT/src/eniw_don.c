/*E*/
/*Fichier :  $Id: eniw_don.c,v 1.2 2002/04/24 08:47:23 gesconf Exp $      Release : $Revision: 1.2 $        Date : $Date: 2002/04/24 08:47:23 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR
------------------------------------------------------
* SOUS-SYSTEME : EQUEXT
------------------------------------------------------
* MODULE TENIW * FICHIER eniw_don.c
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
*  Module de gestion des donnees de la tache TENIW, gtc Nice
*
------------------------------------------------------
* HISTORIQUE :
*
...
static char *version = "$Id: eniw_don.c,v 1.2 2002/04/24 08:47:23 gesconf Exp $      : eniw_don" ;

/* declaration de fonctions internes */

/* definition de fonctions externes */

EX_FONCT_INSERER   (  ENIW_DONNEES_Tube, et_ins_liste_Tube, pg_debutTube, Numero, Suivant, Suivant )
EX_FONCT_INSERER   (  ENIW_DONNEES_Echangeur, et_ins_liste_Ech, pg_debutEchangeur, NumeroDemiEch, Suivant, Suivant )
...
void	et_ins_liste_Capteur ( ENIW_DONNEES_Capteur * 	pa_Capt,
			       XDY_Eqt		 	va_NumTube )

/*
* ARGUMENTS EN ENTREE :
*
*  ENIW_DONNEES_Capteur * 	pa_Capt		: Structure capteur a inserer
...
------------------------------------------------------*/
{
   static char *version = "$Id: eniw_don.c,v 1.2 2002/04/24 08:47:23 gesconf Exp $      : et_ins_liste_Capteur " ;
   ENIW_DONNEES_Tube *		pl_DonCrtTube;
   ENIW_DONNEES_Capteur	*	pl_ExEnr;
   ENIW_DONNEES_Capteur	*	pl_Capt;
   ENIW_DONNEES_Capteur	*	pl_Enr;	
      ...
      for ( pl_DonCrtTube = pg_debutTube; pl_DonCrtTube != NULL; pl_DonCrtTube = pl_DonCrtTube->Suivant)
      {
         ...
         if ( pl_DonCrtTube->Numero == va_NumTube )
         {
            ...
            if ( ( pl_Capt = (ENIW_DONNEES_Capteur *)malloc ( sizeof(ENIW_DONNEES_Capteur) ) ) != NULL)
            {
...
void	et_ins_liste_Sequence ( ENIW_DONNEES_Sequence *	pa_Sequence,
...
* ARGUMENTS EN ENTREE :
*
*  ENIW_DONNEES_Sequence * 	pa_Sequence	: Structure sequence a inserer
...
------------------------------------------------------*/
{
   static char *version = "$Id: eniw_don.c,v 1.2 2002/04/24 08:47:23 gesconf Exp $      : et_ins_liste_Sequence " ;
   ENIW_DONNEES_Tube *		pl_DonCrtTube;
   ENIW_DONNEES_Echangeur *	pl_DonCrtEch;
   ENIW_DONNEES_Sequence *	pl_ExEnr;
   ENIW_DONNEES_Sequence *	pl_Sequence;
   ENIW_DONNEES_Sequence *	pl_Enr;	
   ENIW_DONNEES_Sequence *	pl_Debut  = NULL;
   int				vl_Trouve = XDC_NOK;	
	...
	if ( va_TypeMaitre == XDC_EQT_TUBE )
   	...
   	{
            /*A si l'alocaltion memoire est ok */
            if ( ( pl_Sequence = (ENIW_DONNEES_Sequence *)malloc ( sizeof(ENIW_DONNEES_Sequence) ) ) != NULL)
            {
               /*A copie enegistrement */
...
void	et_ins_liste_Panneau ( ENIW_DONNEES_Panneau *	pa_Panneau,
			       XDY_Eqt			va_NumMaitre,
			       XDY_Mot			va_TypeMaitre )
...
* ARGUMENTS EN ENTREE :
*
*  ENIW_DONNEES_Panneau * 	pa_Panneau	: Structure panneau a inserer
...
------------------------------------------------------*/
{
   static char *version = "$Id: eniw_don.c,v 1.2 2002/04/24 08:47:23 gesconf Exp $      : et_ins_liste_Panneau " ;
   ENIW_DONNEES_Tube *		pl_DonCrtTube;
   ENIW_DONNEES_Echangeur *	pl_DonCrtEch;
   ENIW_DONNEES_Panneau	*	pl_ExEnr;
   ENIW_DONNEES_Panneau	*	pl_Panneau;
   ENIW_DONNEES_Panneau	*	pl_Enr;	
   ENIW_DONNEES_Panneau	*	pl_Debut  = NULL;
   int				vl_Trouve = XDC_NOK;	
	...
	switch ( va_TypeMaitre )
   	...
   	{
            /*A si l'alocaltion memoire est ok */
            if ( ( pl_Panneau = (ENIW_DONNEES_Panneau *)malloc ( sizeof(ENIW_DONNEES_Panneau) ) ) != NULL)
            {
               /*A copie enegistrement */
...
void	et_sup_liste_Capteur ( ENIW_DONNEES_Capteur *	pa_DebCapteur )

/*
* ARGUMENTS EN ENTREE :
*
*   ENIW_DONNEES_Capteur **	pa_DebCapteur : Debut liste de Capteur a supprimer
*
* ARGUMENTS EN SORTIE :
*   aucun
*
...
------------------------------------------------------*/
{
   static char *version = "$Id: eniw_don.c,v 1.2 2002/04/24 08:47:23 gesconf Exp $      : et_sup_liste_Capteur " ;
   ENIW_DONNEES_Capteur	*	pl_ExCapt;
   ENIW_DONNEES_Capteur	*	pl_Capt;
...
void	et_sup_liste_Sequence ( ENIW_DONNEES_Sequence *	pa_DebSequence )

/*
* ARGUMENTS EN ENTREE :
*
*   ENIW_DONNEES_Sequence *	pa_DebSequence : Debut liste de Sequence a supprimer
*
* ARGUMENTS EN SORTIE :
*   aucun
*
...
------------------------------------------------------*/
{
   static char *version = "$Id: eniw_don.c,v 1.2 2002/04/24 08:47:23 gesconf Exp $      : et_sup_liste_Sequence " ;
   ENIW_DONNEES_Sequence *	pl_ExSequence;
   ENIW_DONNEES_Sequence *	pl_Sequence;
...
void	et_sup_liste_Panneau ( ENIW_DONNEES_Panneau *	pa_DebPanneau )

/*
* ARGUMENTS EN ENTREE :
*
*   ENIW_DONNEES_Panneau *	pa_DebPanneau : Debut liste de Panneau a supprimer
*
* ARGUMENTS EN SORTIE :
*   aucun
*
...
------------------------------------------------------*/
{
   static char *version = "$Id: eniw_don.c,v 1.2 2002/04/24 08:47:23 gesconf Exp $      : et_sup_liste_Panneau " ;
   ENIW_DONNEES_Panneau	*	pl_ExPanneau;
   ENIW_DONNEES_Panneau	*	pl_Panneau;
