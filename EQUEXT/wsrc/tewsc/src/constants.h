...
#ifndef TEWST_CONSTANTS_H
#define TEWST_CONSTANTS_H
...
#define TEWSC_SUCCESS 1
#define TEWSC_FAILURE 0
#define TEWSC_ERROR -1

#define TEWST_SUCCESS 1
#define TEWST_FAILURE 0
#define TEWST_ERROR -1
