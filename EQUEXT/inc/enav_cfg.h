/*E*/
/* Fichier : $Id: enav_cfg.h,v 1.4 1996/09/30 18:46:29 mismer Exp $      Release : $Revision: 1.4 $        Date : $Date: 1996/09/30 18:46:29 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR
------------------------------------------------------
* SOUS-SYSTEME : EQUEXT
------------------------------------------------------
* MODULE TENAV * FICHIER enav_cfg.h
------------------------------------------------------
...
* HISTORIQUE :
*
* Nagiel.E	07 Sep 1994	: Creation
* Nagiel.E	21 Dec 1994	:
* Fontaine.C	18 Mai 1995	: Reprise entete, historique
* Mismer.D	version 1.4	11 Sep 1996	: Ajout periode variable en fonction NB eqt (RADT_W)
*
------------------------------------------------------ */
