...
#  Compile les procedures stockees de xzau sur le serveur d'un site donne.
#
#############################################################################
#
# Service rendu
...
Fichier_Compil="xzau${Site_Compil}"
...
{
    echo " "
    echo -e '\E[47;31m'"\033[1mla commande xzau_make.sh a ete  modifiee.\033[0m"
    echo " xzau_make.sh appelle  le script ${Nom_Prog} qui prend en compte les specificites de l'environement de developpement et celles de production."
    echo " " 
    ...
    echo " xzau_make.sh appelle  le script (${Nom_Prog} ) pour prendre en compte les specificites de l'environement de developpement.(directive DEV)"
    ...
    echo -e '\E[47;34m'"\033[1m Exemple: procedure pour le site CI plateforme de DEV  (via xzau_make.sh): $0 CI DEV \033[0m"
    ...
    echo " ${Nom_Prog} genere le fichier .sql a livrer en production via le script sae_liv <num_jira> -p xzau_make.sh  <site> "
...
echo "if exists (select 1 from sysobjects where name = 'XZAU' and type = 'P')" >> ${fic_tmp_c}

echo "drop procedure XZAU " >> ${fic_tmp_c} 
echo "go" >> ${fic_tmp_c}
...
# les groupees
cat_proc "xzau01sp.prc"
cat_proc "xzau02sp.prc"
cat_proc "xzau03sp.prc"
cat_proc "xzau04sp.prc"
cat_proc "xzau05sp.prc"
cat_proc "xzau06sp.prc"
cat_proc "xzau07sp.prc"
cat_proc "xzau08sp.prc"
cat_proc "xzau09sp.prc"

cat_proc "xzau10sp.prc"
cat_proc "xzau11sp.prc"
cat_proc "xzau12sp.prc"
cat_proc "xzau13sp.prc"
cat_proc "xzau14sp.prc"
cat_proc "xzau15sp.prc"
cat_proc "xzau16sp.prc"

# degroupee
sae_dev_make_prc "xzau111sp.prc" $Site_Compil $cible
