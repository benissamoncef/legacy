/*E*/
/*Fichier :  $Id: xzao998sp.prc,v 1.4 2018/07/11 10:59:55 pc2dpdy Exp $      Release : $Revision: 1.4 $        Date : $Date: 2018/07/11 10:59:55 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao998sp.prc
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
* < Module Objets Statiques >
* JBL		Juillet 2008	: Pas d'erreur lors de la suppression
            ...
            begin
                ...
                */
                ...
                begin
                    ...
                    /*A
                    ** La sequence n'existe pas dans EQT_SEQ_GTC_VEN
                    */
                    ...
                    begin
                        ...
                        /*A
                        ** Creation positionne =>
                        ** Insertion de la sequence dans la table EQT_SEQ_GTC_VEN
                        */
                        ...
                        begin
                            ...
                            insert into CFG..EQT_SEQ_GTC_VEN ( numero,
                                                               nom,
                                                               type,
                                                               supprime )
                                                      values ( @vl_NumS,
                    ...
                    begin
                        ...
                        ** Suppression de la sequence de la table EQT_SEQ_GTC_VEN
                        */
                            delete CFG..EQT_SEQ_GTC_VEN
                            where  type       = @va_Type_in
                              and  numero     = @vl_NumS     
					...
					begin
						...
						*/
						...
						begin
							...
							insert into CFT..EQT_SEQ_GTC_VEN ( numero,
															   nom,
															   type,
															   supprime )
													  values ( @vl_NumS,
