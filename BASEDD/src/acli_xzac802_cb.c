/*E*/
/* Fichier : $Id: acli_xzac802_cb.c,v 1.1 2012/07/04 11:39:26 pc2dpdy Exp $      Release : $Revision: 1.1 $        Date : $Date: 2012/07/04 11:39:26 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE ACLI_XZAN34CB * FICHIER acli_xzac802_cb.c
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
* < description rapide des fonctions remplies par le module
*   et reference au dossier de conception generale
*   ou reference au fichier acli_xzac802_cb.h >
*
------------------------------------------------------
* HISTORIQUE :
*
...
static char *	version = "@(#)acli_xzac802_cb.c	1.1 12/05/06 : acli_xzac802_cb" ;
...
void acli_xzac802_cb 	(T_IPC_CONN 	va_Cnx,
...
------------------------------------------------------*/
{
	...
	XZST_03EcritureTrace(XZSTC_WARNING,"IN : acli_xzac802_cb : debut d execution ");
        ...
        if ( !TipcMsgRead(pa_Data -> msg,
			...
			NULL))
        {
	  XZST_03EcritureTrace ( XZSTC_WARNING," Impossible de lire le MSG XDM_EPRV_AUTO");
	  return;
        }

	XZST_03EcritureTrace(XZSTC_WARNING,"IN : acli_xzac802_cb : evt(%d/%d), poste(%d), prv (%d), site (%d), site prv(%d)",
			vl_numero,
			vl_cle,
			vl_poste,
			vl_identifiant,
        ...
        if (XZAC802_Commande_PRV(vl_numero, /*num evt*/
                              vl_cle,    /*cle evt*/
							  ...
							  vl_distance,
                              vl_district,
                              &vl_numaction_out)             /*site d'origine de l'action*/
                               != XDC_OK)
        XZST_03EcritureTrace(XZSTC_FONCTION,"acli_xzac_802_cb : pb appel a XZAC802_Commande_PRV");


	XZST_03EcritureTrace(XZSTC_FONCTION,"OUT : acli_xzac_802_cb : Fin d execution ");
