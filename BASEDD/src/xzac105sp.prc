/*E*/
/*Fichier :  $Id: xzac105sp.prc,v 1.11 2021/03/08 14:37:49 pc2dpdy Exp $      Release : $Revision: 1.11 $        Date : $Date: 2021/03/08 14:37:49 $
------------------------------------------------------
...
/*-----------------------------------------------------
* Service rendu
* Action de configuration des equipements domaine Exploitation par sequence.
* 
* Sequence d'appel
* SP	XZAC105_Commande_Seq_EXP
* 
* Arguments en entree
...
as
	...
	begin
		...
		if @vl_serveur_pra= XDC_SQLVC
			exec @vl_Status= SQL_DM.PRC..XZAC;105 @va_NumEvt_in,@va_CleEvt_in,@va_PosteOperateur_in,@va_TypEqt_in,@va_NumEqt_in,@va_HeureLancement_in,@va_Manuelle_in,@va_Priorite_in,@va_DistanceEvt_in,@va_Sequence_in,@va_NumeroAction_out, @va_NomSiteLocal_in, XDC_OUI

		/* modif ABE du 05-02-2020 : sp�cificit� toulon */
		else if @vl_serveur_pra= XDC_SQLDP
			exec @vl_Status= SQL_DS.PRC..XZAC;105 @va_NumEvt_in,@va_CleEvt_in,@va_PosteOperateur_in,@va_TypEqt_in,@va_NumEqt_in,@va_HeureLancement_in,@va_Manuelle_in,@va_Priorite_in,@va_DistanceEvt_in,@va_Sequence_in,@va_NumeroAction_out, @va_NomSiteLocal_in, XDC_OUI

		else if @vl_serveur_pra= XDC_SQLCI
			exec @vl_Status= SQL_CI.PRC..XZAC;105 @va_NumEvt_in,@va_CleEvt_in,@va_PosteOperateur_in,@va_TypEqt_in,@va_NumEqt_in,@va_HeureLancement_in,@va_Manuelle_in,@va_Priorite_in,@va_DistanceEvt_in,@va_Sequence_in,@va_NumeroAction_out, @va_NomSiteLocal_in, XDC_OUI
	...
	/*A inserer l'actio EXPLOITATION */
	begin tran
	...
	begin
		...
		*/
		if @vl_Site = XDC_CI
			exec @vl_Status = TASRV_CI...ACRP45 @va_TypEqt_in,
												@va_NumEqt_in,
			                                    @va_Sequence_in,
			                                    @va_NumeroAction_out
		else /* PRA
		     ...
		     */
		    if @vl_Site = XDC_DP
				exec @vl_Status = TASRV_DP...ACRP45 @va_TypEqt_in,
													@va_NumEqt_in, 
													@va_Sequence_in,
													@va_NumeroAction_out
		else /* PRA
		     ...
		     */
		    if @vl_Site = XDC_VC
				exec @vl_Status = TASRV_VC...ACRP45 @va_TypEqt_in,
													@va_NumEqt_in,
													@va_Sequence_in,
													@va_NumeroAction_out
		else 
		    if @vl_Site = XDC_CA
				exec @vl_Status = TASRV_CA...ACRP45 @va_TypEqt_in,
													@va_NumEqt_in,
													@va_Sequence_in,
													@va_NumeroAction_out
