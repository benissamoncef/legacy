...
#  Compile les procedures stockées de XZAS sur le serveur d'un site donné.
#
#############################################################################
#
# Service rendu
...
echo "#include \"$includes/XDMICG/inc/xzasc.h\""	>>  ${fic_tmp_c}
...
sae_dev_make_prc "xzas53sp.prc"  $Site_Compil $cible

sae_dev_make_prc "xzas13sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh


sae_dev_make_prc "xzas53sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh




# procedures que sur secteur et CI ou CA ( donc pas HIS)
if [[ "$Site_Compil" != "HIS" ]]
then
    sae_dev_make_prc "xzas10sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh
    sae_dev_make_prc "xzas11sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh
    sae_dev_make_prc "xzas12sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh
    sae_dev_make_prc "xzas14sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh
    sae_dev_make_prc "xzas50sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh
    sae_dev_make_prc "xzas51sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh
    cat_proc "xzas22sp.prc"
    sae_dev_make_prc "xzas54sp.prc"  $Site_Compil $cible
else  
    # procedures que sur HIS
    sae_dev_make_prc "xzas15sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh
...
then
    sae_dev_make_prc "xzas52sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh
    sae_dev_make_prc "xzas62sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas60sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas70sp.prc"  $Site_Compil $cible
#    sae_dev_make_prc "xzas56sp.prc"  $Site_Compil $cible
#    sae_dev_make_prc "xzas57sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas58sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas59sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas80sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas81sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas82sp.prc"  $Site_Compil $cible 
    sae_dev_make_prc "xzas83sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas84sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas85sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas86sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas87sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas88sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas91sp.prc"  $Site_Compil $cible
    sae_dev_make_prc "xzas100sp.prc" $Site_Compil $cible
    sae_dev_make_prc "xzas101sp.prc" $Site_Compil $cible
#   sae_dev_make_prc "xzas102sp.prc" $Site_Compil $cible 
#   sae_dev_make_prc "xzas103sp.prc" $Site_Compil $cible   code commente dans aweb	
    sae_dev_make_prc "xzas540sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh
...
if [[ "$Site_Compil" = "DP" ]]
then
sae_dev_make_prc "xzas56sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh
sae_dev_make_prc "xzas57sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh
sae_dev_make_prc "xzas540sp.prc"  $Site_Compil $cible    # issue de xzasb_make.sh
fi 
