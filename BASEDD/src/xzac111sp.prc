/*E*/
/*Fichier :  $Id: xzac111sp.prc,v 1.2 2020/10/13 17:15:46 pc2dpdy Exp $      Release : $Revision: 1.2 $        Date : $Date: 2020/10/13 17:15:46 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER xzac111sp.prc
------------------------------------------------------
...
* 
* Sequence d'appel
* SP	XZAC111_Fin_Commande_Manuelle_ECL
* 
* Arguments en entree
...
create procedure XZAC;111
	...
	where  EXP..ACT_GEN.numero = @va_NumAction_in and 
		   ...
		   EXP..ACT_GTC_ECL.actio = @va_NumAction_in and 
		   EXP..ACT_GTC_ECL.sit = @vl_Site
