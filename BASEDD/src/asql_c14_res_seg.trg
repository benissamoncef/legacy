/*E*/
/*  Fichier : $Id: asql_c14_res_seg.trg,v 1.1 1995/02/15 19:48:55 gaborit Exp $      Release : $Revision: 1.1 $        Date : $Date: 1995/02/15 19:48:55 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER asq_c01_res_seg.trg
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
* 
* trigger sur la table RES_SEG
*
------------------------------------------------------
* HISTORIQUE :
*
...
/*-----------------------------------------------------
* Service rendu
* Annuler l'update sur un segment si aucune modification
