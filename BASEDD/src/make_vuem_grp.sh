...
#  Compile les procedures stockees de XZAR sur le serveur d'un site donne.
#
#############################################################################
#
# Service rendu
...
Fichier_Compil="vuem${Site_Compil}"
...
{
    echo " "
    echo -e '\E[47;31m'"\033[1mla commande xzar_make.sh a ete  modifiee.\033[0m"
    echo " xzar_make.sh appelle  le script ${Nom_Prog} qui prend en compte les specificites de l'environement de developpement et celles de production."
    echo " " 
    ...
    echo " xzar_make.sh appelle  le script (${Nom_Prog} ) pour prendre en compte les specificites de l'environement de developpement.(directive DEV)"
    ...
    echo -e '\E[47;34m'"\033[1m Exemple: procedure pour le site CI plateforme de DEV  (via xzar_make.sh): $0 CI DEV \033[0m"
    ...
    echo " ${Nom_Prog} genere le fichier .sql a livrer en production via le script sae_liv <num_jira> -p xzar_make.sh  <site> "
...
echo "go" >> ${fic_tmp_c}
echo "drop procedure VUEM" >> ${fic_tmp_c}
echo "go" >> ${fic_tmp_c}
...
sae_dev_make_prc "vuem19sp.prc" $Site_Compil $cible

if [[ $1 = "HIS" ]]
then 

    sae_dev_make_prc "vuem01sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem02sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem03sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem04sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem05sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem06sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem07sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem08sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem09sp.prc" $Site_Compil $cible
    
    sae_dev_make_prc "vuem11sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem12sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem14sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem15sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem15bsp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem16sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem18sp.prc" $Site_Compil $cible
    
    sae_dev_make_prc "vuem21sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem22sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem24sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem25sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem26sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem28sp.prc" $Site_Compil $cible
    sae_dev_make_prc "vuem28bsp.prc" $Site_Compil $cible
    
    sae_dev_make_prc "vuem50sp.prc" $Site_Compil $cible

fi

cat_proc "xzar03sp.prc"
