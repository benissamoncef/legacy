/*E*/
/*Fichier :  $Id: xzac632sp.prc,v 1.9 2021/03/08 14:26:36 pc2dpdy Exp $      Release : $Revision: 1.9 $        Date : $Date: 2021/03/08 14:26:36 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER xzac632sp.prc
------------------------------------------------------
...
* LCL         	14/09/20 (20/11/19) : MOVIS DEM-SAE93 1.5
* GRO		12/10/2020 : MOVIS DEM-SAE93 1.51
...
*
* Sequence d'appel
* SP	XZAC632_Commande_Fin_Signalisation
*
* Arguments en entree
...
* 	ACRP632 :	Appeler XZET03 pour commander l'equipement
-----------------------------------------------------------------------*/

use PRC
go

drop procedure XZAC632
go

create procedure XZAC632
...
as
	...
	begin
		 if @vl_serveur_pra = XDC_SQLVC
			 exec @vl_Status = SQL_DM.PRC..XZAC632 @va_TypEqt_in, @va_NumeroTunnel_in, @va_Site_in, @va_HeureLancementFin_in, @va_Manuelle_in, @va_NomSiteLocal_in, XDC_OUI 
		 
		 else if @vl_serveur_pra = XDC_SQLDP
			 exec @vl_Status = SQL_DS.PRC..XZAC632 @va_TypEqt_in, @va_NumeroTunnel_in, @va_Site_in, @va_HeureLancementFin_in, @va_Manuelle_in, @va_NomSiteLocal_in, XDC_OUI 
		 
		 else if @vl_serveur_pra = XDC_SQLCI
		         exec @vl_Status = SQL_CI.PRC..XZAC632 @va_TypEqt_in, @va_NumeroTunnel_in, @va_Site_in, @va_HeureLancementFin_in, @va_Manuelle_in, @va_NomSiteLocal_in, XDC_OUI
...
*/
	...
	begin
		...
		select @vl_Sequence = XDC_ECL_SEQ_RETOUR_NORMAL
		...
		if @vl_Site = XDC_CI
			exec @vl_Status = TASRV_CI...ACRP41 @va_TypEqt_in, @va_NumeroTunnel_in, @vl_Sequence,
				@vl_Commande

		else if @vl_Site = XDC_DP
			exec @vl_Status = TASRV_DP...ACRP41 @va_TypEqt_in, @va_NumeroTunnel_in, @vl_Sequence,
				@vl_Commande

		else if @vl_Site = XDC_VC
			exec @vl_Status = TASRV_VC...ACRP41 @va_TypEqt_in, @va_NumeroTunnel_in, @vl_Sequence,
				@vl_Commande
	
		else if @vl_Site = XDC_CA
			exec @vl_Status = TASRV_CA...ACRP41 @va_TypEqt_in, @va_NumeroTunnel_in, @vl_Sequence,
				@vl_Commande
