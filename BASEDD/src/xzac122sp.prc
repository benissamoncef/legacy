/*E*/
/*Fichier :  $Id: xzac122sp.prc,v 1.3 2010/09/02 09:49:25 gesconf Exp $      Release : $Revision: 1.3 $        Date : $Date: 2010/09/02 09:49:25 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER xzac122sp.prc
------------------------------------------------------
...
* 
* Sequence d'appel
* SP	XZAC122_Lire_Commande_Ventilation
* 
* Arguments en entree
...
drop procedure XZAC122
go

create procedure XZAC122
...
as
	...
	select
			...
			@va_Manuelle_out	= HIS..ACT_GTC_VEN.manuelle,
	...
	where	HIS..ACT_GEN.numero = @va_NumeroAction_in and 
			...
			HIS..ACT_GTC_VEN.actio = @va_NumeroAction_in and 
			HIS..ACT_GTC_VEN.sit = @va_Site_in
	...
	select
		...
		@va_Manuelle_out		= EXP..ACT_GTC_VEN.manuelle,
	...
	where	EXP..ACT_GEN.numero = @va_NumeroAction_in and 
		...
		EXP..ACT_GTC_VEN.actio = @va_NumeroAction_in and 
		EXP..ACT_GTC_VEN.sit = @va_Site_in
	...
	if @vl_NbEnrg = 0
	begin
		exec @vl_Status = SQL_HIS.PRC..XZAC122
					@va_NumeroAction_in,
					@va_Site_in,
