/*E*/
/*  Fichier : $Id: asql_t11_fmc_mnf.trg,v 1.3 2020/11/10 15:58:02 akkaakka Exp $      Release : $Revision: 1.3 $        Date : $Date: 2020/11/10 15:58:02 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  MNFEDD
------------------------------------------------------
* FICHIER asql_t11_fmc_mnf.trg
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
* 
* trigger sur la table FMC_MNF
*
------------------------------------------------------
* HISTORIQUE :
*
...
* mnfe EXP (et HIS au CI)
---------------------------------------------------*/

use EXP
go

drop trigger fmc_mnf_iu_trg
go

create trigger fmc_mnf_iu_trg
on FMC_MNF
for insert,update
as
