...
* JPL	27/11/18 : Ajout directive 'drop procedure'  1.2
------------------------------------------------------*/
...
if exists (select 1 from sysobjects where name = 'XZAU111' and type = 'P')
	drop procedure XZAU111
go


create procedure XZAU111
