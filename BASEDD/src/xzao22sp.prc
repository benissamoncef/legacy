...
declare @vl_PRdebut1 T_PR, @vl_PRFin1 T_PR, @vl_PRInter1 T_PR, @vl_PRInter2 T_PR,
	...
	begin
		...
		exec @vl_Status = PRC..XZAO;22 @va_NumeroAutorouteDeb_in, @va_PRDebut_in, @va_NumeroAutorouteDeb_in, @vl_PRInter1, @vl_Longueur1 output

		
		if @vl_Status != XDC_OK
			return @vl_Status

		exec @vl_Status = PRC..XZAO;22 @va_NumeroAutorouteFin_in, @va_PRFin_in, @va_NumeroAutorouteFin_in, @vl_PR, @vl_Longueur2 output
 ...
 -- select * from #POR2
	...
	/* supprimer les portions n'Åtant pas sur l'autoroute d'intersection */
	delete #POR2 
	from #POR1, #POR2
...
-- select @va_NumeroAutorouteFin_in, @va_PRFin_in, @va_NumeroAutorouteFin_in, @vl_PR
	...
	exec @vl_Status = PRC..XZAO;22 @va_NumeroAutorouteFin_in, @va_PRFin_in, 
 ...
 -- select @va_NumeroAutorouteDeb_in, @va_PRDebut_in, @va_NumeroAutorouteDeb_in, @vl_PR
	...
	exec @vl_Status = PRC..XZAO;22 @va_NumeroAutorouteDeb_in, @va_PRDebut_in, 
