...
#  Compile les procedures stockées de xzan sur le serveur d'un site donné.
#
#############################################################################
#
# Service rendu
...
echo "#include \"$includes/XDMICG/inc/xzanc.h\"" >> ${fic_tmp_c}    
...
sae_dev_make_prc "xzan45sp.prc" $Site_Compil $cible
sae_dev_make_prc "xzan19sp.prc" $Site_Compil $cible

if [[ "$Site_Compil" != "HIS" ]]
then
sae_dev_make_prc "xzan50sp.prc" $Site_Compil $cible	
