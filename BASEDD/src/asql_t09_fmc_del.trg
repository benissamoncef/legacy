/*E*/
/*  Fichier : $Id: asql_t09_fmc_del.trg,v 1.3 2020/11/10 15:58:00 akkaakka Exp $      Release : $Revision: 1.3 $        Date : $Date: 2020/11/10 15:58:00 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  DELEDD
------------------------------------------------------
* FICHIER asql_t09_fmc_del.trg
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
* 
* trigger sur la table FMC_DEL
*
------------------------------------------------------
* HISTORIQUE :
*
...
* dele EXP (et HIS au CI)
---------------------------------------------------*/

use EXP
go

drop trigger fmc_del_iu_trg
go

create trigger fmc_del_iu_trg
on FMC_DEL
for insert,update
as
