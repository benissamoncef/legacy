								/*E*/
/* Fichier : $Id: xzap86sp.prc,v 1.2 2021/07/15 14:26:35 pc2dpdy Exp $        Release : $Revision: 1.2 $        Date : $Date: 2021/07/15 14:26:35 $
------------------------------------------------------
...
* HISTORIQUE :
*
* ABE	07/04/21	: Creation PAU SONO DEM-SAE244
* ABE	07/04/21	: Fix drop PAU SONO DEM-SAE244 1.2
...
declare @vl_Status int, @vl_Site tinyint
	...
	if @vl_Site = XDC_CI
		...
		exec @vl_Status = SQL_CA.PRC..XZAP86
			@va_NumPA_in,
			@va_Ordre_in
