/*E*/
/*Fichier :  $Id: xzac115sp.prc,v 1.2 2020/10/13 17:16:11 pc2dpdy Exp $      Release : $Revision: 1.2 $        Date : $Date: 2020/10/13 17:16:11 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER xzac115sp.prc
------------------------------------------------------
...
* 
* Sequence d'appel
* SP	XZAC115_Fin_Commande_Manuelle_EXP
* 
* Arguments en entree
...
as
	...
	where  EXP..ACT_GEN.numero = @va_NumAction_in and 
		   ...
		   EXP..ACT_GTC_EXP.actio = @va_NumAction_in and 
		   EXP..ACT_GTC_EXP.sit = @vl_Site
