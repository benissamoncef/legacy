/*E*/
/*Fichier :  $Id: xzac110sp.prc,v 1.3 2020/10/13 17:15:40 pc2dpdy Exp $      Release : $Revision: 1.3 $        Date : $Date: 2020/10/13 17:15:40 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER xzac110sp.prc
------------------------------------------------------
...
* LCL	30/03/20   : MOVIS Ajout site local DEM-SAE93 v1.1
-----------------------------------------------------*/
...
* 
* Sequence d'appel
* SP	XZAC110_Fin_Commande_Manuelle_SIG
* 
* Arguments en entree
...
as
	...
	where  EXP..ACT_GEN.numero = @va_NumAction_in and 
		   ...
		   EXP..ACT_GTC_SIG.actio = @va_NumAction_in and 
		   EXP..ACT_GTC_SIG.sit = @vl_Site
	...
	begin tran
		...
		begin
			...
			where  numero = @va_NumAction_in and
			       sit    = @vl_Site and
				   (type   = XDC_ACT_GTC_SIG or type = XDC_ACT_GTC_SIG_ECH)
