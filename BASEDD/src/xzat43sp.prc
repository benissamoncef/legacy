/*E*/
/*Fichier :  $Id: xzat43sp.prc,v 1.2 2021/03/08 13:16:06 pc2dpdy Exp $      Release : $Revision: 1.2 $        Date : $Date: 2021/03/08 13:16:06 $
------------------------------------------------------
...
drop procedure XZAT43
go

create procedure XZAT43
...
as
    ...
    begin
        ...
        where  EXP..ACT_GEN.numero = @va_NumAction_in
          ...
          and  CFG..EQT_GEN.type   = XDC_EQT_ENR
