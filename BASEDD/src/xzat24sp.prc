/*E*/
/*  Fichier : $Id: xzat24sp.prc,v 1.9 2021/03/08 13:36:43 pc2dpdy Exp $      Release : $Revision: 1.9 $        Date : $Date: 2021/03/08 13:36:43 $
------------------------------------------------------
...
* C.T.  19/01/98        : ajout compte rendu des FAC et FAU (1538) (V1.7)
* LCL	21/01/21	: MOVIS PRA DEM-SAE93 1.8
-----------------------------------------------------*/
...
as
	...
	select @vl_Site = numero 
        ...
        where numero=@va_NumAction_in and
	     (type = XDC_ACT_NAV or type = XDC_ACT_FAC or type = XDC_ACT_FAU) and
	...
	where numero = @va_NumAction_in and sit = @vl_Site and 
		(type = XDC_ACT_NAV or type = XDC_ACT_FAC or type = XDC_ACT_FAU)
