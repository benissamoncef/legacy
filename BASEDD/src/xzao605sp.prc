/*E*/
/*Fichier :  $Id: xzao605sp.prc,v 1.3 2018/07/11 10:50:11 pc2dpdy Exp $      Release : $Revision: 1.3 $        Date : $Date: 2018/07/11 10:50:11 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao605sp.prc
------------------------------------------------------
...
/* static char *version = "@(#)xzao605.c    1.1 04/09/07 : xzao605" ; */
...
* SERVICE RENDU : 
*
*  Ajout d'un eqt du  domaine exploitation dans la base
*
------------------------------------------------------
* SEQUENCE D'APPEL :
*/
...
create procedure XZAO;605
    @va_Basedd_in             char(3),
    @va_NomEXP_in             char(10),
...
* VALEUR RENDUE :
*
* Ajout d'un eqt du domaine exploitation en base
* 
* CODE RETOUR :
*
* 0    XDC_OK
...
* FONCTION :
*
* Insertion ou modification dans la table EQT_GTC_EXP (EQUIPEMENT EXPLOITATION)
*
* MECANISMES :
*
------------------------------------------------------
            ...
            begin
                ...
                */
                ...
                begin
                    ...
                    from   CFG..EQT_GEN
                    where  type = XDC_EQT_EXP   and
                           nom  = @va_NomEXP_in
                
                    /*A
                    ** L equipement EXPLOITATION n'existe pas dans EQT_GEN
                    */
                    ...
                    begin
                        ...
                        /*A
                        ** Insertion equipement EXPLOITATION dans la table EQT_GEN
                        */

                        select @vl_Numero = max(numero) 
                        from   CFG..EQT_GEN
                        where  type = XDC_EQT_EXP
                        ...
                        */
                        ...
                        /*A
                        ** Insertion equipement EXPLOITATION dans la table EQT_GTC_EXP
                        */
                    ...
                    begin
                        ...
                        */
                        ...
                        set    maitre      = @vl_Serveur,
                               type_maitre = XDC_MAI_EXP,
                               autoroute   = @vl_Autoroute,
                               PR          = @va_PR_in
                        where  numero      = @vl_NumEXP  and
                               type        = XDC_EQT_EXP and
                               nom         = @va_NomEXP_in
                        ...
                        */
                        ...
                        /*A
                        ** Modification du eqt EXPLOITATION dans la table EQT_GTC_EXP
                        */
                        /* A voir */

                        /*

                        update CFG..EQT_GTC_EXP
                ...
                */   
                ...
                begin
                    ...
                    */
                    ...
                    begin
	                    ...
	                    */
	                    ...
	                    begin
	                        ...
	                        /*A
	                        ** Insertion equipement EXP dans la table EQT_GEN
	                        */
	                ...
	                /*A
	                ** L'equipement EXPLOITATION existe dans EQT_GEN
	                */

	                begin

	                    /*A
	                    ** Modification de l'equipement EXPLOITATION dans la table EQT_GEN
	                    */
	                    ...
	                    */
	                    ...
	                    /*A
	                    ** Modification de l'equipement EXPLOITATION dans la table EQT_GTC_EXP
	                    */

	                    /* A voir */
	                    /*
	                    update CFT..EQT_GTC_EXP
	                    set    adresse_etat        = @va_AdresseEtat_in,
	                           adresse_commande    = @va_AdresseCommande_in,
	                           adresse_discordance = @va_AdresseDiscordance_in,
	                           adresse_telealarme  = @va_AdresseTelealarme_in
