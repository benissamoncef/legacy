/*E*/
/*Fichier :  $Id: xzao986sp.prc,v 1.4 2018/07/11 11:09:39 pc2dpdy Exp $      Release : $Revision: 1.4 $        Date : $Date: 2018/07/11 11:09:39 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao986sp.prc
------------------------------------------------------
		...
		begin
            ...
            */   
            ...
            begin
                ...
                /*A
                ** Verification de l'existence de la sequence dans EQT_SEQ_GTC_VEN
                */
                ...
                /*A
                ** La sequence existe dans EQT_SEQ_GTC_VEN
                */
                ...
                begin
                    ...
                    from   CFG..EQT_GEN
                    where  nom  = @va_NomVEN_in
                      and  type = @va_Type_in
                    /*A
                    ** L equipement du domaine VEN existe dans EQT_GEN
                    */
                    ...
                    begin
                        ...
                        where  type       = @va_Type_in
                          and  equipement = @vl_NumVEN
                          and  sequence   = @vl_NumSeq

                        /*A
                        ** La sequence autorisee du tunnel n'existe pas dans EQT_SQA_GTC_VEN
                        */
                        ...
                        begin
                          ...
                          /*A
                          ** La sequence autorisee n'existe pas dans EQT_SQA_GTC_VEN
                          */
                          ...
                          begin
                             ...
                             /*A 
                             ** Creation non positionne =>
                             ** Suppression de la sequence autorisee dand la table EQT_SQA_GTC_VEN
                             */
