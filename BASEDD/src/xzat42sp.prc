/*E*/
/*Fichier :  $Id: xzat42sp.prc,v 1.2 2021/03/08 13:16:58 pc2dpdy Exp $      Release : $Revision: 1.2 $        Date : $Date: 2021/03/08 13:16:58 $
------------------------------------------------------
...
drop procedure XZAT42
go

create procedure XZAT42
...
as
    ...
    begin
        ...
        where  EXP..ACT_GEN.numero = @va_NumAction_in
          ...
          and  CFG..EQT_GEN.type   = XDC_EQT_VEN
