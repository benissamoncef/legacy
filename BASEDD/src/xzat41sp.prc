/*E*/
/*Fichier :  $Id: xzat41sp.prc,v 1.2 2021/03/08 13:20:37 pc2dpdy Exp $      Release : $Revision: 1.2 $        Date : $Date: 2021/03/08 13:20:37 $
------------------------------------------------------
...
drop procedure XZAT41
go

create procedure XZAT41
...
as
    ...
    begin
        ...
        where  EXP..ACT_GEN.numero = @va_NumAction_in
          ...
          and  CFG..EQT_GEN.type   = XDC_EQT_ECL
