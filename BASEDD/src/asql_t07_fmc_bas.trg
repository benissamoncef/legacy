/*E*/
/*  Fichier : $Id: asql_t07_fmc_bas.trg,v 1.3 2020/11/10 15:57:58 akkaakka Exp $      Release : $Revision: 1.3 $        Date : $Date: 2020/11/10 15:57:58 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER asql_t07_fmc_bas.trg
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
* 
* trigger sur la table FMC_BAS
*
------------------------------------------------------
* HISTORIQUE :
*
...
drop trigger fmc_bas_iu_trg
go

create trigger fmc_bas_iu_trg
on FMC_BAS
for insert,update
as
