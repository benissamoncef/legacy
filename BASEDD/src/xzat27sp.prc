/*E*/
/*  Fichier : $Id: xzat27sp.prc,v 1.2 2021/03/08 13:36:00 pc2dpdy Exp $      Release : $Revision: 1.2 $        Date : $Date: 2021/03/08 13:36:00 $
------------------------------------------------------
...
as
	...
	where numero = @va_NumAction_in and sit = @vl_Site and type = XDC_ACT_PAL
	...
	begin
		...
		update EXP..ACT_GEN set heure_fin  = @va_Horodate_in
		where equipement = @vl_NumEqt and type = XDC_EQT_PAL and sit = @vl_Site and
