/* Fichier : $Id: xzao5771sp.prc
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER XZAO5771sp.prc
------------------------------------------------------
...
if exists (select * from sysobjects where name = 'XZAO5771' and type = 'P')
	drop procedure XZAO5771
go

create procedure XZAO5771
