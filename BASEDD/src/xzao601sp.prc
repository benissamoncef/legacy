/*E*/
/*Fichier :  $Id: xzao601sp.prc,v 1.3 2018/07/11 10:47:19 pc2dpdy Exp $      Release : $Revision: 1.3 $        Date : $Date: 2018/07/11 10:47:19 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao601sp.prc
------------------------------------------------------
...
/* static char *version = "@(#)xzao601.c    1.1 04/09/07 : xzao601" ; */
...
create procedure XZAO;601
    @va_Basedd_in             char(3),
    @va_NomECL_in             char(10),
...
* VALEUR RENDUE :
*
* Ajout d'un eqt du domaine eclairage en base
* 
* CODE RETOUR :
*
* 0    XDC_OK
...
* FONCTION :
*
* Insertion ou modification dans la table EQT_GTC_ECL (EQUIPEMENT ECLAIRAGE)
*
* MECANISMES :
*
------------------------------------------------------
            ...
            begin
                ...
                */
                ...
                begin
                    ...
                    /*A
                    ** L equipement ECLAIRAGE n'existe pas dans EQT_GEN
                    */
                    ...
                    begin
                        ...
                        /*A
                        ** Insertion equipement ECLAIRAGE dans la table EQT_GEN
                        */

                        select @vl_Numero = max(numero) 
                        from   CFG..EQT_GEN
                        where  type = XDC_EQT_ECL
                        ...
                        */
                        ...
                        /*A
                        ** Insertion equipement ECLAIRAGE dans la table EQT_GTC_ECL
                        */
                    ...
                    begin
                        ...
                        */
                        ...
                        set    maitre      = @vl_Serveur,
                               type_maitre = XDC_MAI_ECL,
                               autoroute   = @vl_Autoroute,
                               PR          = @va_PR_in
                        where  numero      = @vl_NumECL  and
                               type        = XDC_EQT_ECL and
                               nom         = @va_NomECL_in
                        ...
                        */
                        ...
                        /*A
                        ** Modification du eqt ECLAIRAGE dans la table EQT_GTC_ECL
                        */
                        /* A voir */

                        /*

                        update CFG..EQT_GTC_ECL
                ...
                */   
                ...
                begin
                    ...
                    */
                    ...
                    begin
	                    ...
	                    */
	                    ...
	                    begin
	                        ...
	                        /*A
	                        ** Insertion equipement ECL dans la table EQT_GEN
	                        */
	                ...
	                /*A
	                ** L'equipement ECLAIRAGE existe dans EQT_GEN
	                */

	                begin

	                    /*A
	                    ** Modification de l'equipement ECLAIRAGE dans la table EQT_GEN
	                    */
	                    ...
	                    */
	                    ...
	                    /*A
	                    ** Modification de l'equipement ECLAIRAGE dans la table EQT_GTC_ECL
	                    */

	                    /* A voir */
	                    /*
	                    update CFT..EQT_GTC_ECL
	                    set    adresse_etat        = @va_AdresseEtat_in,
	                           adresse_commande    = @va_AdresseCommande_in,
	                           adresse_discordance = @va_AdresseDiscordance_in,
	                           adresse_telealarme  = @va_AdresseTelealarme_in
