/*E*/
/*  Fichier : $Id: xzat66sp.prc,v 1.5 2021/02/12 15:59:22 pc2dpdy Exp $        $Revision: 1.5 $        $Date: 2021/02/12 15:59:22 $
-------------------------------------------------------------------------------------------
* ESCOTA * PROJET MIGRAZUR
-------------------------------------------------------------------------------------------
* SOUS-SYSTEME : BASEDD
-------------------------------------------------------------------------------------------
* FICHIER xzat66sp.prc
-------------------------------------------------------------------------------------------
* DESCRIPTION DU MODULE :
*
*  Ajout d'une mise au neutre programmee pour un PMVA donne.
*
-------------------------------------------------------------------------------------------
* HISTORIQUE :
*
* JPL	20/03/13 : Creation (DEM 1061)  1.1
* JPL	21/07/17 : Support de l'indicateur de mode clignotant / alternat (DEM 1230)  1.2
* JPL	14/12/18 : Ajout du type de periode de programmation (DEM 1312)  1.3
* JPL	03/04/19 : Autoriser des programmations de meme type dans une periode, dans des tranches horaires distinctes  1.4
* LCL	22/01/21 : MOVIS PRA DEM-SAE93 1.5
...
* SERVICE RENDU
*
*  Ajoute une ligne de mise au neutre a la table PRG_PMA
*  pour un PMVA donne, s'il n'en existe aucune.
*
-------------------------------------------------------------------------------------------
* SEQUENCE D'APPEL
*
* SP	XZAT66_Programmer_Neutre_PMVA
*
...
* XDY_Ligne_PMV		va_Ligne2_in		:  \
* XDY_Ligne_PMV		va_Ligne3_in		:   > Message a afficher
* XDY_Ligne_PMV		va_Ligne4_in		:  /
* XDY_Ligne_PMV		va_Ligne5_in		: /
* XDY_Ligne_PMV		va_Ligne1_alternat_in	: \
* XDY_Ligne_PMV		va_Ligne2_alternat_in	:  \
* XDY_Ligne_PMV		va_Ligne3_alternat_in	:   > Message alternat
* XDY_Ligne_PMV		va_Ligne4_alternat_in	:  /
* XDY_Ligne_PMV		va_Ligne5_alternat_in	: /
...
* XDC_OBJ_EXISTE    : Une programmation existe pour ce PMVA dans cette periode
* XDC_NOK           
...
* FONCTION :
*
*  Recherche une mise au neutre programmee pour le PMVA indique dans la table PRG_PMA.
...
if exists (select * from sysobjects where name = 'XZAT66' and type = 'P')
	drop procedure XZAT66
go


create procedure XZAT66
	...
	@va_Ligne4_in			T_LIGNE_PMV	= null,
	@va_Ligne5_in			T_LIGNE_PMV	= null,
	@va_Ligne1_alternat_in		T_LIGNE_PMV	= null,
	@va_Ligne2_alternat_in		T_LIGNE_PMV	= null,
	@va_Ligne3_alternat_in		T_LIGNE_PMV	= null,
	@va_Ligne4_alternat_in		T_LIGNE_PMV	= null,
	@va_Ligne5_alternat_in		T_LIGNE_PMV	= null,
...
as
	...
	/*A  pour ce PMVA, dans une periode de meme type non distincte  */
	if exists (select numero from EXP..PRG_PMA
	...
	/*A Ajouter la mise au neutre programmee definie pour ce PMVA */
	insert EXP..PRG_PMA (
		numero,
		debut,
		fin,
