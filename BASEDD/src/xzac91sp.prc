/*E*/
/*  Fichier : $Id: xzac91sp.prc,v 1.3 2020/11/23 13:11:51 pc2dpdy Exp $     Release : $Revision: 1.3 $        Date : $Date: 2020/11/23 13:11:51 $
------------------------------------------------------
* GTIEPROJET MIGRAZUR
------------------------------------------------------
* SOUS-SYSTEME BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzac91.prc
------------------------------------------------------
...
* LCL	23/11/20	: Correction site equipement au lieu de site local 1.2
------------------------------------------------------ */
...
* 
* Sequence d'appel
* SP	XZAC91_Fin_Commande_Manuelle_BAD
* 
* Arguments en entree
...
as
	...
	from EXP..ACT_GEN, EXP..ACT_BAD
	where	EXP..ACT_GEN.numero = @va_NumAction_in and 
		EXP..ACT_GEN.sit = @vl_Site and
		EXP..ACT_BAD.actio = @va_NumAction_in and 
		EXP..ACT_BAD.sit = @vl_Site
