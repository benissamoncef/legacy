/*E*/
/*Fichier :  $Id: xzac112sp.prc,v 1.2 2020/10/13 17:15:53 pc2dpdy Exp $      Release : $Revision: 1.2 $        Date : $Date: 2020/10/13 17:15:53 $
------------------------------------------------------
...
* 
* Sequence d'appel
* SP	XZAC112_Fin_Commande_Manuelle_VEN
* 
* Arguments en entree
...
as
	...
	where  EXP..ACT_GEN.numero = @va_NumAction_in and 
		   ...
		   EXP..ACT_GTC_VEN.actio = @va_NumAction_in and 
		   EXP..ACT_GTC_VEN.sit = @vl_Site
