/*E*/
/*Fichier :  $Id: xzao606sp.prc,v 1.3 2018/07/11 10:50:51 pc2dpdy Exp $      Release : $Revision: 1.3 $        Date : $Date: 2018/07/11 10:50:51 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao606sp.prc
------------------------------------------------------
...
/* static char *version = "@(#)xzao606.c    1.1 04/09/07 : xzao606" ; */
...
* SERVICE RENDU : 
*
*  Ajout d'un eqt du  domaine systeme dans la base
*
------------------------------------------------------
* SEQUENCE D'APPEL :
*/
...
* VALEUR RENDUE :
*
* Ajout d'un eqt du domaine systeme en base
* 
* CODE RETOUR :
*
* 0    XDC_OK
...
* FONCTION :
*
* Insertion ou modification dans la table EQT_GTC_SYS (EQUIPEMENT SYSTEME)
*
* MECANISMES :
*
------------------------------------------------------
            ...
            begin
                ...
                */
                ...
                begin
                    ...
                    from   CFG..EQT_GEN
                    where  type = XDC_EQT_SYS   and
                           nom  = @va_NomSYS_in
                
                    /*A
                    ** L equipement SYSTEME n'existe pas dans EQT_GEN
                    */
                    ...
                    begin
                        ...
                        /*A
                        ** Insertion equipement SYSTEME dans la table EQT_GEN
                        */
                        ...
                        */
                        ...
                        /*A
                        ** Insertion equipement SYSTEME dans la table EQT_GTC_SYS
                        */
                    ...
                    begin
                        ...
                        */
                        ...
                        set    maitre      = @vl_Serveur,
                               ...
                               PR          = @va_PR_in
                        where  numero      = @vl_NumSYS  and
                               type        = XDC_EQT_SYS and
                               nom         = @va_NomSYS_in
                        ...
                        */
                        ...
                        /*A
                        ** Modification du eqt SYSTEME dans la table EQT_GTC_SYS
                        */
                        /* A voir */

                        /*

                        update CFG..EQT_GTC_SYS
                ...
                */   
                ...
                begin
                    ...
                    */
                    ...
                    begin
	                    ...
	                    */
	                    ...
	                    begin
	                        ...
	                        /*A
	                        ** Insertion equipement SYS dans la table EQT_GEN
	                        */
	                ...
	                /*A
	                ** L'equipement SYSTEME existe dans EQT_GEN
	                */

	                begin

	                    /*A
	                    ** Modification de l'equipement SYSTEME dans la table EQT_GEN
	                    */
	                    ...
	                    */
	                    ...
	                    /*A
	                    ** Modification de l'equipement SYSTEME dans la table EQT_GTC_SYS
	                    */

	                    /* A voir */
	                    /*
	                    update CFT..EQT_GTC_SYS
	                    set    adresse_etat        = @va_AdresseEtat_in,
	                           adresse_commande    = @va_AdresseCommande_in,
	                           adresse_discordance = @va_AdresseDiscordance_in,
	                           adresse_telealarme  = @va_AdresseTelealarme_in
