/*E*/
/*X Fichier : $Id: xzau21sp.prc,v 1.2 2018/06/27 17:53:42 devgfi Exp $        $Revision: 1.2 $        $Date: 2018/06/27 17:53:42 $
------------------------------------------------------
...
if exists (select 1 from sysobjects where name = 'XZAU21' and type = 'P')
	drop procedure XZAU21
go


create procedure XZAU21
