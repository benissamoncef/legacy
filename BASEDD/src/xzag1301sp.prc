/*E*/
/*Fichier :  @(#)xzag1301sp.prc	1.2      Release : 1.2        Date : 02/13/08
------------------------------------------------------
...
if exists (select 1 from sysobjects where name = 'XZAG1301' and type = 'P')
	drop procedure XZAG1301
go

create procedure XZAG1301
...
select @vl_Site=@va_Site
	...
	begin
		...
		/*B trace et suppression des enregistrements de SAD_SONO a supprimer */
