/*E*/
/*Fichier : Fichier : $Id: xzao441sp.prc,v 1.3 2019/01/17 18:38:44 pc2dpdy Exp $     Release : $Revision: 1.3 $        Date : $Date: 2019/01/17 18:38:44 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao441sp.prc
------------------------------------------------------
* HISTORIQUE :
*
...
/* static char *version = " $Id: xzao441sp.prc,v 1.3 2019/01/17 18:38:44 pc2dpdy Exp $ $Revision: 1.3 $ $Date: 2019/01/17 18:38:44 $: xzao441" ; */
...
drop procedure XZAO441
go

create procedure XZAO441
  ...
  close pea2
   ...
   for update of doublon, distance
	...
	and PR_debut_zone <= @vl_PR_min
	and PR_fin_zone >=  @vl_PR_min
	order by numero_baf
	   ...
	   /* if ( @vl_autoroute_baf=@va_Autoroute_in and @vl_sens_baf=@va_Sens_in and @vl_PR_baf between @vl_PR_min and @vl_PR_max)
	    ...
	    begin
	      ...
	      begin
	        ...
	        from EXP..EQT_DSP
#endif
	        where type=XDC_EQT_BAF and dernier=1 and equipement=@vl_numero_baf
