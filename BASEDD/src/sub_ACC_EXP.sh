...
if ((($#<1)) || (test $1 != "CI" && test $1 != "DN" && test $1 != "DM" && test $1 != "$NomSitePrimaire" ))
then echo "syntaxe : sub_exp.sh NomSitePrimaire NomSite TypeSitePrimaire NomfichierErreur"
...
tables/sub_create.rab EXP FMC_ACC $NomSitePrimaire $NomSite xx rab
