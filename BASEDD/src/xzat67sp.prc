/*E*/
/*  Fichier : $Id: xzat67sp.prc,v 1.4 2021/02/12 14:46:41 pc2dpdy Exp $        $Revision: 1.4 $        $Date: 2021/02/12 14:46:41 $
-------------------------------------------------------------------------------------------
* ESCOTA * PROJET MIGRAZUR
-------------------------------------------------------------------------------------------
* SOUS-SYSTEME : BASEDD
-------------------------------------------------------------------------------------------
* FICHIER xzat67sp.prc
-------------------------------------------------------------------------------------------
* DESCRIPTION DU MODULE :
*
*  Supprime la mise au neutre programmee d'un PMVA donne.
*
-------------------------------------------------------------------------------------------
* HISTORIQUE :
*
...
* JPL	13/12/18 : Ajout du type de jour en parametre et critere (DEM 1312)  1.3
...
* SERVICE RENDU
*
*  Supprime la mise au neutre programmee d'un PMVA donne dans la table PRG_PMA.
*
-------------------------------------------------------------------------------------------
* SEQUENCE D'APPEL
*
* SP	XZAT67_Supprimer_Neutre_PMVA
*
...
*
* XDC_OK
* XDC_OBJ_AUCUN     : Pas de programmation pour ce PMVA a cette date
* XZAEC_FMC_NON_FIN : FMC attachee non terminee
* XDC_NOK           : PMVA inexistant, incoherence de site
...
* FONCTION :
*
*  Supprime la mise au neutre programmee pour le PMVA indique dans la table PRG_PMA.
...
if exists (select * from sysobjects where name = 'XZAT67' and type = 'P')
	drop procedure XZAT67
go


create procedure XZAT67
...
as
	...
	/*A Rechercher la programmation de mise au neutre du PMVA et la FMC associee */
	...
	/*A Supprimer la mise au neutre programmee du PMVA */
	delete	EXP..PRG_PMA
	where	numero = @va_NumEqt_in
	  and	type_jour = @va_Type_Jour
	  and	@va_HorodateDebut_in between debut and fin
