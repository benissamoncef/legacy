/*E*/
/*Fichier : Fichier : $Id: xzao440sp.prc,v 1.6 2011/03/10 16:14:43 gesconf Exp $     Release : $Revision: 1.6 $        Date : $Date: 2011/03/10 16:14:43 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao440sp.prc
------------------------------------------------------
* HISTORIQUE :
*
* guilhou       21/06/05      : creation  1.1
* JMG	10/05/07	ajout presence_bifurc
* PNI	30/05/07	Renvoi du sens de la zone à la place de du sens du pmva 1.4
* JPL	11/02/11	Gestion du sens et des Pr de debut et fin de l'evenement  1.5
* JPL	11/02/11	Prise en compte de la distance du PMVA a l'autoroute (DEM 953)  1.6
------------------------------------------------------*/
...
/* static char *version = " $Id: xzao440sp.prc,v 1.6 2011/03/10 16:14:43 gesconf Exp $ $Revision: 1.6 $ $Date: 2011/03/10 16:14:43 $: xzao440" ; */
...
if exists (select * from sysobjects where name = 'XZAO440' and type = 'P')
	drop procedure XZAO440
go


create procedure XZAO440
