/*E*/
/*  Fichier : $Id: xzao232sp.prc,v 1.1 2020/06/24 06:17:16 devgfi Exp $        $Revision: 1.1 $        $Date: 2020/06/24 06:17:16 $
-------------------------------------------------------------------------------
* ESCOTA *  PROJET MIGRAZUR / PASTRE
-------------------------------------------------------------------------------
* SOUS-SYSTEME  BASEDD
-------------------------------------------------------------------------------
* MODULE XZAO * FICHIER xzao232sp.prc
-------------------------------------------------------------------------------
...
*  d'un type donne dans le domaine Ventilation.
*
* -----------------------------------------------------------------------------
* SEQUENCE D'APPEL
*
* SP	XZAO232_Seq_Auto_GTC_VEN
*
*
...
if exists (select 1 from sysobjects where name = 'XZAO232' and type = 'P')
	drop procedure XZAO232
go


create procedure XZAO232
	@va_Basedd_in		char(3),
	...
	*/
	...
	begin
		...
		*/
		...
		from CFG..EQT_SQA_GTC_VEN SQAT, CFG..EQT_SEQ_GTC_VEN SQT
	...
	*/
	...
	begin
		...
		*/
		...
		from CFT..EQT_SQA_GTC_VEN SQAT, CFT..EQT_SEQ_GTC_VEN SQT
