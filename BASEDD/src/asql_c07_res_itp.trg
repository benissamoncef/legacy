/*E*/
/*  Fichier : $Id: asql_c07_res_itp.trg,v 1.1 1995/02/15 19:48:12 gaborit Exp $      Release : $Revision: 1.1 $        Date : $Date: 1995/02/15 19:48:12 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER asq_c01_res_itp.trg
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
* 
* trigger sur la table RES_ITP
*
------------------------------------------------------
* HISTORIQUE :
*
...
/*-----------------------------------------------------
* Service rendu
* Annuler l'update sur un itp si aucune modification
