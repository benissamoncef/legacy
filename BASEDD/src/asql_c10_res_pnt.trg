/*E*/
/*  Fichier : $Id: asql_c10_res_pnt.trg,v 1.1 1995/02/15 19:48:34 gaborit Exp $      Release : $Revision: 1.1 $        Date : $Date: 1995/02/15 19:48:34 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER asq_c01_res_pnt.trg
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
* 
* trigger sur la table RES_PNT
*
------------------------------------------------------
* HISTORIQUE :
*
...
/*-----------------------------------------------------
* Service rendu
* Annuler l'update sur un pont si aucune modification
