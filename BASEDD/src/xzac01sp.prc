...
* LCL	11/10/20 	: MOVIS DEM-SAE93 1.33
* CGR	08/01/21	: MOVIS ajout serveur PRA DEM-SAE93 1.34
* JMG	10/06/21 	: cle double EQT_FIL 1.37
* GGY	28/04/23	: Augmentation du champ  va_TextePicto_in (XDC_LGR_TXT_PICTO) et va_TypePicto_in (XDC_LGR_NOM_PICTO) (DEM-473)
* GGY	28/04/23	: Correction Flash (short to boolean) (DEM-473)
* LCL	28/09/23 	: Adaptations CNA DEM-483	
* JPL	20/10/23	: Pas de FMC d'Essai ou Exercice en attente dans EQT_FIL (SAE_525)  1.38
-----------------------------------------------------*/
...
select "@@servername,@va_Site_in,@va_site_origine_in,@vl_Site"
select @@servername,@va_Site_in,@va_site_origine_in,@vl_Site
	...
	begin
		...
		if @vl_serveur_pra = XDC_SQLVC
			exec @vl_Status = SQL_DM.PRC..XZAC;01 @va_Horodate_in, @va_NumEvt_in, @va_CleEvt_in,
						...
						@va_DestinationNoeud_in,
						XDC_OUI
		else if @vl_serveur_pra = XDC_SQLDP
			exec @vl_Status = SQL_DS.PRC..XZAC;01 @va_Horodate_in, @va_NumEvt_in, @va_CleEvt_in,
						@va_Operateur_in, @va_NumEqt_in, @va_Site_in,
						@va_Ligne1_in, @va_Ligne2_in, @va_Ligne3_in,
						@va_Alternat1_in, @va_Alternat2_in, @va_Alternat3_in,
						@va_Clignotement1_in, @va_Clignotement2_in, @va_Clignotement3_in,
			...
			exec @vl_Status = SQL_CI.PRC..XZAC;01 @va_Horodate_in, @va_NumEvt_in, @va_CleEvt_in,
						@va_Operateur_in, @va_NumEqt_in, @va_Site_in,
						@va_Ligne1_in, @va_Ligne2_in, @va_Ligne3_in,
						@va_Alternat1_in, @va_Alternat2_in, @va_Alternat3_in,
						@va_Clignotement1_in, @va_Clignotement2_in, @va_Clignotement3_in,
	...
	/*A initialisation du Flash */
	select @vl_Flash = XDC_NON
...
/*DEM706*/
	...
	begin tran
		...
		@va_LigneDir_in,@va_AlternatDir_in,@va_Destination_in,@va_DestinationAlternat_in,@va_DepassSeuil_in, @va_DestinationNoeud_in, @vl_Flash)
