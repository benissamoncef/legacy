/*E*/
/*Fichier :  $Id: xzao996sp.prc,v 1.4 2018/07/11 10:59:15 pc2dpdy Exp $      Release : $Revision: 1.4 $        Date : $Date: 2018/07/11 10:59:15 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao996sp.prc
------------------------------------------------------
            ...
            begin
                ...
                */
                ...
                begin
                    ...
                    /*A
                    ** La sequence n'existe pas dans EQT_SEQ_GTC_ECL
                    */
                    ...
                    begin
                        ...
                        /*A
                        ** Creation positionne =>
                        ** Insertion de la sequence dans la table EQT_SEQ_GTC_ECL
                        */
                        ...
                        begin
                            ...
                            insert into CFG..EQT_SEQ_GTC_ECL ( numero,
                                                               nom,
                                                               type,
                                                               supprime )
                                                      values ( @vl_NumS,
                    ...
                    begin
                        ...
                        ** Suppression de la sequence de la table EQT_SEQ_GTC_ECL
                        */
                            delete CFG..EQT_SEQ_GTC_ECL
                            where  type       = @va_Type_in
                              and  numero     = @vl_NumS     
					...
					begin
						...
						*/
						...
						begin
							...
							insert into CFT..EQT_SEQ_GTC_ECL ( numero,
															   nom,
															   type,
															   supprime )
													  values ( @vl_NumS,
