/*E*/
/*Fichier :  $Id: xzao600sp.prc,v 1.3 2018/07/11 10:46:37 pc2dpdy Exp $      Release : $Revision: 1.3 $        Date : $Date: 2018/07/11 10:46:37 $
--------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao600sp.prc
------------------------------------------------------
...
/* static char *version = "@(#)xzao600.c    1.1 04/09/07 : xzao600" ; */
...
* SERVICE RENDU : 
*
*  Ajout d'un eqt du  domaine signalisation dans la base
*
------------------------------------------------------
* SEQUENCE D'APPEL :
*/
...
create procedure XZAO;600
    @va_Basedd_in             char(3),
    @va_NomSIG_in             char(10),
...
* VALEUR RENDUE :
*
* Ajout d'un eqt du domaine signalisation en base
* 
* CODE RETOUR :
*
* 0    XDC_OK
...
* FONCTION :
*
* Insertion ou modification dans la table EQT_GTC_SIG (EQUIPEMENT SIGNALISATION)
*
* MECANISMES :
*
------------------------------------------------------
            ...
            begin
                ...
                */
                ...
                begin
                    ...
                    /*A
                    ** L equipement SIGNALISATION n'existe pas dans EQT_GEN
                    */
                    ...
                    begin
                        ...
                        /*A
                        ** Insertion equipement SIGNALISATION dans la table EQT_GEN
                        */

                        select @vl_Numero = max(numero) 
                        from   CFG..EQT_GEN
                        where  type = XDC_EQT_SIG
                        ...
                        */
                        ...
                        /*A
                        ** Insertion equipement SIGNALISATION dans la table EQT_GTC_SIG
                        */
                    ...
                    begin
                        ...
                        */
                        ...
                        set    maitre      = @vl_Serveur,
                               type_maitre = XDC_MAI_SIG,
                               autoroute   = @vl_Autoroute,
                               PR          = @va_PR_in
                        where  numero      = @vl_NumSIG  and
                               type        = XDC_EQT_SIG and
                               nom         = @va_NomSIG_in
                        ...
                        */
                        ...
                        /*A
                        ** Modification du eqt SIGNALISATION dans la table EQT_GTC_SIG
                        */
                        /* A voir */

                        /*

                        update CFG..EQT_GTC_SIG
                ...
                */   
                ...
                begin
                    ...
                    */
                    ...
                    begin
	                    ...
	                    */
	                    ...
	                    begin
	                        ...
	                        /*A
	                        ** Insertion equipement SIG dans la table EQT_GEN
	                        */
	                ...
	                /*A
	                ** L'equipement SIGNALISATION existe dans EQT_GEN
	                */

	                begin

	                    /*A
	                    ** Modification de l'equipement SIGNALISATION dans la table EQT_GEN
	                    */
	                    ...
	                    */
	                    ...
	                    /*A
	                    ** Modification de l'equipement SIGNALISATION dans la table EQT_GTC_SIG
	                    */

	                    /* A voir */
	                    /*
	                    update CFT..EQT_GTC_SIG
	                    set    adresse_etat        = @va_AdresseEtat_in,
	                           adresse_commande    = @va_AdresseCommande_in,
	                           adresse_discordance = @va_AdresseDiscordance_in,
	                           adresse_telealarme  = @va_AdresseTelealarme_in
