/*E*/
/*  Fichier : $Id: xzat22sp.prc,v 1.7 2021/03/08 13:37:00 pc2dpdy Exp $      Release : $Revision: 1.7 $        Date : $Date: 2021/03/08 13:37:00 $
------------------------------------------------------
...
as
	...
	where numero = @va_NumAction_in and sit = @vl_Site and type = XDC_ACT_TUNNEL
	...
	begin
		...
		update EXP..ACT_GEN set heure_fin  = @va_Horodate_in
		where equipement = @vl_NumEqt and type = XDC_EQT_TUBE and sit = @vl_Site and
