/*E*/
/*Fichier :  $Id: xzao984sp.prc,v 1.5 2018/07/11 11:09:00 pc2dpdy Exp $      Release : $Revision: 1.5 $        Date : $Date: 2018/07/11 11:09:00 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao984sp.prc
------------------------------------------------------
...
*
* HISTORIQUE :
* ABE 06/05/13 : correction code non conforme avec xzao986sp.prc pour VEN et xzao982sp.prc pour SIG
		...
		begin
            ...
            */   
            ...
            begin
                ...
                /*A
                ** Verification de l'existence de la sequence dans EQT_SEQ_GTC_ECL
                */
                ...
                /*A
                ** La sequence existe dans EQT_SEQ_GTC_ECL
                */
                ...
                begin
                    ...
                    from   CFG..EQT_GEN
                    where  nom  = @va_NomECL_in
                      and  type = @va_Type_in
                    /*A
                    ** L equipement du domaine ECL existe dans EQT_GEN
                    */
                    ...
                    begin
                        ...
                        where  type       = @va_Type_in
                          and  equipement = @vl_NumECL
                          and  sequence   = @vl_NumSeq

                        /*A
                        ** La sequence autorisee du tunnel n'existe pas dans EQT_SQA_GTC_ECL
                        */
                        ...
                        begin
                          ...
                          /*A
                          ** La sequence autorisee n'existe pas dans EQT_SQA_GTC_ECL
                          */
                          ...
                          begin
                             ...
                             /*A 
                             ** Creation non positionne =>
                             ** Suppression de la sequence autorisee dand la table EQT_SQA_GTC_ECL
                             */
