/*E*/
/*  Fichier : $Id: asql_t10_fmc_ech.trg,v 1.3 2020/11/10 15:58:01 akkaakka Exp $      Release : $Revision: 1.3 $        Date : $Date: 2020/11/10 15:58:01 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  ECHEDD
------------------------------------------------------
* FICHIER asql_t10_fmc_ech.trg
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
* 
* trigger sur la table FMC_ECH
*
------------------------------------------------------
* HISTORIQUE :
*
...
* eche EXP (et HIS au CI)
---------------------------------------------------*/

use EXP
go

drop trigger fmc_ech_iu_trg
go

create trigger fmc_ech_iu_trg
on FMC_ECH
for insert,update
as
