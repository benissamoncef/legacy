/*E*/
/*Fichier :  $Id: xzac114sp.prc,v 1.2 2020/10/13 17:16:06 pc2dpdy Exp $      Release : $Revision: 1.2 $        Date : $Date: 2020/10/13 17:16:06 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER xzac114sp.prc
------------------------------------------------------
...
* 
* Sequence d'appel
* SP	XZAC114_Fin_Commande_Manuelle_INC
* 
* Arguments en entree
...
as
	...
	where  EXP..ACT_GEN.numero = @va_NumAction_in and 
		   ...
		   EXP..ACT_GTC_INC.actio = @va_NumAction_in and 
		   EXP..ACT_GTC_INC.sit = @vl_Site
