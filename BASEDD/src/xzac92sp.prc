/*E*/
/*  Fichier : $Id: xzac92sp.prc,v 1.11 2021/03/08 14:13:52 pc2dpdy Exp $     Release : $Revision: 1.11 $        Date : $Date: 2021/03/08 14:13:52 $
------------------------------------------------------
* GTIE * PROJET MIGRAZUR
------------------------------------------------------
* SOUS-SYSTEME BASEDD
------------------------------------------------------
* MODULE XZAC * FICHIER xzac92sp.prc
------------------------------------------------------
...
* PNI	29/08/13: suppression verif existance FMC pour SAPIENS au CI (delais de propagation FMC via repli) DEM 1074 1.4
* JMG   09/03/17        : REGIONALISATION - DEM1220 1.5
* LCL	03/07/17	: Modif PRA
* JPL	05/09/17 : Mode DEV: pas de commande equipement; action en succes, ou echec avec alerte si pb. mineur eqt. (DEM 1231)  1.6
* LCL   25/03/20   : MOVIS Ajout site local DEM-SAE93
* GRO	12/10/2020      : MOVIS DEM-SAE93		
* LCL	18/11/20	: MOVIS DEM-SAE93 correction recherche equipement dispo sur basculement PRA 1.9
...
/*-----------------------------------------------------
* Service rendu
* Action de deployement de BAF.par scenario
* 
* Sequence d'appel
* SP	XZAC92_Commande_BAF
* 
* Arguments en entree
...
* 
* Inserer dans la table ACTION et la table E_BAF.
...
if exists (select * from sysobjects where name = 'XZAC92' and type = 'P')
	drop procedure XZAC92
go


create procedure XZAC92
...
as
	...
	if @va_NumEvt_in = null or @va_CleEvt_in = null or @va_NumEqt_in = null or
	   @va_Operateur_in = null or @va_HeureLancement_in = null or @va_Module11_in = null
	   or @va_Module12_in	 = null or @va_Module15_in = null or @va_Module21_in = null
	   or @va_Module22_in = null or @va_Module25_in = null				
		return XDC_ARG_INV
	...
	begin
		if @vl_serveur_pra=XDC_SQLDP
			exec @vl_Status = SQL_DS.PRC..XZAC92 @va_NumEvt_in, @va_CleEvt_in,
						@va_Operateur_in, @va_NumEqt_in, 
						@va_HeureLancement_in, @va_Manuelle_in, @va_Priorite_in,
						@va_DistanceEvt_in, @va_Module11_in, @va_Module12_in,
						@va_Module15_in,@va_Module21_in,@va_Module22_in,
						@va_Module25_in,@va_Site_in, 
						@va_site_origine_in,
						@va_NumeroAction_out output, 
						XDC_OUI 
		
		else if @vl_serveur_pra=XDC_SQLVC
			exec @vl_Status = SQL_DM.PRC..XZAC92 @va_NumEvt_in, @va_CleEvt_in,
						@va_Operateur_in, @va_NumEqt_in, 
						@va_HeureLancement_in, @va_Manuelle_in, @va_Priorite_in,
						@va_DistanceEvt_in, @va_Module11_in, @va_Module12_in,
						@va_Module15_in,@va_Module21_in,@va_Module22_in,
			...
			exec @vl_Status = SQL_CI.PRC..XZAC92 @va_NumEvt_in, @va_CleEvt_in,
						@va_Operateur_in, @va_NumEqt_in, 
						@va_HeureLancement_in, @va_Manuelle_in, @va_Priorite_in,
						@va_DistanceEvt_in, @va_Module11_in, @va_Module12_in,
						@va_Module15_in,@va_Module21_in,@va_Module22_in,
...
/*DEM1074 : suppression de la verif pour SAPIENS au CI (delais de propagation FMC via repli)
	...
	from	EXP..EQT_DSP
	where	type = XDC_EQT_BAF  and  equipement = @va_NumEqt_in  and
		sit = @vl_Site  and
		dernier = 1
	...
	begin tran
		...
		insert EXP..ACT_BAF (actio, BAF, sit, module11, module12, module15, module21, module22, module25, manuelle)
		values ( @va_NumeroAction_out,  @va_NumEqt_in, @vl_Site, 
		@va_Module11_in, @va_Module12_in, @va_Module15_in, @va_Module21_in, @va_Module22_in, @va_Module25_in, @va_Manuelle_in)
...
/*	if @va_Manuelle_in = XDC_NON
	begin */
		...
		*/
		if @vl_Site = XDC_CI
			exec @vl_Status = TASRV_CI...ACRP12 @va_NumEqt_in, @va_Module11_in, 
			@va_Module12_in, @va_Module15_in, @va_Module21_in, @va_Module22_in, @va_Module25_in,
			@va_NumeroAction_out, @vl_NomMachine
		/* PRA
		else if  @@servername = XDC_SQLVC
		*/
		else if @vl_Site = XDC_VC
			exec @vl_Status = TASRV_VC...ACRP12 @va_NumEqt_in, @va_Module11_in, 
			@va_Module12_in, @va_Module15_in, @va_Module21_in, @va_Module22_in, @va_Module25_in,
			@va_NumeroAction_out, @vl_NomMachine
		/* PRA
		...
		*/
			...
			exec @vl_Status = TASRV_DP...ACRP12 @va_NumEqt_in, @va_Module11_in, 
			@va_Module12_in, @va_Module15_in, @va_Module21_in, @va_Module22_in, @va_Module25_in,
			@va_NumeroAction_out, @vl_NomMachine
		/* PRA
		...
		*/
			...
			exec @vl_Status = TASRV_CA...ACRP12 @va_NumEqt_in, @va_Module11_in, 
			@va_Module12_in, @va_Module15_in, @va_Module21_in, @va_Module22_in, @va_Module25_in,
			@va_NumeroAction_out, @vl_NomMachine
...
*/
	...
	where	EXP..ACT_GEN.equipement = @va_NumEqt_in and 
		...
		(select max(heure_lancement) from EXP..ACT_GEN
		 where	equipement = @va_NumEqt_in and type = XDC_EQT_BAF and
	...
	begin
		...
		begin
			...
			exec XZAC;60 XDC_EQT_BAF, @vl_Autoroute, @vl_PR, @vl_Sens, @vl_Intitule output
	...
	if @vl_EtatPbMineur <> 0
	begin
		exec PRC..XZAA;01 @va_HeureLancement_in, XDC_EQT_BAF, @va_NumEqt_in, XZAAC_AFF_DIF, "Action BAF"
		return XDC_NOK
	end
#endif
