/*E*/
/*Fichier :  $Id: xzac123sp.prc,v 1.3 2010/09/02 09:49:27 gesconf Exp $      Release : $Revision: 1.3 $        Date : $Date: 2010/09/02 09:49:27 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER xzac123sp.prc
------------------------------------------------------
...
* 
* Sequence d'appel
* SP	XZAC123_Lire_Commande_Energie
* 
* Arguments en entree
...
drop procedure XZAC123
go

create procedure XZAC123
...
as
	...
	select
			...
			@va_Manuelle_out	= HIS..ACT_GTC_ENR.manuelle,
			@va_Sequence_out	= HIS..ACT_GTC_ENR.sequence
	from HIS..ACT_GTC_ENR, HIS..ACT_GEN
	where	HIS..ACT_GEN.numero = @va_NumeroAction_in and 
			HIS..ACT_GEN.type = XDC_ACT_GTC_ENR and
			HIS..ACT_GEN.sit = @va_Site_in and
			HIS..ACT_GTC_ENR.actio = @va_NumeroAction_in and 
			HIS..ACT_GTC_ENR.sit = @va_Site_in
	...
	select
		...
		@va_Manuelle_out		= EXP..ACT_GTC_ENR.manuelle,
		@va_Sequence_out		= EXP..ACT_GTC_ENR.sequence
	from EXP..ACT_GTC_ENR, EXP..ACT_GEN
	where	EXP..ACT_GEN.numero = @va_NumeroAction_in and 
		EXP..ACT_GEN.type = XDC_ACT_GTC_ENR and
		EXP..ACT_GEN.sit = @va_Site_in and
		EXP..ACT_GTC_ENR.actio = @va_NumeroAction_in and 
		EXP..ACT_GTC_ENR.sit = @va_Site_in
	...
	if @vl_NbEnrg = 0
	begin
		exec @vl_Status = SQL_HIS.PRC..XZAC123
					@va_NumeroAction_in,
					@va_Site_in,
