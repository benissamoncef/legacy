...
if exists (select * from sysobjects where name = 'XZAT31' and type = 'P')
    drop procedure XZAT31
go

create procedure XZAT31
...
as
	...
	select 
		...
		@vl_TypeEqt = type 
	from EXP..ACT_GEN
	where numero = @va_NumAction_in and sit = @vl_Site and type = XDC_ACT_BAD
