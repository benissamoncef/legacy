...
#  Compile les procedures stockees de xzax sur le serveur d'un site donne.
#
#############################################################################
#
# Service rendu
...
# degroupees
sae_dev_make_prc "xzax01sp.prc" $Site_Compil $cible
sae_dev_make_prc "xzax02sp.prc" $Site_Compil $cible
sae_dev_make_prc "xzax03sp.prc" $Site_Compil $cible
