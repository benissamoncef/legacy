/*E*/
/*Fichier :  $Id: xzat45sp.prc,v 1.2 2021/03/08 13:15:53 pc2dpdy Exp $      Release : $Revision: 1.2 $        Date : $Date: 2021/03/08 13:15:53 $
------------------------------------------------------
...
drop procedure XZAT45
go

create procedure XZAT45
...
as
    ...
    begin
        ...
        where  EXP..ACT_GEN.numero = @va_NumAction_in
          ...
          and  CFG..EQT_GEN.type   = XDC_EQT_EXP
