/*E*/
/*Fichier :  $Id: acli_xzac101_cb.c,v 1.1 2008/09/26 15:19:35 devgtie Exp $      Release : $Revision: 1.1 $        Date : $Date: 2008/09/26 15:19:35 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE ACLI_XZAN34CB * FICHIER acli_xzac101_cb.c
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
* < description rapide des fonctions remplies par le module
*   et reference au dossier de conception generale
*   ou reference au fichier acli_xzac101_cb.h >
*
------------------------------------------------------
* HISTORIQUE :
*
...
static char *    version = "@(#)acli_xzac101_cb.c    1.1 27/08/07 : acli_xzac101_cb" ;
...
void acli_xzac101_cb( T_IPC_CONN                 va_Cnx,
...
------------------------------------------------------*/
{
    ...
    T_INT2    vl_cle,vl_poste,vl_identifiant,vl_manuelle,vl_priorite,vl_district_ECL,vl_district;
    T_INT2     vl_scenario;
    T_REAL8    vl_horodate;
#else
    XDY_Entier vl_numero,vl_distance;
    XDY_Mot    vl_cle,vl_poste,vl_identifiant,vl_manuelle,vl_priorite,vl_district_ECL,vl_district;
    XDY_Mot     vl_scenario;
    ...
    if (XZAC101_Commande_ECL( vl_numero,      /*num evt*/
                              vl_cle,         /*cle evt*/
                           ...
                           != XDC_OK)
        XZST_03EcritureTrace(XZSTC_FONCTION,"acli_xzac_101_cb : pb appel a XZAC101_Commande_ECL");


    XZST_03EcritureTrace(XZSTC_FONCTION,"OUT : acli_xzac_101_cb : Fin d execution ");
