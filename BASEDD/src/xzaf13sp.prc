/*E*/
/*  Fichier : $Id: xzaf13sp.prc,v 1.1 1995/01/17 16:30:17 torregrossa Exp $      Release : $Revision: 1.1 $        Date : $Date: 1995/01/17 16:30:17 $
------------------------------------------------------
	...
	begin
		...
		begin
			...
			if @va_BAU_in=XDC_VOIE_SENS_INVERSE
				insert	#SYN_BAS_SEG ( evenement_basc, cle_basc, 
					evenement_bou, cle_bou, portion, PR, sens, voie, 
					translation, extension, niveau)
			...
			begin
				if @va_VL_in=XDC_VOIE_SENS_INVERSE
					insert	#SYN_BAS_SEG ( evenement_basc, cle_basc, 
						...
						voie, translation, extension, niveau)
					values ( @va_NumBascul_in, @va_CleBascul_in,
						@va_NumBouchon_in, @va_CleBouchon_in,
						@vl_Portion, @vl_PRDebutSeg, @va_SensBascul_in,
						6,
