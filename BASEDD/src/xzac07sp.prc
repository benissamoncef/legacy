/*E*/
/*  Fichier : $Id: xzac07sp.prc,v 1.6 2020/10/13 17:13:15 pc2dpdy Exp $      Release : $Revision: 1.6 $        Date : $Date: 2020/10/13 17:13:15 $
------------------------------------------------------
...
as
	...
	begin
		...
		where	equipement = @vl_NumEqt and sit = @vl_Site and 
			heure_fin is null and type = XDC_ACT_ECHANGEUR and
