/*E*/
/*Fichier : $Id: xzao493sp.prc,v 1.1 2021/05/03 13:07:28 pc2dpdy Exp $  Release : $Revision: 1.1 $ Date : $Date: 2021/05/03 13:07:28 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao493sp.prc
------------------------------------------------------
...
/* static char *version = "$Id: xzao493sp.prc,v 1.1 2021/05/03 13:07:28 pc2dpdy Exp $ $Revision: 1.1 $ $Date: 2021/05/03 13:07:28 $ : xzao493" ; */
...
if exists (select * from sysobjects where name = 'XZAO493' and type = 'P')
	drop procedure XZAO493
go

create procedure XZAO493
   @va_Basedd_in       	char(3),
