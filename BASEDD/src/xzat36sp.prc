...
* PNI	11/10/13	: SAPIENS AU CI : on considére l'utilisation de l'eqt à partir de l'heure_lancement ou heure_succes DEM 1074 1.2
...
* 
* Service rendu
* Retourne l'utilisation reelle d'une BAD È une horodate donnÅe.
* 
* Code retour
* XDC_OK
* XDC_NOK
