/*E*/
/*  Fichier : $Id: asql_c18_res_vil.trg,v 1.1 1995/02/15 19:49:15 gaborit Exp $      Release : $Revision: 1.1 $        Date : $Date: 1995/02/15 19:49:15 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER asq_c01_res_vil.trg
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
* 
* trigger sur la table RES_VIL
*
------------------------------------------------------
* HISTORIQUE :
*
...
/*-----------------------------------------------------
* Service rendu
* Annuler l'update sur une ville si aucune modification
