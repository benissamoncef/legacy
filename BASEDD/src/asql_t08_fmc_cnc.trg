/*E*/
/*  Fichier : $Id: asql_t08_fmc_cnc.trg,v 1.3 2020/11/10 15:57:59 akkaakka Exp $      Release : $Revision: 1.3 $        Date : $Date: 2020/11/10 15:57:59 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  CNCEDD
------------------------------------------------------
* FICHIER asql_t08_fmc_cnc.trg
------------------------------------------------------
* DESCRIPTION DU MODULE :
*
* 
* trigger sur la table FMC_CNC
*
------------------------------------------------------
* HISTORIQUE :
*
...
* cnce EXP (et HIS au CI)
---------------------------------------------------*/

use EXP
go

drop trigger fmc_cnc_iu_trg
go

create trigger fmc_cnc_iu_trg
on FMC_CNC
for insert,update
as
