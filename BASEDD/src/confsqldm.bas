/*X  Fichier : $Id: confsqldm.bas,v 1.1 1995/03/21 17:42:42 gaborit Exp $      Release : $Revision: 1.1 $        Date : $Date: 1995/03/21 17:42:42 $
------------------------------------------------------
...
* DESCRIPTION :
* 
* cree les devices pour le district DM
* cree le user applicatif MIGRAZUR pour le district DM
* cree les bases pour le district DM
* 
*
------------------------------------------------------
* HISTORIQUE :
...
-----------------------------------------------------
   ...
   print "fin de la configuration des devices du DM"
   go
