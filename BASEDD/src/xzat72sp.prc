/*E*/
/*  Fichier : $Id: xzat72sp.prc,v 1.1 2018/03/26 18:34:46 devgfi Exp $        $Revision: 1.1 $        $Date: 2018/03/26 18:34:46 $
-------------------------------------------------------------------------------------------
* ESCOTA  *  PROJET MIGRAZUR
-------------------------------------------------------------------------------------------
* SOUS-SYSTEME : BASEDD
-------------------------------------------------------------------------------------------
* FICHIER xzat72sp.prc
-------------------------------------------------------------------------------------------
* DESCRIPTION DU MODULE :
*
*  Supprime la mise au neutre programmee d'un PMV SAGA donne.
*
-------------------------------------------------------------------------------------------
* HISTORIQUE :
*
...
* SERVICE RENDU
*
*  Supprime la mise au neutre programmee d'un PMV SAGA donne dans la table PRG_PMV_SAGA.
*
-------------------------------------------------------------------------------------------
* SEQUENCE D'APPEL
*
* SP	XZAT72_Supprimer_Neutre_PMV_SAGA
*
* PARAMETRES EN ENTREE :
*
* XDY_Eqt	va_NumEqt_in	: Numero de l'equipement PMV SAGA
...
*
* XDC_OK
* XDC_OBJ_AUCUN     : Pas de programmation pour ce PMV SAGA a cette date
* XZAEC_FMC_NON_FIN : FMC attachee non terminee
* XDC_NOK           : PMV SAGA inexistant, incoherence de site
...
* FONCTION :
*
*  Supprime la mise au neutre programmee pour le PMV SAGA indique dans la table PRG_PMV_SAGA.
...
if exists (select * from sysobjects where name = 'XZAT72' and type = 'P')
	drop procedure XZAT72
go


create procedure XZAT72
...
as
	...
	/*A Rechercher la programmation de mise au neutre du PMV SAGA et la FMC associee */
	...
	/*A Supprimer la mise au neutre programmee du PMV SAGA */
	delete	EXP..PRG_PMV_SAGA
	where	numero = @va_NumEqt_in
	  and	@va_HorodateDebut_in between debut and fin
