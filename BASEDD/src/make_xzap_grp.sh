...
#  Compile les procedures stockees de XZAP sur le serveur d'un site donne.
#
#############################################################################
#
# Service rendu
...
echo "#include \"$includes/migrazur/BASEDD/inc/xzap11sp.h\"" >> ${fic_tmp_c}
echo "#include \"$includes/migrazur/BASEDD/inc/xzap12sp.h\"" >> ${fic_tmp_c}
echo "#include \"$includes/migrazur/BASEDD/inc/xzap13sp.h\"" >> ${fic_tmp_c}
echo "#include \"$includes/migrazur/BASEDD/inc/xzap14sp.h\"" >> ${fic_tmp_c}
echo "#include \"$includes/migrazur/BASEDD/inc/xzap15sp.h\"" >> ${fic_tmp_c}
echo "#include \"$includes/migrazur/BASEDD/inc/xzap16sp.h\"" >> ${fic_tmp_c}
echo "#include \"$includes/migrazur/BASEDD/inc/xzap17sp.h\"" >> ${fic_tmp_c}
echo "#include \"$includes/migrazur/BASEDD/inc/xzap18sp.h\"" >> ${fic_tmp_c}
