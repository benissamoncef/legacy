/*E*/
/*Fichier : @(#)xzao419sp.prc	1.2     Release : 1.2        Date :  06/03/02
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao419sp.prc
------------------------------------------------------
* HISTORIQUE :
*
* guilhou       20/09/00        : creation vide 1.1
* cluchague     03/12/01        : reprise complete pour debug et a57 et dispo pmv
* niepceron     28/08/06        : voir dem 583 (pb suite a l'ajout du pmv du 17) v1.3 
* PNI		28/06/13	: Calcul non prévu pour PMV sur une bifurc. d'une bifurc. (cf A501 pour A8) , ne prendre en compte que les PMV ayant un distance positive v1.4 DEM1072
------------------------------------------------------*/
...
/* static char *version = " @(#)xzao419sp.prc	1.2 06/03/02: xzao419" ; */
...
drop procedure XZAO419
go

create procedure XZAO419
