/*E*/
/*  Fichier : $Id: xzao415sp.prc,v 1.1 1998/01/06 17:26:21 gaborit Exp $      Release : $Revision: 1.1 $        Date : $Date: 1998/01/06 17:26:21 $
------------------------------------------------------
...
create procedure XZAO;415
   as
   
   select numero, nom, code, type, serveur, machine from CFG..RES_DIS
