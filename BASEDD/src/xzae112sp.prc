/*X  Fichier : $Id: xzae112sp.prc,v 1.2 2007/04/16 17:44:00 gesconf Exp $      Release : $Revision: 1.2 $        Date : $Date: 2007/04/16 17:44:00 $
------------------------------------------------------
...
* JPL	16/04/07	: Changement de nom 1.2
-----------------------------------------------------*/
...
drop procedure XZAE112
go


create procedure XZAE112
as
	select
		numero,
		classe,
		convert(varchar(100), libelle),
		abreviation,
		operation,
		supprime
	from CFG..LIB_PRE, CFG..TYP_FMC
	where notyp = XDC_TYPE_FICHE_MC and code = numero
	order by position
