/*E*/
/*Fichier : $Id: xzao425sp.prc,v 1.4 2007/07/30 17:32:55 gesconf Exp $     Release : $Revision: 1.4 $        Date :  $Date: 2007/07/30 17:32:55 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao425sp.prc
------------------------------------------------------
* HISTORIQUE :
*
...
* cluchague     10/12/07        : probleme avec le trou des pr sur A50 => verrue 1.3
* cluchague     30/07/07        : bug sur A50 dans la verrue -> 1.4
------------------------------------------------------*/
...
/* static char *version = " $Id: xzao425sp.prc,v 1.4 2007/07/30 17:32:55 gesconf Exp $: xzao425" ; */
...
if exists (select * from sysobjects where name = 'XZAO425' and type = 'P')
	drop procedure XZAO425
go

create procedure XZAO425
