...
echo "#include \"$includes/XDMICG/inc/xdc.h\"" >> ${fic_tmp_c_xzag}    
# par: 10 15 25 05 11 01 02 03 04 06 07 08 09 12 54 100 35 40 50 51 52 53 55
echo "#include \"$includes/XDMICG/inc/xzaec.h\"" >> ${fic_tmp_c_xzag}  
# par: 15 17 18 21 22 25 13 14 16 19 20 26 27 28 29 30 31 40
echo "#include \"$includes/XDMICG/inc/xzagc.h\"" >> ${fic_tmp_c_xzag}  
...
then
    ...
    sae_dev_make_prc "xzag1301sp.prc"   $Site_Compil $cible
fi




#########################Debut on ne fait qu au CI et CA #####################
