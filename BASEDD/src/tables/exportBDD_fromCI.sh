...
# Les donnes sont exportees depuis CI
#
#################################################################################
#
#################################################################################
...
bcp CFG..LIB_PRE out LIB_PRE.bcp -SSQL_CI -UMIGRAZUR -PMIGRAZUR
cp -p bcp.fmt LIB_PRE.fmt

bcp CFG..LIB_TYP out LIB_TYP.bcp -SSQL_CI -UMIGRAZUR -PMIGRAZUR
cp -p bcp.fmt LIB_TYP.fmt

bcp CFG..LST_FMC_BLC out LST_FMC_BLC.bcp -SSQL_CI -UMIGRAZUR -PMIGRAZUR
cp -p bcp.fmt LST_FMC_BLC.fmt

bcp CFG..LST_FMC_COL out LST_FMC_COL.bcp -SSQL_CI -UMIGRAZUR -PMIGRAZUR
cp -p bcp.fmt LST_FMC_COL.fmt

bcp CFG..OPR_FCT_NOM out OPR_FCT_NOM.bcp -SSQL_CI -UMIGRAZUR -PMIGRAZUR
cp -p bcp.fmt OPR_FCT_NOM.fmt

bcp CFG..OPR_IDE out OPR_IDE.bcp -SSQL_CI -UMIGRAZUR -PMIGRAZUR
cp -p bcp.fmt OPR_IDE.fmt

bcp CFG..OPR_LOG_MDP out OPR_LOG_MDP.bcp -SSQL_CI -UMIGRAZUR -PMIGRAZUR
cp -p bcp.fmt OPR_LOG_MDP.fmt

bcp CFG..OPR_NOM out OPR_NOM.bcp -SSQL_CI -UMIGRAZUR -PMIGRAZUR
cp -p bcp.fmt OPR_NOM.fmt

bcp CFG..OPR_PRF out OPR_PRF.bcp -SSQL_CI -UMIGRAZUR -PMIGRAZUR
cp -p bcp.fmt OPR_PRF.fmt

bcp CFG..OPR_PRF_FCT out OPR_PRF_FCT.bcp -SSQL_CI -UMIGRAZUR -PMIGRAZUR
cp -p bcp.fmt OPR_PRF_FCT.fmt

bcp CFG..TYP_CRB out TYP_CRB.bcp -SSQL_CI -UMIGRAZUR -PMIGRAZUR
cp -p bcp.fmt TYP_CRB.fmt

bcp CFG..TYP_FMC out TYP_FMC.bcp -SSQL_CI -UMIGRAZUR -PMIGRAZUR
cp -p bcp.fmt TYP_FMC.fmt

bcp CFG..TYP_FMC_GRP out TYP_FMC_GRP.bcp -SSQL_CI -UMIGRAZUR -PMIGRAZUR
