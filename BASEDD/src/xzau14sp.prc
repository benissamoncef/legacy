/*E*/
/*Fichier : $Id: xzau14sp.prc,v 1.4 2020/11/10 08:02:52 devgtie Exp $      Release : $Revision: 1.4 $        Date : $Date: 2020/11/10 08:02:52 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAU * FICHIER xzau14sp.prc
------------------------------------------------------
...
* VALEUR RENDUE :
*
* Ajoute un profil (et les login et mot de passe correspondants) a un utilisateur
*
* CODE RETOUR :
*
* 0	XDC_OK
   ...
   begin
	...
	select  @vl_Site = numero
         ...
         */
         ...
         begin   
            select @vl_Login = login from CFG..OPR_LOG_MDP
              where login 	 = @va_Login_in
                and mot_de_passe = @va_MotDePasse_in   
            
            if @vl_Login = null
               
               insert into CFG..OPR_LOG_MDP
               values ( @va_Login_in, @va_MotDePasse_in, @va_NumUtilisateur_in, @va_NumProfil_in )    
