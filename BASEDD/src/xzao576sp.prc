/*E*/
/* Fichier : $Id: xzao576sp.prc,v 1.4 2018/10/11 14:52:43 devgtie Exp $      Release : $Revision: 1.4 $        Date : $Date: 2018/10/11 14:52:43 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* FICHIER xzao576sp.prc
------------------------------------------------------
...
/* static char *version = "@(#)xzao576.c	1.1 23/18/94 : xzao576" ; */
...
if exists (select * from sysobjects where name = 'XZAO576' and type = 'P')
	drop procedure XZAO576
go

create procedure XZAO576
