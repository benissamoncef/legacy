/*E*/
/*Fichier : $Id: xzap13sp.prc,v 1.3 1998/09/22 13:37:24 gaborit Exp $      Release : $Revision: 1.3 $        Date : $Date: 1998/09/22 13:37:24 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAP * FICHIER xzap13sp.prc
------------------------------------------------------
...
declare @vl_Status int, @vl_Site tinyint
	...
	if @vl_Site = XDC_CI
		exec @vl_Status = SQL_CI.PRC..XZAP;13
			@va_NumPA_in		,
			@va_Ordre_in

	else if @vl_Site = XDC_CA
		exec @vl_Status = SQL_CA.PRC..XZAP;13
			@va_NumPA_in		,
			@va_Ordre_in
   ...
   */
   ...
   begin
      ...
      where	evenement=@vl_evt
      	and	cle=@vl_cle
      	and	type_equipement=XDC_EQT_NAV
