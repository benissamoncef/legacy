/*E*/
/*Fichier :  $Id: xzac125sp.prc,v 1.3 2010/09/02 09:49:33 gesconf Exp $      Release : $Revision: 1.3 $        Date : $Date: 2010/09/02 09:49:33 $
------------------------------------------------------
...
* 
* Sequence d'appel
* SP	XZAC125_Lire_Commande_Exploitation
* 
* Arguments en entree
...
drop procedure XZAC125
go

create procedure XZAC125
...
as
	...
	select
			...
			@va_Manuelle_out	= HIS..ACT_GTC_EXP.manuelle,
	...
	where	HIS..ACT_GEN.numero = @va_NumeroAction_in and 
			...
			HIS..ACT_GTC_EXP.actio = @va_NumeroAction_in and 
			HIS..ACT_GTC_EXP.sit = @va_Site_in
	...
	select
		...
		@va_Manuelle_out		= EXP..ACT_GTC_EXP.manuelle,
	...
	where	EXP..ACT_GEN.numero = @va_NumeroAction_in and 
		...
		EXP..ACT_GTC_EXP.actio = @va_NumeroAction_in and 
		EXP..ACT_GTC_EXP.sit = @va_Site_in
	...
	if @vl_NbEnrg = 0
	begin
		exec @vl_Status = SQL_HIS.PRC..XZAC125
					@va_NumeroAction_in,
					@va_Site_in,
