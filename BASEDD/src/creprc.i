...
* GABORIT	21 Oct 1994 : Èchange des valeurs XDC_SENS_xxx entre nord et sud		(v1.94)
...
*				rendu visible les XDC_PATHxxx ‡ Applix
...
* Niepceron     19 Dec 1996 : Mise ‡ 30 du nb de familles (et non 28) (dem/1359) (1.252)
...
* Guilhou     	07 Avr 1997 : RE-Mise ‡ 30 du nb de familles (et non 28) (dem/1359) (1.261)
...
* ABE-GTIE	27/05/13 : mise ‡ jour de la gestion du retour ‡ la normale avec les modif : #define XDC_ECL_SEQ_RETOUR_NORMAL 5 -> 20 ET #define XDC_VEN_SEQ_RETOUR_NORMAL 8 -> 46
...
* PNI		15/04/15 : Remplacement SIS par Surveillance RÈseau DEM1126 1.349
...
* JPL		22/06/18 : CaractËres minuscules accentuÈs en ISO Latin (DEM 1274)  1.365
...
* JPL		27/11/18 : Ajout constantes types de jour pour calendrier et type de libellÈ prÈdÈfini (DEM 1312)  1.370
* JPL		28/03/19 : Ajout constantes XDC_LOCAL et XDC_NON_LOCAL  1.371
* JPL		24/06/19 : Ajout constantes d'Ètat des FMC ‡ traiter (configurÈes et prÈsentÈes sur postes opÈrateurs) (DEM 1325)  1.372
...
/* PR de la frontiere*/
/* diffÈrents Ètats d'actions */
/* diffÈrents Ètats d'alerte (ne pas modifier, utilisÈ pour rÈplication) */
...
/* Commandes d'Ètats d'un equipement */
...
* B.G.	21/12/94	: Ajout point pour espace synthËse (1.7)
...
* PNI	17/10/05	: correction blÈssÈs --> blessÈs v1.42 DEM529
...
* JPL	15/05/07	: Ajout de constantes de libellÈs pour fmc Echangeur deconseille (DEM 645) 1.48
* JPL	13/06/07	: Ajout libellÈ pour configuration des voies de Basculement pour travaux (DEM 647) 1.49
* JPL	10/07/07	: Modif libellÈ pour configuration des voies de Basculement pour travaux (DEM GO) 1.50
...
* PNI	15/04/15	: Remplacement SIS par Surveillance RÈseau DEM1125 1.71
* NDE	20/08/15	: Nouvelles constantes pour intitules dÈviation, basculement travaux, etc. (DEM 1136) 1.73
...
* JPL	22/06/18	: CaractËres minuscules accentuÈs en ISO Latin (DEM 1274)  1.79
* JMG	10/10/18	: ajout SMS LOT25 DEM1301 1.80
* JPL	04/04/19	: Ajout libellÈ XZAEC_SYN_ECOUL (DEM 1326)  1.81
* RGR	17/06/19	: Correction orthographe manifestants		1.82
* JPL	01/10/19	: Ajout libellÈ XZAEC_SYN_BOU_MOBILE (DEM 1346)  1.83
