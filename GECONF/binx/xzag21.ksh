...
# PNI	03/05/16	: Regionalisation v1.10
#################################################################################
#
...
rm /produits/migrazur/appliSD/traces/SQL_${site}15.7.log.old
mv /produits/migrazur/appliSD/traces/SQL_${site}15.7.log /produits/migrazur/appliSD/traces/SQL_${site}15.7.log.old
...
fich="/produits/migrazur/appliSD/traces/SQL_${site}15.7.log"
