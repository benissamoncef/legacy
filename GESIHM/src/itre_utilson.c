/*E*/
/*Fichier : $Id: itre_utilson.c,v 1.2 1995/07/07 09:19:36 mercier Exp $      Release : $Revision: 1.2 $        Date : $Date: 1995/07/07 09:19:36 $
*************************************************
* STERIA * Projet MIGRAZUR			*
*************************************************
* MODULE  : MTRE				*
* FICHIER : itre_utilson.c			*
*************************************************
* DESCRIPTION :
...
* Niepceron 07 Jul 1995 : Remplacement de fprintf ( stderr, par
*			XZST_03EcritureTrace (XZSTC_WARNING,	v1.2
*************************************************
*
*/
...
static char *version = "$Id: itre_utilson.c,v 1.2 1995/07/07 09:19:36 mercier Exp $ : itre_utilson" ;
...
/****************************************************************************
 *
 *   rate2num - gets ascii string for sample rate, returns an unsigned long 
 *   of the sample rate (returns 0 if the sample rate is not valid.)
 */
#ifdef __STDC__
unsigned long
rate2num(
...
#endif
{
	...
	*/
	    ...
	    */
	    if ( (n == lastIndex) && 
	        ((rate[lastIndex] == 'k') || (rate[lastIndex] == 'K')) ) {
...
#endif
{
   ...
   /* fprintf ( stderr, "%s: %s\n", message, errorbuff);*/
    XZST_03EcritureTrace (XZSTC_WARNING, "%s: %s\n", message, errorbuff );
}
