...
* GGY	02/04/21	: Ajout XZAEC_SYN_VEH_BAT (DEM-483)
--------------------------------------------------------------------------------- */
...
#define XZAEC_FMC_INIT_NON_AUTORISEE	22	/* lien avec cette fmc initiale non autorise */
...
#define XZAEC_SYN_DEB		"debut       : "	/* 14 carcateres */
#define XZAEC_SYN_FIN		"fin         : "	/* 14 carcateres */
#define XZAEC_SYN_DEB_PREV	"debut prevu : "	/* 14 carcateres */
#define XZAEC_SYN_FIN_PREV	"fin prevue  : "	/* 14 carcateres */
#define XZAEC_SYN_PAS_DATE	".                   "	/* 20 carcateres */
#define XZAEC_SYN_ACT_REUSSIE	" : succes"
#define XZAEC_SYN_ACT_ECHOUEE	" : echec"
#define XZAEC_SYN_ACT_RESULT_SUC	"resultat : succes "
#define XZAEC_SYN_ACT_RESULT_ECHEC	"resultat : echec  "
#define XZAEC_SYN_VEH_AIR	"sur aire    : "	/* 14 carcateres */
#define XZAEC_SYN_VEH_ECH	"sur echangeur : "	/* 16 carcateres */
#define XZAEC_SYN_VEH_LIT	"sur lit arret : "	/* 16 carcateres */
#define XZAEC_SYN_VEH_BAT	"sur batiment : "	/* 16 carcateres */
#define XZAEC_SYN_VEH_PEA	"sur peage   : "	/* 14 carcateres */
#define XZAEC_SYN_NICHE	"sur niche / interniche : "	/* 25 carcateres */
#define XZAEC_SYN_ISSUE_DE_SECOUR	"sur l'issue de secours : "	/* 25 carcateres */
#define XZAEC_SYN_SIGNALEE	"signale"		/* 7 carcateres */
#define XZAEC_SYN_CONFIRMEE	"confirme"		/* 8 carcateres */
#define XZAEC_SYN_VAL		"VALIDATION "		/* 11 carcateres */
#define XZAEC_SYN_CAUSE		"CAUSE               "	/* 20 carcateres */
#define XZAEC_SYN_COM_VAL	"commentaire valable jusqu a " /* 28 carcateres */
#define XZAEC_SYN_COM		"commentaire "		/* 12 carcateres */
#define XZAEC_SYN_CONSEQ	"CONSEQUENCES        "	/* 20 carcateres */
#define XZAEC_SYN_AUCUNE_CONSEQ	"Neant"
#define XZAEC_SYN_FINIE		"FIN D'EVENEMENT"
#define XZAEC_SYN_LON_ESC	"longueur (en km) : "
#define XZAEC_SYN_GRAVITE	"Gravite    : "
...
#define XZAEC_SYN_TRAFIC_PRESAT	"pre-sature"
#define XZAEC_SYN_TRAFIC_SATURE	"sature"

#define XZAEC_SYN_ACT_ANNULEE	": Annulee"
#define XZAEC_SYN_MAJEUR	"Majeur"
#define XZAEC_SYN_DEG_DOM	"degats domaine"
#define XZAEC_SYN_ECOUL		"presence d'ecoulement"
#define XZAEC_SYN_PERS		"presence de personalites"
#define XZAEC_SYN_PER_ESC	"presence de personnel ESCOTA"
#define XZAEC_SYN_VEH_ESC	"presence de vehicule ESCOTA"
#define XZAEC_SYN_PRE_MAT_DNG	"presence de matieres dangereuses"
#define XZAEC_SYN_MOR		"nombre de morts            : "
#define XZAEC_SYN_BLE_GRA	"nombre de blesses graves   : "
#define XZAEC_SYN_BLE_LEG	"nombre de blesses legers   : "
...
#define XZAEC_SYN_VL		"nombre de vehicules legers : "

#define XZAEC_SYN_SCEN		"Scenario : "
#define XZAEC_SYN_CON		"Contexte : "
#define XZAEC_SYN_TRA		"Transitoire : "
#define XZAEC_SYN_ZON		"Zone : "
#define XZAEC_SYN_MES		"Mesure : "
#define XZAEC_SYN_IND_HOR	"Declenchement horaire"
#define XZAEC_SYN_HOR		"horodate"

#define XZAEC_SYN_MAT_DNG	"matieres dangereuses : "
#define XZAEC_SYN_VEH_PL	"type de vehicule     : poids lourd"
#define XZAEC_SYN_VEH_VL	"type de vehicule     : vehicule leger"
#define XZAEC_SYN_VEH_CAR	"type de vehicule     : car"
#define XZAEC_SYN_VEH_MOT	"type de vehicule     : moto"
#define XZAEC_SYN_VEH_REM	"type de vehicule     : remorque"
#define XZAEC_SYN_VEH_FEU_MAITRISE	"feu maitrise : "
#define XZAEC_SYN_INC_MAITRISE	"incendie maitrise : "

#define XZAEC_SYN_PLN_SCR	"plan de secours          : "
#define XZAEC_SYN_ECH_SOR	"echangeur de sortie      : "
#define XZAEC_SYN_ECH_INJ	"echangeur de reinjection : "

#define XZAEC_SYN_LON_VEH	"longueur du vehicule : "
#define XZAEC_SYN_VIT_VEH	"vitesse du vehicule  : "
#define XZAEC_SYN_LRG_VEH	"largeur du vehicule  : "
#define XZAEC_SYN_HAU_VEH	"hauteur du vehicule  : "
#define XZAEC_SYN_POI_VEH	"poids du vehicule    : "
#define XZAEC_SYN_CNT_VEH	"contenu du vehicule  : "
...
#define XZAEC_SYN_NEI_CHA	"type : chaussee enneigee"
...
#define XZAEC_SYN_GRELE		"type : grele"
#define XZAEC_SYN_VERG		"type : verglas"
#define XZAEC_SYN_AUT		"type : autre"
#define XZAEC_SYN_GREL_CH	"type : grele sur chaussee"
#define XZAEC_SYN_CH_MOUI	"type : chaussee mouillee"
#define XZAEC_SYN_VIS_MET	"visibilite : "
#define XZAEC_SYN_FIN_MET	"PR fin : "
#define XZAEC_SYN_PRECIPIT	"Precipitations"

#define XZAEC_SYN_CHS_HUILE	"type : huile sur chaussee"
#define XZAEC_SYN_CHS_CARBURANT	"type : carburant sur chaussee"
#define XZAEC_SYN_CHS_GASOIL	"type : gasoil sur chaussee"

#define XZAEC_SYN_TRT_SALAGE	"type : salage"
#define XZAEC_SYN_TRT_DENEIG	"type : deneigement"


#define XZAEC_SYN_CNC		"sous concessionnaire : "
#define XZAEC_SYN_PEN_CRB	"penurie de "
#define XZAEC_SYN_CNC_FERM	"fermeture du sous concessionnaire"

#define XZAEC_SYN_PAS_PER_PEA	"sans perception peage"
#define XZAEC_SYN_VIO_MNF	"violence"
#define XZAEC_SYN_NBR_MNF	"nombre de manifestants : "

#define XZAEC_SYN_FIN_BAS	"fin du basculement a "
#define XZAEC_SYN_CFG_VOIES_BAS	"Configuration finale des voies "
#define XZAEC_SYN_VOIE_BAS	"Voie"
#define XZAEC_SYN_PRD_BAS	"PR debut"
#define XZAEC_SYN_PRF_BAS	"PR fin"
#define XZAEC_SYN_HD_BAS	"Horodate debut"
...
#define XZAEC_SYN_TRV_GLI	"type : glissieres"
#define XZAEC_SYN_TRV_VEG	"type : vegetation"
#define XZAEC_SYN_TRV_HYD	"type : ouvrage hydraulique"
#define XZAEC_SYN_TRV_ART	"type : ouvrage d'art"
#define XZAEC_SYN_TRV_TER	"type : chaussee et terrassement"
#define XZAEC_SYN_TRV_SGV	"type : signalisation verticale"
#define XZAEC_SYN_TRV_SGH	"type : signalisation horizontale"
#define XZAEC_SYN_TRV_ECL	"type : eclairage"
#define XZAEC_SYN_TRV_RAU	"type : reseau d'appel d'urgence"
#define XZAEC_SYN_TRV_LBT	"type : lavage, balayage tunnel"
#define XZAEC_SYN_TRV_LBA	"type : lavage balayage"
#define XZAEC_SYN_TRV_MTN	"type : maintenance d'equipement de tunnel"
#define XZAEC_SYN_TRV_MAU	"type : maintenance d'equipement autre que tunnel"
#define XZAEC_SYN_TRV_ELA	"type : elargissement"
#define XZAEC_SYN_TRV_MUR	"type : mur anti-bruit"
#define XZAEC_SYN_TRV_CGL	"type : conformite de glissiere"
#define XZAEC_SYN_TRV_AUT	"type : autres travaux"
#define XZAEC_SYN_TRV_ENR	"type : enrobes"
#define XZAEC_SYN_TRV_MTV	"type : maintenance video"
#define XZAEC_SYN_TRV_PAU	"type : travaux sur postes d'appel d'urgence"
#define XZAEC_SYN_TRV_CLO	"type : travaux de cloture"
#define XZAEC_SYN_TRV_FON	"type : travaux sur fibre optique"
#define XZAEC_SYN_TRV_ACC	"type : travaux suite a accident"
...
#define XZAEC_SYN_DEB_PLA	"debut planifie              : " 
#define XZAEC_SYN_FIN_PLA	"fin planifiee               : "
#define XZAEC_SYN_TET_PLA	"debut des travaux planifies : "
#define XZAEC_SYN_QUE_PLA	"fin des travaux planifies   : "

#define XZAEC_SYN_PR_TET	"debut des travaux           : "
#define XZAEC_SYN_VOI_RET	"retrecissement de voie"
#define XZAEC_SYN_TRV_DISCONT	"travaux discontinus planifies : "
...
#define XZAEC_SYN_STK_PRT	"debut de stockage           : "
#define XZAEC_SYN_STK_PREPAR	"stockage en preparation"
...
#define XZAEC_SYN_BOU_BOU	"type             : bouche"
#define XZAEC_SYN_BOU_BLQ	"type             : bloque"
#define XZAEC_SYN_BOU_ACD	"type             : en accordeon"

#define XZAEC_SYN_OPR		"poste operateur : "
...
#define XZAEC_SYN_SOR_N_FERM	"sortie sens 2 fermee"
#define XZAEC_SYN_SOR_S_FERM	"sortie sens 1 fermee"
#define XZAEC_SYN_ENT_N_FERM	"entree sens 2 fermee"
#define XZAEC_SYN_ENT_S_FERM	"entree sens 1 fermee"

#define XZAEC_SYN_SOR_N_DECONS	"sortie sens 2 deconseillee"
#define XZAEC_SYN_SOR_S_DECONS	"sortie sens 1 deconseillee"
#define XZAEC_SYN_ENT_N_DECONS	"entree sens 2 deconseillee"
#define XZAEC_SYN_ENT_S_DECONS	"entree sens 1 deconseillee"
...
#define XZAEC_SYN_ACT_TEL	"appel astreinte par tel "	/* 24 caracteres */
#define XZAEC_SYN_ACT_BIP	"appel astreinte par bip/radio "	/* 30 caracteres */
#define XZAEC_SYN_ACT_FAX_AST	"envoi mail a "
#define XZAEC_SYN_ACT_TEL_AST	"appel par tel "
...
#define XZAEC_SYN_ACT_SMS_AST	"envoi SMS a "
...
#define XZAEC_SYN_ACT_SEQ	"sequence : "

#define XZAEC_SYN_ACT_ECH	"echangeur          "	/* 19 caracteres */

#define XZAEC_SYN_ACT_DEP	"depanneur          "	/* 19 caracteres */
#define XZAEC_SYN_ACT_DEP_NOM	"nom : "
#define XZAEC_SYN_ACT_RESULTAT	"resultat : "

#define XZAEC_SYN_ACT_NAV	"BRA                "	/* 19 caracteres */
#define XZAEC_SYN_ACT_FAU	"Fermeture d'autoroute "	/* 22 caracteres */
#define XZAEC_SYN_ACT_FAC	"Fermeture d'acces  "	/* 19 caracteres */
#define XZAEC_SYN_ACT_SCN	"scenario : "

#define XZAEC_SYN_ACT_BAL_POS	"pose balisage"
#define XZAEC_SYN_ACT_BAL_OTE	"ote balisage"
...
#define XZAEC_SYN_ACT_TFM_ARRET	"arret diffusion a "

#define XZAEC_SYN_ACT_GAR					"affichage en gare  "	/* 19 caracteres */
#define XZAEC_SYN_ACT_GAR_NOM				"gare de peage : "	/* 16 caracteres */
...
#define XZAEC_SYN_ACT_BAF_MOD1				"Feu arret droit "
#define XZAEC_SYN_ACT_CFE_TXT   			"Plan de feux : "
#define XZAEC_SYN_ACT_BAF_MOD2				"Feu alerte droit "
#define XZAEC_SYN_ACT_BAF_MOD3 				"Barriere droite "
#define XZAEC_SYN_ACT_BAF_MOD4				"Feu arret gauche "
#define XZAEC_SYN_ACT_BAF_MOD5				"Feu alerte gauche "
#define XZAEC_SYN_ACT_BAF_MOD6				"Barriere gauche "
#define XZAEC_SYN_ACT_BAD_MOD1				"Flash "
#define XZAEC_SYN_ACT_BAD_MOD2				"Barriere "
#define XZAEC_SYN_ACT_BAF_FEUX_DROITS		"Feux arret et alerte droits "
#define XZAEC_SYN_ACT_BAF_GLOBAL_DROIT		"Barriere, feux arret et alerte droits "
#define XZAEC_SYN_ACT_BAF_FEUX_GAUCHES		"Feux arret et alerte gauches "
#define XZAEC_SYN_ACT_BAF_GLOBAL_GAUCHE		"Barriere, feux arret et alerte gauches "
