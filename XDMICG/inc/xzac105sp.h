/*E*/
/*Fichier :  $Id: xzac105sp.h,v 1.1 2008/02/13 13:24:20 devgtie Exp $      Release : $Revision: 1.1 $        Date : $Date: 2008/02/13 13:24:20 $
------------------------------------------------------
...
/*-----------------------------------------------------
* Service rendu
* Action de configuration des voies du domaine protection incendie par sequence.
* 
* Sequence d'appel
* SP	XZAC105_Commande_Seq_INC
* 
* Arguments en entree
...
* 
* Inserer dans la table ACTION et la table AFFICHAGE__INC.
...
#define XZAC105_Commande_Seq_EXP	"XZAC;105" 
