/*E*/
/*Fichier : $Id: ex_xzao170.c,v 1.1 1994/10/05 19:35:32 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:32 $
------------------------------------------------------
* GTIE *  AdresseOJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao170.c
*               fait appel a xzag et xzao170
------------------------------------------------------
...
*  Fait appel a XZAO170_Ajouter_SeqAut_Tunnel_Ech
...
static char *version = "@(#)ex_xzao170.c	1.1 10/03/94 : XZAO" ;
...
------------------------------------------------------*/
{
	...
	XZAOT_ConfSeqAutTun	va_Sequence_in;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Sequence_in.NomSequence,"Sequence T1");
	strcpy(va_Sequence_in.NomTube,"ECH 1");
	va_Sequence_in.Adresse = 10;
	va_Sequence_in.BitComm = 1;
	va_Sequence_in.BitDiscordance = 1;
	va_Sequence_in.Creation = 1;
	
	retcode =  XZAO170_Ajouter_SeqAut_Tunnel (va_Basedd_in,va_Sequence_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO170_Ajouter_SeqAut_Tunnel retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Sequence_in.NomSequence,"Sequence T2");
	strcpy(va_Sequence_in.NomTube,"ECH 1");
