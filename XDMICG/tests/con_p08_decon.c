/*E*/
/*  Fichier : $Id: con_p08_decon.c,v 1.2 1994/09/08 22:12:17 volcic Exp $      Release : $Revision: 1.2 $        Date : $Date: 1994/09/08 22:12:17 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAP * FICHIER con_p08_decon.c
*               fait appel a xzag et xzap08
------------------------------------------------------
...
*  Fait appel a XZAP08_Ajout_Prop_Tel
...
static char *version = "@(#)con_p08_decon.c	1.1 08/24/94 : XZAP" ;

/* definition de fonctions externes */

/*X------------------------------------------------------
* SERVICE RENDU : 
*  < Appel la procedure stockee XZAP08SP >
*
------------------------------------------------------
* SEQUENCE D'APPEL :
*/
...
------------------------------------------------------*/
{
	...
	XDY_Nom		Libelle;
	XDY_PR		PR_In=520205;
	XDY_Autoroute	NumeroAutoroute_In=2;
	XDY_Octet	TypeDAstreinte_In=1;
...
/*	retcode = XZSC_InitTrace();*/
        ...
        /* Remarque_In.len=50; */
        strcpy(Remarque,"Remarque Tel");

	/* Explication_In.len=250; */
        strcpy(Explication,"Ceci est un Tel");
        
	/* Libelle_In.len=25; */
        strcpy(Libelle,"Libelle Tel");
	...
	retcode =  XZAP08_Ajout_Prop_Tel( NumPA_In,Ordre_In,District_In,Remarque,Explication,Libelle,PR_In,NumeroAutoroute_In,TypeDAstreinte_In);
	
	
	printf("\n\n*********\nXZAP08_Ajout_Prop_Tel retourne :%d\n******\n",retcode);
