/*E*/
/*Fichier : $Id: ex_xzao68.c,v 1.1 1994/10/05 19:36:10 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:36:10 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao68.c
*               fait appel a xzag et xzao68
------------------------------------------------------
...
*  Fait appel a XZAO68_Ajouter_Chaussee_Ech
...
static char *version = "@(#)ex_xzao68.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Chaussee_in.NomStation,"RADT 1");
	va_Chaussee_in.PR = 168000;
	va_Chaussee_in.Sens = 1;
	
	
	retcode =  XZAO68_Ajouter_Chaussee (va_Basedd_in,va_Chaussee_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO68_Ajouter_Chaussee retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Chaussee_in.NomStation,"RADT 1");
	va_Chaussee_in.PR = 170000;
	va_Chaussee_in.Sens = 0;
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Chaussee_in.NomStation,"RADT 2");
	va_Chaussee_in.PR = 179000;
	va_Chaussee_in.Sens = 1;
