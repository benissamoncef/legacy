/*E*/
/*Fichier : $Id: ex_xzao57.c,v 1.1 1994/10/05 19:35:55 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:55 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao57.c
*               fait appel a xzag et xzao57
------------------------------------------------------
...
*  Fait appel a XZAO57_Ajouter_Noeud
...
static char *version = "@(#)ex_xzao57.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Noeud_in.NomPortion1,"Por_1");
	strcpy(va_Noeud_in.NomPortion2,"Por_2");
	va_Noeud_in.ExtremitePortion1 = 1;
	va_Noeud_in.ExtremitePortion2 = 1;
	va_Noeud_in.Creation = 1;
	
	retcode =  XZAO57_Ajouter_Noeud(va_Basedd_in,va_Noeud_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO57_Ajouter_Noeud retourne :%d\n******\n",retcode);
