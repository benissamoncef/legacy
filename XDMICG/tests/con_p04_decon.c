/*X  Fichier : @(#)con_p04_decon.c	1.1      Release : 1.1        Date : 08/24/94
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAP * FICHIER con_p04_decon.c
*               fait appel a xzag et xzap04
------------------------------------------------------
...
*  Fait appel a XZAP04_Ajout_Prop_Tunnel
...
static char *version = "@(#)con_p04_decon.c	1.1 08/24/94 : XZAP" ;

/* definition de fonctions externes */

/*X------------------------------------------------------
* SERVICE RENDU : 
*  < Appel la procedure stockee XZAP04SP >
*
------------------------------------------------------
* SEQUENCE D'APPEL :
*/
...
/*	retcode = XZSC_InitTrace();*/
	...
	retcode =  XZAP04_Ajout_Prop_Tunnel( NumPA_In,Ordre_In,District_In,Remarque_In,PrioriteEvt_In,NoEqt_In,Explication_In,Libelle_In,Scenario_In,Realisable_In);
	
	
	printf("\n\n*********\nXZAP04_Ajout_Prop_Tunnel retourne :%d\n******\n",retcode);
