/*E*/
/*Fichier : $Id: ex_xzao61.c,v 1.1 1994/10/05 19:35:59 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:59 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao61.c
*               fait appel a xzag et xzao61
------------------------------------------------------
...
*  Fait appel a XZAO61_Ajouter_Pente
...
static char *version = "@(#)ex_xzao61.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Pente_in.NomPortion,"Por_1");
	strcpy(va_Pente_in.Autoroute,"A800");
	va_Pente_in.PRdebut = 125543;
	va_Pente_in.PRfin = 135253;
	va_Pente_in.Pente = 25;
	strcpy(va_Pente_in.NomPente,"Pente Douce");
	va_Pente_in.Creation = 1;
	
	retcode =  XZAO61_Ajouter_Pente(va_Basedd_in,va_Pente_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO61_Ajouter_Pente retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Pente_in.Autoroute,"A800");
	va_Pente_in.PRdebut = 125543;
	va_Pente_in.PRfin = 135000;
	va_Pente_in.Pente = 35;
	strcpy(va_Pente_in.NomPente,"Descente");
	va_Pente_in.Creation = 1;
