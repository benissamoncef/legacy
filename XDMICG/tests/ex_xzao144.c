/*E*/
/*Fichier : $Id: ex_xzao144.c,v 1.1 1994/10/05 19:35:08 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:08 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao144.c
*               fait appel a xzag et xzao144
------------------------------------------------------
...
*  Fait appel a XZAO144_Ajouter_PAU_Ech
...
static char *version = "@(#)ex_xzao144.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_PAU_in.Nom,"PAU 1");
	strcpy(va_PAU_in.NomPIRAU,"RAU 1");
	strcpy(va_PAU_in.Autoroute,"A800");
	va_PAU_in.PR = 175000;
	va_PAU_in.Sens = 1;
	strcpy(va_PAU_in.CodeAntenne,"ca1");
	strcpy(va_PAU_in.CodePAU,"p1");
	
	retcode =  XZAO144_Ajouter_PAU (va_Basedd_in,va_PAU_in,&va_Resultat_out);
	
	printf("\n\n*********\nXZAO144_Ajouter_PAU retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_PAU_in.Nom,"PAU 2");
	strcpy(va_PAU_in.NomPIRAU,"RAU 2");
	strcpy(va_PAU_in.Autoroute,"A800");
	va_PAU_in.PR = 185000;
	va_PAU_in.Sens = 1;
	strcpy(va_PAU_in.CodeAntenne,"ca2");
	strcpy(va_PAU_in.CodePAU,"p2");
