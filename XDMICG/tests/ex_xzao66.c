/*E*/
/*Fichier : $Id: ex_xzao66.c,v 1.1 1994/10/05 19:36:07 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:36:07 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao66.c
*               fait appel a xzag et xzao66
------------------------------------------------------
...
*  Fait appel a XZAO66_Ajouter_Serveur_Terminaux
...
static char *version = "@(#)ex_xzao66.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Serveur_in.NomServeur,"SDCI1");
	strcpy(va_Serveur_in.NomMaitre,"SDDN1");
	
	retcode =  XZAO66_Ajouter_Serveur_Terminaux(va_Basedd_in,va_Serveur_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO66_Ajouter_Serveur_Terminaux retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Serveur_in.NomServeur,"SDCI1");
	strcpy(va_Serveur_in.NomMaitre,"SDDM1");
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Serveur_in.NomServeur,"SDDM1");
	strcpy(va_Serveur_in.NomMaitre,"SDDN1");
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Serveur_in.NomServeur,"SDDN1");
	strcpy(va_Serveur_in.NomMaitre,"");
