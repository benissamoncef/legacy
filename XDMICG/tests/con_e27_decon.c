/*E*/
/*  Fichier : $Id: con_e27_decon.c,v 1.1 1994/09/15 17:37:25 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/09/15 17:37:25 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAE * FICHIER con_e27_decon.c
*               fait appel a xzag et xzae27
------------------------------------------------------
...
*  Fait appel a XZAE27_Decrire_Pb_Veh_PA
...
static char *version = "@(#)con_e27_decon.c	1.1 08/27/94 : XZAE" ;
...
------------------------------------------------------*/
{
	/* XDY_Horodate 	Horodate=22767767;765634332 */
...
/*	retcode = XZSC_InitTrace();*/
	...
	retcode =  XZAE27_Decrire_Pb_Veh_PA( va_Horodate,va_NumEvt, &va_Vehicule);
	
	printf("\n\n*********\nXZAE27_Decrire_Pb_Veh_PA retourne :%d\n******\n",retcode);

	printf("\nva_Vehicule.Type = %d\nva_Vehicule.Passagers = %d\nva_Vehicule.Bebe = %d\nva_Vehicule.PersAgee = %d\nva_Vehicule.Animaux = %d\nva_Vehicule.VehEscota = %d\nva_Vehicule.Chargement = %d\nva_Vehicule.CodeMat = %s\nva_Vehicule.Enleve = %d\n va_Vehicule.Texte = %s\n",
	va_Vehicule.Type,
	va_Vehicule.Passagers,
	va_Vehicule.Bebe,
	va_Vehicule.PersAgee,
	va_Vehicule.Animaux,
	va_Vehicule.VehEscota,
	va_Vehicule.Chargement,
	va_Vehicule.CodeMat,
	va_Vehicule.Enleve,
	va_Vehicule.Texte);
