/*E*/
/*Fichier : $Id: ex_xzao94.c,v 1.1 1994/10/05 19:36:34 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:36:34 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao94.c
*               fait appel a xzag et xzao94
------------------------------------------------------
...
*  Fait appel a XZAO94_Ajouter_Ville
...
static char *version = "@(#)ex_xzao94.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy( va_Ville_in.Nom, "Nice" );
	va_Ville_in.Creation = 1;
	
	retcode =  XZAO94_Ajouter_Ville(va_Basedd_in,va_Ville_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO94_Ajouter_Ville retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy( va_Ville_in.Nom, "Antibes" );
	va_Ville_in.Creation = 1;
