/*E*/
/*Fichier : $Id: ex_xzao92.c,v 1.1 1994/10/05 19:36:33 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:36:33 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao92.c
*               fait appel a xzag et xzao92
------------------------------------------------------
...
*  Fait appel a XZAO92_Ajouter_Reseau
...
static char *version = "@(#)ex_xzao92.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy( va_Reseau_in.NomReseau, "Reseau 1" );
	va_Reseau_in.TypeReseau = 1;
	strcpy( va_Reseau_in.Autoroute, "A800" );
	va_Reseau_in.PR = 154021;
	va_Reseau_in.Creation = 1;
	
	retcode =  XZAO92_Ajouter_Reseau(va_Basedd_in,va_Reseau_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO92_Ajouter_Reseau retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy( va_Reseau_in.NomReseau, "Reseau 1" );
	va_Reseau_in.TypeReseau = 2;
	strcpy( va_Reseau_in.Autoroute, "A800" );
	va_Reseau_in.PR = 154800;
	va_Reseau_in.Creation = 1;
