/*E*/
/*Fichier : $Id: ex_xzao86.c,v 1.1 1994/10/05 19:36:25 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:36:25 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao86.c
*               fait appel a xzag et xzao86
------------------------------------------------------
...
*  Fait appel a XZAO86_Ajouter_Aire
...
static char *version = "@(#)ex_xzao86.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	va_Aire_in.Numero = 1;
	strcpy( va_Aire_in.NomAire, "Aire de Repos" );
	strcpy( va_Aire_in.Abreviation, "Aire Rep" );
	strcpy( va_Aire_in.Autoroute, "A800" );
	va_Aire_in.Sens = 1;
	va_Aire_in.PRentree = 125900;
	va_Aire_in.PRsortie = 127050;
	va_Aire_in.Creation = 1;
	
	retcode =  XZAO86_Ajouter_Aire(va_Basedd_in,va_Aire_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO86_Ajouter_Aire retourne :%d\n******\n",retcode);
	...
	*/
	...
	va_Aire_in.Numero = 1;
	strcpy( va_Aire_in.NomAire, "Aire de Repos" );
	strcpy( va_Aire_in.Abreviation, "Aire Midi" );
	strcpy( va_Aire_in.Autoroute, "A800" );
	va_Aire_in.Sens = 1;
	va_Aire_in.PRentree = 125900;
	va_Aire_in.PRsortie = 127050;
