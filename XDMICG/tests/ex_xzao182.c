/*E*/
/*Fichier : $Id: ex_xzao182.c,v 1.1 1994/10/05 19:35:45 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:45 $
------------------------------------------------------
* GTIE *  AdresseOJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao182.c
*               fait appel a xzag et xzao182
------------------------------------------------------
...
*  Fait appel a XZAO182_Ajouter_FAV_Ech
...
static char *version = "@(#)ex_xzao182.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_FAV_in.NomFAV,"FAV 1");
	strcpy(va_FAV_in.Autoroute,"A800");
	strcpy(va_FAV_in.NomTube,"ECH 1");
	va_FAV_in.PR = 185010;
	va_FAV_in.Sens = 1;
	va_FAV_in.Voie = 1;
	va_FAV_in.RangComm = 1;
	va_FAV_in.RangComm2 = 1;
	va_FAV_in.RangEtat = 1;
	va_FAV_in.RangEtat2 = 1;
	va_FAV_in.BitDiscordance = 1;
	va_FAV_in.BitDiscordance = 1;
	
	retcode =  XZAO182_Ajouter_FAV (va_Basedd_in,va_FAV_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO182_Ajouter_FAV retourne :%d\n******\n",retcode);
	...
	*/
	...
	va_FAV_in.Sens = 1;
	va_FAV_in.Voie = 1;
	va_FAV_in.RangComm = 2;
	va_FAV_in.RangComm2 = 1;
	va_FAV_in.RangEtat = 1;
	va_FAV_in.RangEtat2 = 1;
	va_FAV_in.BitDiscordance = 2;
	va_FAV_in.BitDiscordance = 1;
