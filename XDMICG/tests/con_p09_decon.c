/*E*/
/*  Fichier : $Id: con_p09_decon.c,v 1.2 1994/09/08 22:12:28 volcic Exp $      Release : $Revision: 1.2 $        Date : $Date: 1994/09/08 22:12:28 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAP * FICHIER con_p09_decon.c
*               fait appel a xzag et xzap09
------------------------------------------------------
...
*  Fait appel a XZAP09_Ajout_Dest_Fax
...
static char *version = "@(#)con_p09_decon.c	1.1 09/24/94 : XZAP" ;

/* definition de fonctions externes */

/*X------------------------------------------------------
* SERVICE RENDU : 
*  < Appel la procedure stockee XZAP09SP >
*
------------------------------------------------------
* SEQUENCE D'APPEL :
*/
...
/*	retcode = XZSC_InitTrace();*/
	...
	retcode =  XZAP09_Ajout_Dest_Fax( NumPA_In,Ordre_In,PR_In,NumeroAutoroute_In,TypeDAstreinte_In);
	
	
	printf("\n\n*********\nXZAP09_Ajout_Dest_Fax retourne :%d\n******\n",retcode);
