/*E*/
/*Fichier : $Id: ex_xzao146.c,v 1.1 1994/10/05 19:35:10 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:10 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao146.c
*               fait appel a xzag et xzao146
------------------------------------------------------
...
*  Fait appel a XZAO146_Ajouter_ITPC
...
static char *version = "@(#)ex_xzao146.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy( va_ITPC_in.Autoroute, "A800" );
	va_ITPC_in.PR = 164000;
	
	retcode =  XZAO146_Ajouter_ITPC (va_Basedd_in,va_ITPC_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO146_Ajouter_ITPC retourne :%d\n******\n",retcode);
