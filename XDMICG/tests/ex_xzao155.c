/*E*/
/*Fichier : $Id: ex_xzao155.c,v 1.1 1994/10/05 19:35:15 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:15 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao155.c
*               fait appel a xzag et xzao155
------------------------------------------------------
...
*  Fait appel a XZAO155_Ajouter_Scenario
...
static char *version = "@(#)ex_xzao155.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Scenario_in.Scenario,"Sc 1");
	strcpy(va_Scenario_in.Nom,"Scenario NAV 1");
	va_Scenario_in.Creation = 1;
	
	retcode =  XZAO155_Ajouter_Scenario(va_Basedd_in,va_Scenario_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO155_Ajouter_Scenario retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Scenario_in.Scenario,"Sc 2");
	strcpy(va_Scenario_in.Nom,"Scenario NAV 2");
	va_Scenario_in.Creation = 1;
