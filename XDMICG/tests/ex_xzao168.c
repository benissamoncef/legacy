/*E*/
/*Fichier : $Id: ex_xzao168.c,v 1.1 1994/10/05 19:35:30 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:30 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao168.c
*               fait appel a xzag et xzao168
------------------------------------------------------
...
*  Fait appel a XZAO168_Ajouter_Sequence_Tube
...
static char *version = "@(#)ex_xzao168.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Sequence_Tube_in.NomSequence,"Sequence T1");
	va_Sequence_Tube_in.Creation = 1;
	
	retcode =  XZAO168_Ajouter_Sequence_Tube(va_Basedd_in,va_Sequence_Tube_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO168_Ajouter_Sequence_Tube retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Sequence_Tube_in.NomSequence,"Sequence T1");
	va_Sequence_Tube_in.Creation = 0;
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Sequence_Tube_in.NomSequence,"Sequence T2");
	va_Sequence_Tube_in.Creation = 1;
