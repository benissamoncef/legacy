/*E*/
/*Fichier : $Id: ex_xzao157.c,v 1.1 1994/10/05 19:35:17 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:17 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao157.c
*               fait appel a xzag et xzao157
------------------------------------------------------
...
*  Fait appel a XZAO157_Ajouter_Type_NAV
...
static char *version = "@(#)ex_xzao157.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Type_NAV_in.NomType,"TYP_NAV 1");
	va_Type_NAV_in.FlashMod4 = 0;
	va_Type_NAV_in.NbBarrieres = 4;
	
	retcode =  XZAO157_Ajouter_Type_NAV(va_Basedd_in,va_Type_NAV_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO157_Ajouter_Type_NAV retourne :%d\n******\n",retcode);
	...
	*/
	...
	printf("\n** Test 4 de la procedure stockee **\n");
	
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Type_NAV_in.NomType,"TYP_NAV 2");
	va_Type_NAV_in.FlashMod4 = 0;
	va_Type_NAV_in.NbBarrieres = 5;
