/*E*/
/*Fichier : $Id: ex_xzao141.c,v 1.1 1994/10/05 19:35:01 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:01 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao141.c
*               fait appel a xzag et xzao141
------------------------------------------------------
...
*  Fait appel a XZAO141_Ajouter_Magnetoscope_Ech
...
static char *version = "@(#)ex_xzao141.c	1.1 10/03/94 : XZAO" ;
...
------------------------------------------------------*/
{
	...
	XZAOT_ConfMagneto	va_Magnetoscope_in;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Magnetoscope_in.Nom,"MAG 1");
	strcpy(va_Magnetoscope_in.Code,"M1");
	strcpy(va_Magnetoscope_in.NomSysVideo,"Video 1");
	
	retcode =  XZAO141_Ajouter_Magnetoscope (va_Basedd_in,va_Magnetoscope_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO141_Ajouter_Magnetoscope retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Magnetoscope_in.Nom,"MAG 1");
	strcpy(va_Magnetoscope_in.Code,"M1");
	strcpy(va_Magnetoscope_in.NomSysVideo,"Video 2");
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Magnetoscope_in.Nom,"MAG 2");
	strcpy(va_Magnetoscope_in.Code,"M2");
	strcpy(va_Magnetoscope_in.NomSysVideo,"Video 1");
