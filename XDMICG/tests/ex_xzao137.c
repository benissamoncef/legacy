/*E*/
/*Fichier : $Id: ex_xzao137.c,v 1.1 1994/10/05 19:34:53 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:34:53 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao137.c
*               fait appel a xzag et xzao137
------------------------------------------------------
...
*  Fait appel a XZAO137_Ajouter_SystemeVideo
...
static char *version = "@(#)ex_xzao137.c	1.1 10/03/94 : XZAO" ;
...
------------------------------------------------------*/
{
	...
	XZAOT_ConfSyVideo	va_SysVideo_in;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_SysVideo_in.Nom,"Video 1");
	strcpy(va_SysVideo_in.NomServeur,"SDDM1");
	va_SysVideo_in.Liaison = 1;
	strcpy(va_SysVideo_in.RGS, "rgs");
	
	retcode =  XZAO137_Ajouter_SystemeVideo(va_Basedd_in,va_SysVideo_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO137_Ajouter_SystemeVideo retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_SysVideo_in.Nom,"Video 2");
	strcpy(va_SysVideo_in.NomServeur,"SDDM1");
	va_SysVideo_in.Liaison = 2;
	strcpy(va_SysVideo_in.RGS, "rgs");
