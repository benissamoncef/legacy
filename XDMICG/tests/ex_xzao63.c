/*E*/
/*Fichier : $Id: ex_xzao63.c,v 1.1 1994/10/05 19:36:01 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:36:01 $
------------------------------------------------------
* GTIE *  AdresseOJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao63.c
*               fait appel a xzag et xzao63
------------------------------------------------------
...
*  Fait appel a XZAO63_Ajouter_Influence_Station_Ech
...
static char *version = "@(#)ex_xzao63.c	1.1 10/03/94 : XZAO" ;
...
------------------------------------------------------*/
{
	...
	XZAOT_ConfInfluence	va_Influence_in;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Influence_in.NomPortion,"Por_1");
	strcpy(va_Influence_in.NomStation,"RADT 1");
	va_Influence_in.Sens = 1;
	va_Influence_in.PRdebut = 155543;
	va_Influence_in.PRfin = 165253;
	va_Influence_in.Creation = 1;
	
	retcode =  XZAO63_Ajouter_Influence_Station (va_Basedd_in,va_Influence_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO63_Ajouter_Influence_Station retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Influence_in.NomStation,"RADT 1");
	va_Influence_in.Sens = 1;
	va_Influence_in.PRdebut = 164000;
	va_Influence_in.PRfin = 165253;
	va_Influence_in.Creation = 1;
