/*E*/
/*Fichier : $Id: ex_xzao174.c,v 1.1 1994/10/05 19:35:37 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:37 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao174.c
*               fait appel a xzag et xzao174
------------------------------------------------------
...
*  Fait appel a XZAO174_Ajouter_Sequence_Ech
...
static char *version = "@(#)ex_xzao174.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Sequence_Ech_in.NomSequence,"Sequence E1");
	va_Sequence_Ech_in.Creation = 1;
	
	retcode =  XZAO174_Ajouter_Sequence_Ech(va_Basedd_in,va_Sequence_Ech_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO174_Ajouter_Sequence_Ech retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Sequence_Ech_in.NomSequence,"Sequence E2");
	va_Sequence_Ech_in.Creation = 1;
