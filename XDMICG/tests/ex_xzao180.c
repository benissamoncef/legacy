/*E*/
/*Fichier : $Id: ex_xzao180.c,v 1.1 1994/10/05 19:35:43 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:43 $
------------------------------------------------------
* GTIE *  AdresseOJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao180.c
*               fait appel a xzag et xzao180
------------------------------------------------------
...
*  Fait appel a XZAO180_Ajouter_Capteur_Tunnel_Ech
...
static char *version = "@(#)ex_xzao180.c	1.1 10/03/94 : XZAO" ;
...
------------------------------------------------------*/
{
	...
	XZAOT_ConfCaptTun	va_Capteur_in;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Capteur_in.NomCapteur,"CPT 1");
	strcpy(va_Capteur_in.Autoroute,"A800");
	strcpy(va_Capteur_in.NomTube,"ECH 1");
	va_Capteur_in.PR = 185010;
	va_Capteur_in.Sens = 1;
	va_Capteur_in.Type = 1;
	va_Capteur_in.NumBit = 1;
	
	retcode =  XZAO180_Ajouter_Capteur_Tunnel (va_Basedd_in,va_Capteur_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO180_Ajouter_Capteur_Tunnel retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Capteur_in.NomCapteur,"CPT 2");
	strcpy(va_Capteur_in.Autoroute,"A800");
	strcpy(va_Capteur_in.NomTube,"ECH 1");
	va_Capteur_in.PR = 185012;
	va_Capteur_in.Sens = 1;
	va_Capteur_in.Type = 1;
	va_Capteur_in.NumBit = 1;
