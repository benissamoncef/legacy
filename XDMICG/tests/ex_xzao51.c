/*E*/
/*Fichier : $Id: ex_xzao51.c,v 1.1 1994/10/05 19:35:49 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:49 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao51.c
*               fait appel a xzag et xzao51
------------------------------------------------------
...
static char *version = "@(#)ex_xzao51.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	strcpy(va_Autoroute_in,"A800");
	
	retcode =  XZAO51_Ajouter_Autoroute(va_Basedd_in,va_Autoroute_in,&va_Resultat_out );
