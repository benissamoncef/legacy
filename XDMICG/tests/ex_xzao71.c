/*E*/
/*Fichier : $Id: ex_xzao71.c,v 1.1 1994/10/05 19:36:16 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:36:16 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao71.c
*               fait appel a xzag et xzao71
------------------------------------------------------
...
*  Fait appel a XZAO71_Ajouter_Type_Picto
...
static char *version = "@(#)ex_xzao71.c	1.1 10/03/94 : XZAO" ;
...
------------------------------------------------------*/
{
	...
	XZAOT_ConfTypPicto	va_Type_Picto_in;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Type_Picto_in.NomType,"Type Picto 1");
	va_Type_Picto_in.NombreCaracteres = 50;
	strcpy(va_Type_Picto_in.FichierPanneau, "Fichier 1");
	
	retcode =  XZAO71_Ajouter_Type_Picto(va_Basedd_in,va_Type_Picto_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO71_Ajouter_Type_Picto retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Type_Picto_in.NomType,"Type Picto 1");
	va_Type_Picto_in.NombreCaracteres = 12;
	strcpy(va_Type_Picto_in.FichierPanneau, "Fichier 1");
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Type_Picto_in.NomType,"Type Picto 2");
	va_Type_Picto_in.NombreCaracteres = 24;
	strcpy(va_Type_Picto_in.FichierPanneau, "Fichier 2");
