/*E*/
/*Fichier : $Id: ex_xzao70.c,v 1.1 1994/10/05 19:36:14 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:36:14 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao70.c
*               fait appel a xzag et xzao70
------------------------------------------------------
...
*  Fait appel a XZAO70_Ajouter_Type_PMV
...
static char *version = "@(#)ex_xzao70.c	1.1 10/03/94 : XZAO" ;
...
------------------------------------------------------*/
{
	...
	XZAOT_ConfTypPMV	va_Type_PMV_in;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Type_PMV_in.NomType,"Type_PMV 1");
	va_Type_PMV_in.NombreLignes = 4;
	va_Type_PMV_in.NombreCaracteres = 50;
	va_Type_PMV_in.Flash = 1;
	va_Type_PMV_in.Temperature = 1;
	
	retcode =  XZAO70_Ajouter_Type_PMV(va_Basedd_in,va_Type_PMV_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO70_Ajouter_Type_PMV retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Type_PMV_in.NomType,"Type_PMV 2");
	va_Type_PMV_in.NombreLignes = 8;
	va_Type_PMV_in.NombreCaracteres = 250;
	va_Type_PMV_in.Flash = 1;
	va_Type_PMV_in.Temperature = 0;
