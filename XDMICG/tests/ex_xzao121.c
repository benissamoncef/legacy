/*E*/
/*Fichier : $Id: ex_xzao121.c,v 1.1 1994/10/05 19:34:51 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:34:51 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao121.c
*               fait appel a xzag et xzao121
------------------------------------------------------
...
*  Fait appel a XZAO121_Ajouter_Panneau_Police
...
static char *version = "@(#)ex_xzao121.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy( va_PnPOL_in.NomPortion, "Por_1" );
	va_PnPOL_in.PR = 164000;
	va_PnPOL_in.Sens = 1;
	va_PnPOL_in.Vitesse = 150;
	va_PnPOL_in.Creation = 1;
	
	retcode =  XZAO121_Ajouter_Panneau_Police (va_Basedd_in,va_PnPOL_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO121_Ajouter_Panneau_Police retourne :%d\n******\n",retcode);
