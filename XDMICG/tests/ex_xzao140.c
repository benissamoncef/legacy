/*E*/
/*Fichier : $Id: ex_xzao140.c,v 1.1 1994/10/05 19:34:59 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:34:59 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao140.c
*               fait appel a xzag et xzao140
------------------------------------------------------
...
*  Fait appel a XZAO140_Ajouter_Moniteur_Ech
...
static char *version = "@(#)ex_xzao140.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	*/
	...
	strcpy(va_Moniteur_in.Nom,"MNT 1");
	strcpy(va_Moniteur_in.Code,"M1");
	strcpy(va_Moniteur_in.NomSysVideo,"Video 1");
	strcpy(va_Moniteur_in.MachineOperateur,"MAA 1");
	
	retcode =  XZAO140_Ajouter_Moniteur (va_Basedd_in,va_Moniteur_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO140_Ajouter_Moniteur retourne :%d\n******\n",retcode);
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Moniteur_in.Nom,"MNT 1");
	strcpy(va_Moniteur_in.NomSysVideo,"Video 2");
	strcpy(va_Moniteur_in.MachineOperateur,"MAA 1");
	...
	*/
	...
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_Moniteur_in.Nom,"MNT 2");
	strcpy(va_Moniteur_in.Code,"M2");
	strcpy(va_Moniteur_in.NomSysVideo,"Video 1");
	strcpy(va_Moniteur_in.MachineOperateur,"MAA 1");
