/*E*/
/*Fichier : $Id: ex_xzao53.c,v 1.1 1994/10/05 19:35:51 volcic Exp $      Release : $Revision: 1.1 $        Date : $Date: 1994/10/05 19:35:51 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER ex_xzao53.c
*               fait appel a xzag et xzao53
------------------------------------------------------
...
*  Fait appel a XZAO53_Ajouter_District
...
static char *version = "@(#)ex_xzao53.c	1.1 10/03/94 : XZAO" ;
...
/*	retcode = XZSC_InitTrace();*/
	...
	strcpy(va_District_in.NomDistrict,"Mandelieu");
	strcpy(va_District_in.Abreviation,"DM");
	
	retcode =  XZAO53_Ajouter_District(va_Basedd_in,va_District_in,&va_Resultat_out );
	
	printf("\n\n*********\nXZAO53_Ajouter_District retourne :%d\n******\n",retcode);

	printf("\nva_Resultat_out = %d \n",va_Resultat_out);
				
	strcpy(va_Basedd_in,"CFG");
	strcpy(va_District_in.NomDistrict,"Nice");
	strcpy(va_District_in.Abreviation,"DN");
