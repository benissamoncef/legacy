/*E*/
/*Fichier : $Id: xzao167.c,v 1.3 2016/07/13 12:43:09 devgfi Exp $      Release : $Revision: 1.3 $        Date : $Date: 2016/07/13 12:43:09 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao167.c
------------------------------------------------------
...
static char *version = "$Id: xzao167.c,v 1.3 2016/07/13 12:43:09 devgfi Exp $ : xzao167" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des sequences tubes et
...
int xzao167_Lire_Config_Sequences_Tube ( 	FILE  		*pa_Fd,
...
*       XZAOT_ConfSeqTube 	contenu de ligne
*       XDY_Entier 		NumLigne
...
{
   static char *version = "$Id: xzao167.c,v 1.3 2016/07/13 12:43:09 devgfi Exp $ : xzao167_Lire_Config_Sequences_Tube" ;
   
   XZAOT_ConfSeqTube	vl_SeqTube;
   char			vl_Lig[255];
   char			*vl_Texte;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao167: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao167 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao167 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             
             vl_SeqTube.Creation = atoi( vl_Texte_out );
             ...
             strcpy ( vl_SeqTube.NomSequence, vl_Texte_out );
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_SeqTube, vl_num_ligne ) ) != XDC_OK )
                {    
             ...
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao167: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
