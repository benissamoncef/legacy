/*E*/
/*Fichier : $Id: xzao156.c,v 1.3 2016/07/13 12:43:08 devgfi Exp $      Release : $Revision: 1.3 $        Date : $Date: 2016/07/13 12:43:08 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao156.c
------------------------------------------------------
...
static char *version = "$Id: xzao156.c,v 1.3 2016/07/13 12:43:08 devgfi Exp $ : xzao156" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des TypNAV et
...
int xzao156_Lire_Config_Type_NAV ( 	FILE  		*pa_Fd,
...
*       XZAOT_ConfTypNAV 	contenu de ligne
*       XDY_Entier 		NumLigne
...
{
   static char *version = "$Id: xzao156.c,v 1.3 2016/07/13 12:43:08 devgfi Exp $ : xzao156_Lire_Config_Type_NAV" ;
   
   XZAOT_ConfTypNAV	vl_TypNAV;
   char			vl_Lig[255];
   char			*vl_Texte;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao156: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao156 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao156 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             
             strcpy ( vl_TypNAV.NomType, vl_Texte_out );
             ...
             vl_TypNAV.FlashMod4 = atoi ( vl_Texte_out );
             ...
             vl_TypNAV.NbBarrieres = atoi ( vl_Texte_out );
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_TypNAV, vl_num_ligne ) ) != XDC_OK )
                {    
             ...
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao156: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
