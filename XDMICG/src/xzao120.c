/*E*/
/*Fichier : $Id: xzao120.c,v 1.4 2016/07/13 12:43:07 devgfi Exp $      Release : $Revision: 1.4 $        Date : $Date: 2016/07/13 12:43:07 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao120.c
------------------------------------------------------
...
static char *version = "$Id: xzao120.c,v 1.4 2016/07/13 12:43:07 devgfi Exp $ : xzao120" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des Panneau_Police et
...
int xzao120_Lire_Config_Panneau_Police (FILE  		*pa_Fd,
...
*       XZAOT_ConfPnPol1 	contenu de ligne
*       XDY_Entier 		NumLigne
...
{
   static char *version = "$Id: xzao120.c,v 1.4 2016/07/13 12:43:07 devgfi Exp $ : xzao120_Lire_Config_Panneau_Police" ;
   
   XZAOT_ConfPnPol	vl_PnPol;
   char			vl_Lig[255];
   char			*vl_Texte;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao120: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao120 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao120 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             
             vl_PnPol.Creation = atoi ( vl_Texte_out );
             ...
             strcpy ( vl_PnPol.NomPortion, vl_Texte_out );
             ...
             sscanf ( vl_Texte_out, "%d", &vl_PnPol.PR );
             ...
             vl_PnPol.Sens = atoi ( vl_Texte_out );
             ...
             vl_PnPol.Vitesse = atoi ( vl_Texte_out );
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_PnPol, vl_num_ligne ) ) != XDC_OK )
                {    
             ...
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao120: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
...
/* Fin de la fonction xzao120_Lire_Config_Panneau_Police */
