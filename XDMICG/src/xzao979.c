/*E*/
/*Fichier :  $Id: xzao979.c,v 1.2 2016/07/13 12:43:17 devgfi Exp $      Release : $Revision: 1.2 $        Date : $Date: 2016/07/13 12:43:17 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao979.c
------------------------------------------------------
...
* HISTORIQUE :
*
* AAZ    15 Nov 1994    : Creation DEM 662
...
static char *version = "$Id: xzao979.c,v 1.2 2016/07/13 12:43:17 devgfi Exp $ : xzao979" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des Demi echangeurs et
...
int xzao979_Lire_Config_Demi_Ech_Renove ( FILE              *pa_Fd,
...
*       XZAOT_ConfDemiEchRenove     contenu de ligne
*       XDY_Entier                  NumLigne
...
{
    static char *version = "$Id: xzao979.c,v 1.2 2016/07/13 12:43:17 devgfi Exp $ : xzao979_Lire_Config_Demi_Ech_Renove" ;
   
    XZAOT_ConfDemiEchRenove  vl_DemiEch;
    char                     vl_Lig[255];
    char                     *vl_Texte;
    ...
    */
    ...
    if (pa_Fd == NULL)
    {
        XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao979: fichier non existant");
        return ( XDC_NOK );
    }
            ...
            */
            ...
            if (vl_retcode != XDC_OK) 
            {
                ...
                */
                ...
                {  
                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao979 : Saisie  non valide");
                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao979 : retourne %d",XDC_NOK);
                    return ( XDC_NOK );
                }
                ...
                */
                ...
                else
                {
                    ...
                    */
                    ...
                    XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao979: echec de l'appel de la fonction utilisateur");
                    return ( XDC_NOK );
                }
            }
        }
...
/* Fin de la fonction xzao979_Lire_Config_Demi_Ech_Renove */
