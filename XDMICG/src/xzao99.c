/*E*/
/*Fichier : $Id: xzao99.c,v 1.3 2016/07/13 12:43:19 devgfi Exp $      Release : $Revision: 1.3 $        Date : $Date: 2016/07/13 12:43:19 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao99.c
------------------------------------------------------
...
static char *version = "$Id: xzao99.c,v 1.3 2016/07/13 12:43:19 devgfi Exp $ : xzao99" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des Chaussees et
...
int xzao99_Lire_Config_Chaussee ( 	FILE  		*pa_Fd,
...
*       XZAOT_ConfChaussee 	contenu de ligne
*       XDY_Entier 		NumLigne
...
{
   static char *version = "$Id: xzao99.c,v 1.3 2016/07/13 12:43:19 devgfi Exp $ : xzao99_Lire_Config_Chaussee" ;
   
   XZAOT_ConfChau	vl_Chaussee;
   char			vl_Lig[255];
   char			*vl_Texte;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao99: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao99 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao99 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             
             strcpy ( vl_Chaussee.NomStation, vl_Texte_out );
             ...
             vl_Chaussee.Sens = atoi ( vl_Texte_out );
             ...
             vl_Chaussee.PR = atoi ( vl_Texte_out );
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_Chaussee, vl_num_ligne ) ) != XDC_OK )
                {    
             ...
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao99: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
...
/* Fin de la fonction xzao99_Lire_Config_Chaussee */
