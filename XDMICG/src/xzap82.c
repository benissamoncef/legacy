/*E*/
/*Fichier : $Id: xzap82.c,v 1.1 2012/07/04 10:47:22 pc2dpdy Exp $      Release : $Revision: 1.1 $        Date : $Date: 2012/07/04 10:47:22 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAP * FICHIER xzap82.c
------------------------------------------------------
...
static char *version = "@(#)xzap82.c	1.3 1.3 12/06/10 : xzap82" ;
...
int XZAP82_Ajout_Prop_PRV   (   XDY_Mot 	NumPA_In,
				XDY_Mot 	Ordre_In,
				...
				XDY_Nom		Libelle_In,
				XDY_Bandeau		Bandeau_In,
				XDY_VitesseRegulTxt	Vitesse_In,
...
------------------------------------------------------*/
{
	...
	static char *version = "@(#)xzap82.c	1.3 1.3 12/06/10 : XZAP82_Ajout_Prop_PRV" ;

	CS_CHAR *rpc_name =XZAOC_XZAP82_RPC_NAME;
	...
	"IN : XZAP82_Ajout_Prop_PRV : NumPA_In=%d Ordre_In=%d District_In=%d PrioriteEvt_In=%d NoEqt_In=%d Explication=%s Vitesse=%s Bandeau=%s Libelle=%s",
		NumPA_In,Ordre_In,District_In,PrioriteEvt_In,NoEqt_In,Explication_In,Vitesse_In, Bandeau_In, Libelle_In);
	...
	*/
	...
	{
	 	XZST_03EcritureTrace(XZSTC_WARNING,"xzap82: ct_cmd_alloc() a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAP82_Ajout_Prop_PRV retourne %d", retcode);
	...
	*/
	...
	{
		XZST_03EcritureTrace(XZSTC_WARNING,"xzap82: ct_command() a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAP82_Ajout_Prop_PRV retourne %d", retcode);
		asql_clean_cmd(connection, cmd);
		return (XDC_NOK);
	}
	...
	*/
			...
			CS_SIZEOF(CS_SMALLINT), CGS_PARAM_INDIC)) != CS_SUCCEED)
	{
		...
		XZST_03EcritureTrace(XZSTC_WARNING,"xzap82: ct_param(@NumPA_In) a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAP82_Ajout_Prop_PRV retourne %d", retcode);
		asql_clean_cmd(connection, cmd);
		return (XDC_NOK);
	}
			...
			CS_SIZEOF(CS_SMALLINT), CGS_PARAM_INDIC)) != CS_SUCCEED)
	{
		...
		XZST_03EcritureTrace(XZSTC_WARNING,"xzap82: ct_param(@Ordre_In) a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAP82_Ajout_Prop_PRV retourne %d", retcode);
		asql_clean_cmd(connection, cmd);
		return (XDC_NOK);
	}
			...
			CS_SIZEOF(CS_TINYINT), CGS_PARAM_INDIC)) != CS_SUCCEED)
	{
		...
		XZST_03EcritureTrace(XZSTC_WARNING,"xzap82: ct_param(District_In) a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAP82_Ajout_Prop_PRV retourne %d",retcode);
		asql_clean_cmd(connection, cmd);
		return (XDC_NOK);
	}
		...
		CS_SIZEOF(CS_TINYINT), CGS_PARAM_INDIC)) != CS_SUCCEED)
	{
		...
		XZST_03EcritureTrace(XZSTC_WARNING,"xzap82: ct_param(PrioriteEvt_In) a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAP82_Ajout_Prop_PRV retourne %d", retcode);
		asql_clean_cmd(connection, cmd);
		return (XDC_NOK);
	}
		...
		CS_SIZEOF(CS_SMALLINT), CGS_PARAM_INDIC)) != CS_SUCCEED)
	{
		...
		XZST_03EcritureTrace(XZSTC_WARNING,"xzap82: ct_param(NoEqt_In) a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAP82_Ajout_Prop_PRV retourne %d", retcode);
		asql_clean_cmd(connection, cmd);
		return (XDC_NOK);
	}
	...
	if ((retcode = ct_param(cmd, &datafmt, (CS_VOID *)Bandeau_In,
		strlen(Bandeau_In), CGS_PARAM_INDIC)) != CS_SUCCEED)
	{
	
		XZST_03EcritureTrace(XZSTC_WARNING,"xzap82: ct_param(Bandeau_In) a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAP82_Ajout_Prop_PRV retourne %d", retcode);
		asql_clean_cmd(connection, cmd);
		return (XDC_NOK);
	}
	...
	strcpy(datafmt.name ,"@Vitesse_In");
	datafmt.namelen   = CS_NULLTERM;
	datafmt.datatype  = CS_CHAR_TYPE; 
	datafmt.maxlength = strlen(Vitesse_In);
	datafmt.status    = CS_INPUTVALUE; 
	datafmt.locale    = NULL;

	if ((retcode = ct_param(cmd, &datafmt, (CS_VOID *)Vitesse_In,
		strlen(Vitesse_In), CGS_PARAM_INDIC)) != CS_SUCCEED)
	{
	
		XZST_03EcritureTrace(XZSTC_WARNING,"xzap82: ct_param(Vitesse_In) a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAP82_Ajout_Prop_PRV retourne %d", retcode);
		asql_clean_cmd(connection, cmd);
		return (XDC_NOK);
	}
		...
		strlen(Libelle_In), CGS_PARAM_INDIC)) != CS_SUCCEED)
	{
		...
		XZST_03EcritureTrace(XZSTC_WARNING,"xzap82: ct_param(Libelle_In) a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAP82_Ajout_Prop_PRV retourne %d", retcode);
		asql_clean_cmd(connection, cmd);
		return (XDC_NOK);
	}
	...
	*/
	...
	{
		XZST_03EcritureTrace(XZSTC_WARNING,"xzap82: ct_send() a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAP82_Ajout_Prop_PRV retourne %d", retcode);
		asql_clean_cmd(connection, cmd);
		return (XDC_NOK);
	}
				...
				*/
				switch ((int)res_type)
				{
					case  CS_ROW_RESULT:
						...
						XZST_03EcritureTrace(XZSTC_INFO,"xzap82: ROW RESULTS");
						break;

					case  CS_PARAM_RESULT:
						XZST_03EcritureTrace(XZSTC_INFO,"xzap82 : PARAMETER RESULTS\n");
						break;

					case  CS_STATUS_RESULT:
						retcode = asql_fetch (cmd, &SPstatus);
						XZST_03EcritureTrace(XZSTC_INFO,"xzap82 : CS_STATUS_RESULT = %ld", retcode);
						XZST_03EcritureTrace(XZSTC_INFO,"xzap82 : STATUS RESULT PROCEDURE STOCKEE = %ld", SPstatus);
						
						if (SPstatus != XDC_OK)
						{
						   XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAP82_Ajout_PRV retourne 1");
 						   asql_clean_cmd(connection, cmd);
	   					   return (XDC_NOK);
						}
						break;
				...
				case CS_MSG_RESULT:
					...
					*/
					...
					if (retcode != CS_SUCCEED)
					{
						...
						XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAP82_Ajout_PRV retourne %d", retcode);
						asql_clean_cmd(connection, cmd);
	   					return (XDC_NOK);
					}
					break;
