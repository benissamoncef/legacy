/*E*/
/*  Fichier : 	$Id: xzao166.c,v 1.3 1997/05/06 19:43:55 mismer Exp $      Release : $Revision: 1.3 $        Date : $Date: 1997/05/06 19:43:55 $
------------------------------------------------------
* GTIE *  LongueurITOROJET MIGRAZUR
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao166.c
------------------------------------------------------
...
static char *version = "$Id: xzao166.c,v 1.3 1997/05/06 19:43:55 mismer Exp $ : xzao166" ;
...
int XZAO166_Ajouter_GTC_NICE (	XDY_Basedd		va_Basedd_in,
...

{
	...
	static char *version = "$Id: xzao166.c,v 1.3 1997/05/06 19:43:55 mismer Exp $ : XZAO166_Ajouter_GTC_NICE" ;
	
	CS_CHAR *rpc_name = XZAOC_XZAO166_RPC_NAME;
	CS_CONTEXT      *context;
	...
	CS_INT          res_type;
	CS_SMALLINT     msg_id;
	int 		num_Tab_donnees2 = XZAOC_XZAO166_NB_PARM_RETURN;
	...
	*/
	...
	vl_LongueurITOR		 = va_GTC_NICE_in.LongueurITOR;
	vl_AdresseITOR		 = va_GTC_NICE_in.AdresseITOR;
	vl_LongueurETOR 	 = va_GTC_NICE_in.LongueurETOR;
	vl_AdresseETOR		 = va_GTC_NICE_in.AdresseETOR;
	vl_LongTelealarme	 = va_GTC_NICE_in.LongTelealarme;
	vl_AdresseTelealarme 	 = va_GTC_NICE_in.AdresseTelealarme;
	vl_LongTelecomEch 	 = va_GTC_NICE_in.LongTelecomEch;
	vl_AdresseTelecomEch 	 = va_GTC_NICE_in.AdresseTelecomEch;
	vl_LongTelecomTub 	 = va_GTC_NICE_in.LongTelecomTub;
	vl_AdresseTelecomTub 	 = va_GTC_NICE_in.AdresseTelecomTub;
	vl_LongTelesignEch 	 = va_GTC_NICE_in.LongTelesignEch;
	vl_AdresseTelesignEch 	 = va_GTC_NICE_in.AdresseTelesignEch;
	vl_LongTelesignTub 	 = va_GTC_NICE_in.LongTelesignTub;
	vl_AdresseTelesignTub 	 = va_GTC_NICE_in.AdresseTelesignTub;
	vl_LongSeqEch 		 = va_GTC_NICE_in.LongSeqEch;
	vl_AdresseSeqEch 	 = va_GTC_NICE_in.AdresseSeqEch;
	vl_LongSeqTub 	 	 = va_GTC_NICE_in.LongSeqTub;
	vl_AdresseSeqTub 	 = va_GTC_NICE_in.AdresseSeqTub;
	vl_LongAlerteTub 	 = va_GTC_NICE_in.LongAlerteTub;
	vl_AdresseAlerteTub 	 = va_GTC_NICE_in.AdresseAlerteTub;
	
	
	
	/*!
	** XZST_03EcritureTrace( XZSTC_INTERFACE,"IN : XZAO166_Ajouter_GTC_NICE : Nom = %s\tNomMachine = %s\tLITOR = %d\tAITOR = %d\tLETOR = %d\tAETOR = %d\tLTeleal = %d\tATeleal = %d\tLTelecomEch = %d\tATelecomEch = %d\tLTelecomTub = %d\tATelecomTub = %d\tLTelesigEch = %d\tATelesigEch = %d\tLTelesigTub = %d\tATelesigmTub = %d\tLSeqEch = %d\tASeqEch = %d\tLSeqTub = %d\tASeqTub = %d\n",
			va_GTC_NICE_in.Nom,
			va_GTC_NICE_in.NomMachine,
			va_GTC_NICE_in.LongueurITOR,
			va_GTC_NICE_in.AdresseITOR,
			va_GTC_NICE_in.LongueurETOR,
			va_GTC_NICE_in.AdresseETOR,
			va_GTC_NICE_in.LongTelealarme,
			va_GTC_NICE_in.AdresseTelealarme,
			va_GTC_NICE_in.LongTelecomEch,
			va_GTC_NICE_in.AdresseTelecomEch,
			va_GTC_NICE_in.LongTelecomTub,
			va_GTC_NICE_in.AdresseTelecomTub,
			va_GTC_NICE_in.LongTelesignEch,
			va_GTC_NICE_in.AdresseTelesignEch,
			va_GTC_NICE_in.LongTelesignTub,
			va_GTC_NICE_in.AdresseTelesignTub,
			va_GTC_NICE_in.LongSeqEch,
			va_GTC_NICE_in.AdresseSeqEch,
			va_GTC_NICE_in.LongSeqTub,
			va_GTC_NICE_in.AdresseSeqTub );
	...
	*/
	...
	{
	 	XZST_03EcritureTrace(XZSTC_WARNING,"xzao166: ct_cmd_alloc() a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO166_Ajouter_GTC_NICE retourne %d", retcode);
		free(Tab_donnees2);
		return (XDC_NOK);
	}
	...
	*/
	...
	{
		XZST_03EcritureTrace(XZSTC_WARNING,"xzao166: ct_command() a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO166_Ajouter_GTC_NICE retourne %d", retcode);
	...
	*/
	...
	{
    	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao166: asql_ctparam_char_input() a echoue");
	   XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO166_Ajouter_GTC_NICE retourne %d", retcode);
	   asql_clean_cmd(connection, cmd);
	   free(Tab_donnees2);
	   return (XDC_NOK);
	...
	{
    	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao166: asql_ctparam_char_input(Nom) a echoue");
	   XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO166_Ajouter_GTC_NICE retourne %d", retcode);
	   asql_clean_cmd(connection, cmd);
	   free(Tab_donnees2);
	   return (XDC_NOK);
	...
	{
    	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao166: asql_ctparam_char_input(NomMachine) a echoue");
	   XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO166_Ajouter_GTC_NICE retourne %d", retcode);
	   asql_clean_cmd(connection, cmd);
	   free(Tab_donnees2);
	   return (XDC_NOK);
	...
	{
	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao166: asql_ctparam_int_output(Resultat) a echoue "); 
	   XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO166_Ajouter_GTC_NICE retourne %d", retcode);
	   asql_clean_cmd(connection, cmd);
	   free(Tab_donnees2);
	   return (XDC_NOK);
	...
	*/
	...
	{
		XZST_03EcritureTrace(XZSTC_WARNING,"xzao166: ct_send() a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO166_Ajouter_Aire retourne %d", retcode);
		asql_clean_cmd(connection, cmd);
	   	free(Tab_donnees2);
	   	return (XDC_NOK);
	}
				...
				*/
				switch ((int)res_type)
				{
					case  CS_ROW_RESULT:
						...
						XZST_03EcritureTrace(XZSTC_INFO,"xzao166: ROW RESULTS");
						break;

					case  CS_PARAM_RESULT:
						retcode = asql_fetch_param_result (cmd , num_Tab_donnees2, Tab_donnees2);
						XZST_03EcritureTrace(XZSTC_INFO,"xzao166 : PARAMETER RESULTS\n");
						break;

					case  CS_STATUS_RESULT:
						retcode = asql_fetch (cmd, &SPstatus);
						XZST_03EcritureTrace(XZSTC_INFO,"xzao166 : CS_STATUS_RESULT = %ld", retcode);
						XZST_03EcritureTrace(XZSTC_INFO,"xzao166 : STATUS RESULT PROCEDURE STOCKEE = %ld", SPstatus);
						
						if (SPstatus != XDC_OK)
						{
						   XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO166_Ajouter_GTC_NICE retourne 1");
 						   asql_clean_cmd(connection, cmd);
	   					   free(Tab_donnees2);
	   					   return (XDC_NOK);
						}
				...
				if (retcode != CS_SUCCEED)
                                {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao166 : asql_fetch_* a echoue");
                                        XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO166_Ajouter_GTC_NICE retourne %d", retcode);
                                        asql_clean_cmd(connection, cmd);
	   				free(Tab_donnees2);
	   				return (XDC_NOK);
				...
				case CS_MSG_RESULT:
					...
					*/
					...
					if (retcode != CS_SUCCEED)
					{
						XZST_03EcritureTrace(XZSTC_WARNING,"xzao166: ct_res_info(msgtype) a echoue");
						XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO166_Ajouter_GTC_NICE retourne %d", retcode);
						asql_clean_cmd(connection, cmd);
	   					free(Tab_donnees2);
	   					return (XDC_NOK);
					...
					XZST_03EcritureTrace(XZSTC_INFO,"xzao166 : ct_result retourne CS_MSG_RESULT l id du message est : %d.\n", msg_id);
					break;
				...
				case CS_CMD_SUCCEED:
					...
					*/
					XZST_03EcritureTrace(XZSTC_INFO,"xzao166 : CS_CMD_SUCCEED \n");
					break;
				...
				case CS_CMD_DONE:
					...
					*/
					XZST_03EcritureTrace(XZSTC_INFO,"xzao166 : CS_CMD_DONE \n");
					break;
				...
				case CS_CMD_FAIL:
					...
					*/
					XZST_03EcritureTrace(XZSTC_WARNING,"xzao166: ct_results retourne CS_CMD_FAIL.");
					XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO166_Ajouter_GTC_NICE retourne %d", retcode);
					asql_clean_cmd(connection, cmd);
	   				free(Tab_donnees2);
	   				return (XDC_NOK);
				...
				default:
					...
					*/
					XZST_03EcritureTrace(XZSTC_WARNING,"xzao166: ct_results retourne un resultat de type inattendu");
					XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO166_Ajouter_GTC_NICE retourne %d", retcode);
					asql_clean_cmd(connection, cmd);
	   				free(Tab_donnees2);
	   				return (XDC_NOK);
