/*E*/
/* Fichier : $Id: xzao179.c,v 1.5 2018/10/26 15:13:04 devgfi Exp $        $Revision: 1.5 $        $Date: 2018/10/26 15:13:04 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao179.c
------------------------------------------------------
...
static char *version = "$Id: xzao179.c,v 1.5 2018/10/26 15:13:04 devgfi Exp $ : xzao179" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des Capteurs de Tunnels et
...
int xzao179_Lire_Config_Capteurs_Tunnel ( 	FILE  		*pa_Fd,
...
*       XZAOT_ConfCaptTun 	contenu de ligne
*       XDY_Entier 		NumLigne
...
{
   static char *version = "$Id: xzao179.c,v 1.5 2018/10/26 15:13:04 devgfi Exp $ : xzao179_Lire_Config_Capteurs_Tunnel" ;
   
   XZAOT_ConfCaptTun	vl_CaptTun;
   char			vl_Lig[255];
   char			*vl_Texte;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao179: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao179 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao179 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             
             strcpy ( vl_CaptTun.NomCapteur, vl_Texte_out );
             ...
             strcpy ( vl_CaptTun.Autoroute, vl_Texte_out );
             ...
             strcpy ( vl_CaptTun.NomTube, vl_Texte_out );
             ...
             vl_CaptTun.PR = atoi ( vl_Texte_out );
             ...
             vl_CaptTun.Sens = atoi ( vl_Texte_out );
             ...
             vl_CaptTun.Type = atoi ( vl_Texte_out );
             ...
             vl_CaptTun.NumBit = atoi ( vl_Texte_out );
             ...
             vl_CaptTun.NumAlerte = atoi ( vl_Texte_out );
             ...
             vl_CaptTun.Supprime = atoi ( vl_Texte_out );
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_CaptTun, vl_num_ligne ) ) != XDC_OK )
                {    
                   XZST_03EcritureTrace(XZSTC_WARNING,"xzao179 : appel de FonctionUtilisateur s'est mal deroule");
                   return ( XDC_NOK );
                }  
	     } 
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao179: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
