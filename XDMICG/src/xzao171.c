/*E*/
/*Fichier : $Id: xzao171.c,v 1.3 2016/07/13 12:43:09 devgfi Exp $      Release : $Revision: 1.3 $        Date : $Date: 2016/07/13 12:43:09 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao171.c
------------------------------------------------------
...
static char *version = "$Id: xzao171.c,v 1.3 2016/07/13 12:43:09 devgfi Exp $ : xzao171" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des Sequences Autorisees des echangeurs et
...
int xzao171_Lire_Config_SeqAut_Echangeur ( FILE  		*pa_Fd,
...
{
   static char *version = "$Id: xzao171.c,v 1.3 2016/07/13 12:43:09 devgfi Exp $ : xzao171_Lire_Config_SeqAut_Echangeur" ;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao171: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao171 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao171 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                {    
                   XZST_03EcritureTrace(XZSTC_WARNING,"xzao171 : appel de FonctionUtilisateur s'est mal deroule");
                   return ( XDC_NOK );
                }  
	     } 
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao171: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
