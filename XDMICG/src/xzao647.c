/*E*/
/*Fichier :  $Id: xzao647.c,v 1.2 2010/12/06 19:18:06 gesconf Exp $      Release : $Revision: 1.2 $        Date : $Date: 2010/12/06 19:18:06 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-LTNTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao647.c
------------------------------------------------------
...
static char *version = "@(#)xzao647.c    1.1 09/26/07 : xzao647" ;
...
int xzao647_Lire_Config_LTN ( FILE            *pa_Fd,
...
* ARGUMENTS EN SORTIE :    
*
* XDY_Entier       *pa_Resultat : OK = NULL ou ligne de l'erreur du locaux technqiues
*
* CODE RETOUR :
*
* 0    XDC_OK
...
*       XZAOT_ConfLTN     contenu de ligne
*       XDY_Entier        NumLigne
...
{
    static char *version = "@(#)xzao647.c    1.1 09/26/07 : xzao647_Lire_Config_LTN" ;

    XZAOT_ConfLTN    vl_LTN;
    char             vl_Lig[255];
    char             *vl_Texte;
    ...
    */
    ...
    if (pa_Fd == NULL)
    {
        XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao647: fichier non existant");
        return ( XDC_NOK );
    }
            ...
            */
            ...
            if (vl_retcode != XDC_OK)
            {
                ...
                */
                ...
                {  
                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao647 : Saisie  non valide");
                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao647 : retourne %d",XDC_NOK);
                    return ( XDC_NOK );
                }
                ...
                */
                ...
                else
                {
                    ...
                    */
                    XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao647: echec de l'appel de la fonction utilisateur");
                    return ( XDC_NOK );
                }
            }
        }
...
/* Fin de la fonction xzao647_Lire_Config_LTN */
