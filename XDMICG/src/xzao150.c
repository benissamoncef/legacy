/*E*/
/*Fichier : $Id: xzao150.c,v 1.4 2016/07/13 12:43:08 devgfi Exp $      Release : $Revision: 1.4 $        Date : $Date: 2016/07/13 12:43:08 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao150.c
------------------------------------------------------
...
static char *version = "$Id: xzao150.c,v 1.4 2016/07/13 12:43:08 devgfi Exp $ : xzao150" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des Portails et
...
int xzao150_Lire_Config_Portail (FILE  		*pa_Fd,
...
*       XZAOT_ConfPortail1 	contenu de ligne
*       XDY_Entier 		NumLigne
...
{
   static char *version = "$Id: xzao150.c,v 1.4 2016/07/13 12:43:08 devgfi Exp $ : xzao150_Lire_Config_Portail" ;
   
   XZAOT_ConfPortail	vl_Portail;
   char			vl_Lig[255];
   char			*vl_Texte;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao150: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao150 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao150 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             
             vl_Portail.Creation = atoi ( vl_Texte_out );
             ...
             strcpy ( vl_Portail.NomPortion, vl_Texte_out );
             ...
             sscanf ( vl_Texte_out, "%d", &vl_Portail.PR );
             ...
             vl_Portail.Sens = atoi ( vl_Texte_out );
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_Portail, vl_num_ligne ) ) != XDC_OK )
                {    
             ...
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao150: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
