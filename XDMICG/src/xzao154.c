/*E*/
/*Fichier : $Id: xzao154.c,v 1.3 2016/07/13 12:43:08 devgfi Exp $      Release : $Revision: 1.3 $        Date : $Date: 2016/07/13 12:43:08 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYScenarioEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao154.c
------------------------------------------------------
...
static char *version = "$Id: xzao154.c,v 1.3 2016/07/13 12:43:08 devgfi Exp $ : xzao154" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des scenarios NAV et
...
int xzao154_Lire_Config_Scenarios ( 	FILE  		*pa_Fd,
...
{
   static char *version = "$Id: xzao154.c,v 1.3 2016/07/13 12:43:08 devgfi Exp $ : xzao154_Lire_Config_Scenarios" ;
   
   XZAOT_ConfScenario	vl_Scenario;
   char			vl_Lig[255];
   char			*vl_Texte;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao154: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao154 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao154 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             
             vl_Scenario.Creation = atoi ( vl_Texte_out );
             ...
             strcpy ( vl_Scenario.Scenario, vl_Texte_out );
             ...
             strcpy ( vl_Scenario.Nom, vl_Texte_out );
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_Scenario, vl_num_ligne ) ) != XDC_OK )
                {    
             ...
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao154: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
