/*E*/
/*Fichier : $Id: xzao825.c,v 1.1 2017/02/10 09:01:17 pc2dpdy Exp $      Release : $Revision: 1.1 $        Date :  $Date: 2017/02/10 09:01:17 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao825.c
------------------------------------------------------
...
#include "xzao.h"
#include "xzao825.h"
static char *version = "$Id: xzao825.c,v 1.1 2017/02/10 09:01:17 pc2dpdy Exp $ $Revision: 1.1 $ $Date: 2017/02/10 09:01:17 $ : xzao825.c" ;
...
int XZAO825_Rechercher_les_PMV_SAGA_ds_pert (	XDY_Autoroute	va_autoroute_in,
						XDY_Sens	va_sens_in,
						XDY_PR		va_pr_in,
...
{
	CS_CHAR *rpc_name = XZAOC_XZAO825_RPC_NAME;
	CS_CONTEXT      *context;
	...
	*/
	...
	XZST_03EcritureTrace( XZSTC_INTERFACE,"IN : XZAO825_Rechercher_les_PMV_SAGA_ds_pert aut=%d, sens = %d,PR=%d, PR tete=%d, Dmax=%d, Dmaxbifurc=%d,PR bifamont=%d,PR bifamont tete=%d,aut bifamont=%d,aut bifamont tete=%d, PR deb bifamont=%d, PR deb bifamont tete=%d",
						va_autoroute_in,
						va_sens_in,
						va_pr_in,
						va_pr_tete_in,
	...
	*/
	...
	{
	 	XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: ct_cmd_alloc() a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
	...
	*/
	...
	{
		XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: ct_command() a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
		asql_clean_cmd(connection, cmd);
		return (XDC_NOK);
	}
	...
	*/
	...
	{
    	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: asql_ctparam_tinyint_input(va_Autoroute_in) a echoue");
	   XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
	   asql_clean_cmd(connection, cmd);
	   return (XDC_NOK);
	}
	...
	{
	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: asql_ctparam_tinyint_input(va_Sens_in) a echoue");
           XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
  	   asql_clean_cmd(connection, cmd);
	   return (XDC_NOK);
        }
	...
	{
	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: asql_ctparam_int_input(va_distance_in) a echoue");
           XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
  	   asql_clean_cmd(connection, cmd);
	   return (XDC_NOK);
        }
	...
	{
	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: asql_ctparam_int_input(va_Dmax_bifurc_in) a echoue");
           XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
  	   asql_clean_cmd(connection, cmd);
	   return (XDC_NOK);
        }
	...
	{
	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: asql_ctparam_int_input(va_pr_bifamont_in) a echoue");
           XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
  	   asql_clean_cmd(connection, cmd);
	   return (XDC_NOK);
        }
	...
	{
	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: asql_ctparam_int_input(va_pr_bifamont_tete_in) a echoue");
           XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
  	   asql_clean_cmd(connection, cmd);
	   return (XDC_NOK);
        }
	...
	{
	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: asql_ctparam_tinyint_input(va_aut_bifamont_in) a echoue");
           XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
  	   asql_clean_cmd(connection, cmd);
	   return (XDC_NOK);
        }
	...
	{
	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: asql_ctparam_tinyint_input(va_aut_bifamont_tete_in) a echoue");
           XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
  	   asql_clean_cmd(connection, cmd);
	   return (XDC_NOK);
        }
	...
	{
	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: asql_ctparam_int_input(va_pr_debut_bifamont_in) a echoue");
           XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
  	   asql_clean_cmd(connection, cmd);
	   return (XDC_NOK);
        }
	...
	{
	   XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: asql_ctparam_int_input(va_pr_debut_bifamont_tete_in) a echoue");
           XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
  	   asql_clean_cmd(connection, cmd);
	   return (XDC_NOK);
        }
	...
	*/
	...
	{
		XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: ct_send() a echoue");
		XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
		asql_clean_cmd(connection, cmd);
		return (XDC_NOK);
	}
				...
				*/
				switch ((int)res_type)
				{
					case  CS_ROW_RESULT:
						...
						XZST_03EcritureTrace(XZSTC_INFO,"xzao825: ROW RESULTS");
						break;

					case  CS_PARAM_RESULT:
						XZST_03EcritureTrace(XZSTC_INFO,"xzao825 : PARAMETER RESULTS");
						break;

					case  CS_STATUS_RESULT:
						retcode = asql_fetch (cmd, &SPstatus);
						XZST_03EcritureTrace(XZSTC_INFO,"xzao825 : CS_STATUS_RESULT = %d", retcode);
						XZST_03EcritureTrace(XZSTC_INFO,"xzao825 : STATUS REUSULT PROCEDURE STOCKEE = %d", SPstatus);
				...
				case CS_MSG_RESULT:
					...
					*/
					...
					{
						XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: ct_res_info(msgtype) a echoue");
						XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
						asql_clean_cmd(connection, cmd);
						return (XDC_NOK);
					}
				...
				case CS_CMD_SUCCEED:
					...
					*/
					XZST_03EcritureTrace(XZSTC_INFO,"xzao825: ct_results retourne CS_CMD_SUCCEED.");
					break;
				...
				case CS_CMD_DONE:
					...
					*/
					XZST_03EcritureTrace(XZSTC_INFO,"xzao825: ct_results retourne CS_CMD_DONE.");
					break;
				...
				case CS_CMD_FAIL:
					...
					*/
					XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: ct_results retourne CS_CMD_FAIL.");
					XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
					asql_clean_cmd(connection, cmd);
					return (XDC_NOK);
				...
				default:
					...
					*/
					XZST_03EcritureTrace(XZSTC_WARNING,"xzao825: ct_results retourne un resultat de type inattendu");
					XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO825_Rechercher_les_PMV_SAGA_ds_pert retourne %d", retcode);
					asql_clean_cmd(connection, cmd);
					return (XDC_NOK);
				}
	...
	*va_Resultat_out = 0;
	...
	XZST_03EcritureTrace(XZSTC_INFO,"xzao825 : nb de PMV = %d",vl_Nb_Ligne_Lue);
