/*E*/
/*Fichier :  $Id: xzao640.c,v 1.2 2010/12/06 19:18:04 gesconf Exp $      Release : $Revision: 1.2 $        Date : $Date: 2010/12/06 19:18:04 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao640.c
------------------------------------------------------
...
static char *version = "@(#)xzao640.c    1.1 09/26/07 : xzao640" ;
...
int xzao640_Lire_Config_SIG ( FILE            *pa_Fd,
...
*       XZAOT_ConfSIG     contenu de ligne
*       XDY_Entier        NumLigne
...
{
    static char *version = "@(#)xzao640.c    1.1 09/26/07 : xzao640_Lire_Config_SIG" ;

    XZAOT_ConfSIG    vl_SIG;
    char             vl_Lig[255];
    char             *vl_Texte;
    ...
    */
    ...
    if (pa_Fd == NULL)
    {
        XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao640: fichier non existant");
        return ( XDC_NOK );
    }
            ...
            */
            ...
            if (vl_retcode != XDC_OK)
            {
                ...
                */
                ...
                {  
                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao640 : Saisie  non valide");
                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao640 : retourne %d",XDC_NOK);
                    return ( XDC_NOK );
                }

                strcpy ( vl_SIG.NomSIG, vl_Texte_out );
                ...
                strcpy ( vl_SIG.Autoroute, vl_Texte_out );
                ...
                strcpy ( vl_SIG.NomServeur, vl_Texte_out );
                ...
                vl_SIG.AdresseEtat = atoi ( vl_Texte_out );
                ...
                vl_SIG.AdresseCommande = atoi ( vl_Texte_out );
                ...
                vl_SIG.AdresseDiscordance = atoi ( vl_Texte_out );
                ...
                vl_SIG.AdresseTelealarme = atoi ( vl_Texte_out );
                ...
                */
                ...
                if (pa_FonctionUtil != NULL)
                {
                    ...
                    */
                    if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_SIG, vl_num_ligne ) ) != XDC_OK )
                    {    
                ...
                else
                {
                    ...
                    */
                    XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao640: echec de l'appel de la fonction utilisateur");
                    return ( XDC_NOK );
                }
            }
        }
...
/* Fin de la fonction xzao640_Lire_Config_SIG */
