/*E*/
/*Fichier : $Id: xzao433.c,v 1.3 2018/02/09 15:20:27 devgfi Exp $     Release : $Revision: 1.3 $        Date : $Date: 2018/02/09 15:20:27 $
------------------------------------------------------
* STERIA *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao433.c
------------------------------------------------------
...
static char *version = "$Id: xzao433.c,v 1.3 2018/02/09 15:20:27 devgfi Exp $ $Revision: 1.3 $ $Date: 2018/02/09 15:20:27 $ : xzao433" ;
...
int xzao433_Lire_Config_Zon_BAF ( 	FILE  		*pa_Fd,
...

{
   ...
   char			vl_autoroute_baf[10];
   XDY_PR		vl_pr_baf;
   XDY_Sens		vl_sens_baf;
   char			vl_site_baf[10];
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao433: fichier non existant");
     return ( XDC_NOK );
   }
       ...
       */
       ...
       { 
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : Saisie Autoroute PMV non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
	     strcpy(vl_autoroute_baf, vl_Texte_out);
              
             vl_Texte = strtok ( NULL, XZAO_TAB_SEPAR );
             if ( ( vl_retcode = XZAO000_Verif_Coherence_Nombre ( vl_Texte, XZAO_LONG_UCHAR, vl_Texte_out ) ) != XDC_OK )
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : Saisie sens PMV non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             vl_sens_baf = atoi ( vl_Texte_out ); 
              
             
             vl_Texte = strtok ( NULL, XZAO_TAB_SEPAR );
             if ( ( vl_retcode = XZAO000_Verif_Coherence_Nombre ( vl_Texte, XZAO_LONG_LONG, vl_Texte_out ) ) != XDC_OK )
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : Saisie PR PMV non valide <%s>", vl_Texte);
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             vl_pr_baf= atoi ( vl_Texte_out );
              
             
             vl_Texte = strtok ( NULL, XZAO_TAB_SEPAR );
             if ( ( vl_retcode = XZAO000_Verif_Coherence_String ( vl_Texte, XDC_Lon_Nom - 1, vl_Texte_out ) ) != XDC_OK )
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : Saisie site baf non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
	     strcpy(vl_site_baf,vl_Texte_out);
                           
             
             vl_Texte = strtok ( NULL, XZAO_TAB_SEPAR );
             if ( ( vl_retcode = XZAO000_Verif_Coherence_String ( vl_Texte, 11, vl_Texte_out ) ) != XDC_OK )
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : Saisie autoroute zone  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
	     strcpy(vl_autoroute_zone, vl_Texte_out);
             ...
             if ( ( vl_retcode = XZAO000_Verif_Coherence_Nombre ( vl_Texte, XZAO_LONG_UCHAR , vl_Texte_out ) ) != XDC_OK )
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : Saisie sens zone non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
	     vl_sens_zone = atoi ( vl_Texte_out );
             ...
             if ( ( vl_retcode = XZAO000_Verif_Coherence_Nombre ( vl_Texte, XZAO_LONG_LONG, vl_Texte_out ) ) != XDC_OK )
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : Saisie pr debut zone non valide <%s>", vl_Texte);
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
	     vl_debut_zone = atoi ( vl_Texte_out );
             ...
             if ( ( vl_retcode = XZAO000_Verif_Coherence_Nombre ( vl_Texte, XZAO_LONG_LONG, vl_Texte_out ) ) != XDC_OK )
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : Saisie PR fin zone non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : Saisie Inhibition non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_autoroute_baf
							  ,vl_sens_baf
							  ,vl_pr_baf
							  ,vl_site_baf
							  ,vl_autoroute_zone
							  ...
							  , vl_num_ligne ) ) != XDC_OK )
                {    
                   XZST_03EcritureTrace(XZSTC_WARNING,"xzao433 : appel de FonctionUtilisateur s'est mal deroule");
                   return ( XDC_NOK );
                }  
	     } 
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao433: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
