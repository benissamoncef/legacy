/*E*/
/*Fichier : $Id: xzao91.c,v 1.4 2016/07/13 12:43:17 devgfi Exp $      Release : $Revision: 1.4 $        Date : $Date: 2016/07/13 12:43:17 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao91.c
------------------------------------------------------
...
static char *version = "$Id: xzao91.c,v 1.4 2016/07/13 12:43:17 devgfi Exp $ : xzao91" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des reseaux et
...
int xzao91_Lire_Config_Reseau ( FILE 		*pa_Fd,
...
*       XZAOT_ConfReseau 	contenu de ligne
*       XDY_Entier 		NumLigne
...
{
   static char *version = "$Id: xzao91.c,v 1.4 2016/07/13 12:43:17 devgfi Exp $ : xzao91_Lire_Config_Reseau" ;
   
   XZAOT_ConfReseau	vl_Reseau;
   char			vl_Lig[255];
   char			*vl_Texte;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao91: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao91 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao91 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             
             vl_Reseau.Creation = atoi ( vl_Texte_out );
             ...
             strcpy ( vl_Reseau.NomReseau, vl_Texte_out );
             ...
             vl_Reseau.TypeReseau = atoi ( vl_Texte_out );
             ...
             strcpy ( vl_Reseau.Autoroute, vl_Texte_out );
             ...
             sscanf ( vl_Texte_out, "%d", &vl_Reseau.PR );
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_Reseau, vl_num_ligne ) ) != XDC_OK )
                {    
             ...
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao91: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
...
/* Fin de la fonction xzao91_Lire_Config_Reseau */
