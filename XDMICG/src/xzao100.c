/*E*/
/*Fichier : $Id: xzao100.c,v 1.3 2016/07/13 12:43:03 devgfi Exp $      Release : $Revision: 1.3 $        Date : $Date: 2016/07/13 12:43:03 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao100.c
------------------------------------------------------
...
static char *version = "$Id: xzao100.c,v 1.3 2016/07/13 12:43:03 devgfi Exp $ : xzao100" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des points de mesure et
...
int xzao100_Lire_Config_Pt_Mesure ( 	FILE  		*pa_Fd,
...
*       XZAOT_ConfPtMes 	contenu de ligne
*       XDY_Entier 		NumLigne
...
{
   static char *version = "$Id: xzao100.c,v 1.3 2016/07/13 12:43:03 devgfi Exp $ : xzao100_Lire_Config_PtMes" ;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao100: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao100 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao100 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             
             vl_PtMes.Creation = atoi ( vl_Texte_out );
             ...
             strcpy ( vl_PtMes.NomStation, vl_Texte_out );
             ...
             vl_PtMes.Sens = atoi ( vl_Texte_out );
             ...
             vl_PtMes.Boucle = atoi ( vl_Texte_out );
             ...
             vl_PtMes.BoucleInv = atoi ( vl_Texte_out );
             ...
             vl_PtMes.Voie = atoi ( vl_Texte_out );
             ...
             vl_PtMes.Poids = atoi ( vl_Texte_out );
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_PtMes, vl_num_ligne ) ) != XDC_OK )
                {    
             ...
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao100: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
...
/* Fin de la fonction xzao100_Lire_Config_PtMes_Station */
