/*E*/
/*Fichier : $Id: xzao93.c,v 1.3 2016/07/13 12:43:17 devgfi Exp $      Release : $Revision: 1.3 $        Date : $Date: 2016/07/13 12:43:17 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao93.c
------------------------------------------------------
...
static char *version = "$Id: xzao93.c,v 1.3 2016/07/13 12:43:17 devgfi Exp $ : xzao93" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des villes et
...
int xzao93_Lire_Config_Ville ( 	FILE  		*pa_Fd,
...
*       XZAOT_ConfVille 	contenu de ligne
*       XDY_Entier 		NumLigne
...
{
   static char *version = "$Id: xzao93.c,v 1.3 2016/07/13 12:43:17 devgfi Exp $ : xzao93_Lire_Config_Ville" ;
   
   XZAOT_ConfVille	vl_Ville;
   char			vl_Lig[255];
   char			*vl_Texte;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao93: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao93 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao93 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             
             vl_Ville.Creation = atoi ( vl_Texte_out );
             ...
             strcpy ( vl_Ville.Nom, vl_Texte_out );
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_Ville, vl_num_ligne ) ) != XDC_OK )
                {    
             ...
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao93: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
...
/* Fin de la fonction xzao93_Lire_Config_Ville */
