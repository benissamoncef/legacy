/*E*/
/* Fichier : $Id: xzao197.c,v 1.5 2018/10/26 16:13:23 devgfi Exp $        $Revision: 1.5 $        $Date: 2018/10/26 16:13:23 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao197.c
------------------------------------------------------
...
static char *version = "$Id: xzao197.c,v 1.5 2018/10/26 16:13:23 devgfi Exp $ : xzao197" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des Åquipements gÅnÅrique LCR et
...
int xzao197_Lire_Config_Eqt_Generique_LCR ( 	FILE  		*pa_Fd,
...
*       XZAOT_ConfEqtGenLCR 	contenu de ligne
*       XDY_Entier 		NumLigne
...
{
   static char *version = "$Id: xzao197.c,v 1.5 2018/10/26 16:13:23 devgfi Exp $ : xzao197_Lire_Config_Eqt_Generique_LCR" ;
   
   XZAOT_ConfEqtGenLCR	vl_Eqt;
   char			vl_Lig[255];
   char			*vl_Texte;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao197: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao197 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao197 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             ...
             vl_Eqt.LiaisonMaitre = atoi ( vl_Texte_out );
             ...
             vl_Eqt.LiaisonEsclave = atoi ( vl_Texte_out );
             ...
             strcpy ( vl_Eqt.NomSite, vl_Texte_out );
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                {    
                   XZST_03EcritureTrace(XZSTC_WARNING,"xzao197 : appel de FonctionUtilisateur s'est mal deroule");
                   return ( XDC_NOK );
                }  
	     } 
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao197: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
