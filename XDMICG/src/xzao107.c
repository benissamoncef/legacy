/*E*/
/*Fichier : $Id: xzao107.c,v 1.3 2016/07/13 12:43:06 devgfi Exp $      Release : $Revision: 1.3 $        Date : $Date: 2016/07/13 12:43:06 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao107.c
------------------------------------------------------
...
static char *version = "$Id: xzao107.c,v 1.3 2016/07/13 12:43:06 devgfi Exp $ : xzao107" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des SysVideo et
...
int xzao107_Lire_Config_SystemeVideo ( 	FILE  		*pa_Fd,
...
*       XZAOT_ConfSysVideo 	contenu de ligne
*       XDY_Entier 		NumLigne
...
{
   static char *version = "$Id: xzao107.c,v 1.3 2016/07/13 12:43:06 devgfi Exp $ : xzao107_Lire_Config_SystemeVideo" ;
   
   XZAOT_ConfSyVideo	vl_SysVideo;
   char			vl_Lig[255];
   char			*vl_Texte;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao107: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao107 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao107 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             
             strcpy ( vl_SysVideo.Nom, vl_Texte_out );
             ...
             strcpy ( vl_SysVideo.NomServeur, vl_Texte_out );
             ...
             vl_SysVideo.Liaison = atoi ( vl_Texte_out );
             ...
             strcpy ( vl_SysVideo.RGS, vl_Texte_out );
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_SysVideo, vl_num_ligne ) ) != XDC_OK )
                {    
                   XZST_03EcritureTrace(XZSTC_WARNING,"xzao107 : appel de FonctionUtilisateur s'est mal deroule");
                   return ( XDC_NOK );
                }  
	     } 
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao107: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
