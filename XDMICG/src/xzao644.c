/*E*/
/*Fichier :  $Id: xzao644.c,v 1.2 2010/12/06 19:18:05 gesconf Exp $      Release : $Revision: 1.2 $        Date : $Date: 2010/12/06 19:18:05 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao644.c
------------------------------------------------------
...
static char *version = "@(#)xzao644.c    1.1 09/26/07 : xzao644" ;
...
*    domaine protection incendie et
...
int xzao644_Lire_Config_INC ( FILE            *pa_Fd,
...
*       XZAOT_ConfINC     contenu de ligne
*       XDY_Entier        NumLigne
...
{
    static char *version = "@(#)xzao644.c    1.1 09/26/07 : xzao644_Lire_Config_INC" ;

    XZAOT_ConfINC    vl_INC;
    char             vl_Lig[255];
    char             *vl_Texte;
    ...
    */
    ...
    if (pa_Fd == NULL)
    {
        XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao644: fichier non existant");
        return ( XDC_NOK );
    }
            ...
            */
            ...
            if (vl_retcode != XDC_OK)
            {
                ...
                */
                ...
                {  
                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao644 : Saisie  non valide");
                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao644 : retourne %d",XDC_NOK);
                    return ( XDC_NOK );
                }

                strcpy ( vl_INC.NomINC, vl_Texte_out );
                ...
                strcpy ( vl_INC.Autoroute, vl_Texte_out );
                ...
                strcpy ( vl_INC.NomServeur, vl_Texte_out );
                ...
                vl_INC.AdresseEtat = atoi ( vl_Texte_out );
                ...
                vl_INC.AdresseCommande = atoi ( vl_Texte_out );
                ...
                vl_INC.AdresseDiscordance = atoi ( vl_Texte_out );
                ...
                vl_INC.AdresseTelealarme = atoi ( vl_Texte_out );
                ...
                */
                ...
                if (pa_FonctionUtil != NULL)
                {
                    ...
                    */
                    if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_INC, vl_num_ligne ) ) != XDC_OK )
                    {    
                ...
                else
                {
                    ...
                    */
                    XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao644: echec de l'appel de la fonction utilisateur");
                    return ( XDC_NOK );
                }
            }
        }
...
/* Fin de la fonction xzao644_Lire_Config_INC */
