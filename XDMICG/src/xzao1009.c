/*E*/
/*Fichier :  $Id: xzao1009.c,v 1.5 2018/02/09 15:17:19 devgfi Exp $      Release : $Revision: 1.5 $        Date : $Date: 2018/02/09 15:17:19 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao1009.c
------------------------------------------------------
...
static char *version = "$Id: xzao1009.c,v 1.5 2018/02/09 15:17:19 devgfi Exp $ : xzao1009" ;
...
int xzao1009_Lire_Config_Eht ( FILE             *pa_Fd,
...
*       XZAOT_ConfEHTG     contenu de ligne
*       XDY_Entier         NumLigne
...
{
	static char *version = "$Id: xzao1009.c,v 1.5 2018/02/09 15:17:19 devgfi Exp $ : xzao1009_Lire_Config_Eht" ;
   
    XZAOT_ConfEHTG   vl_Eht;
    char             vl_Lig[255];
    char             *vl_Texte;
    ...
    */
    ...
    if (pa_Fd == NULL)
    {
        XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao1009: fichier non existant");
        return ( XDC_NOK );
    }
            ...
            */
            ...
            
            {
                ...
                */
                ...
                {  
                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao1009 : Saisie  non valide");
                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao1009 : retourne %d",XDC_NOK);
                    return ( XDC_NOK );
                }
             
                strcpy ( vl_Eht.NomEht, vl_Texte_out );
                ...
                strcpy ( vl_Eht.Autoroute, vl_Texte_out );
                ...
                strcpy ( vl_Eht.NomServeur, vl_Texte_out );
                ...
                vl_Eht.PRInfluence = atoi ( vl_Texte_out );
                ...
                vl_Eht.AdresseEtat = atoi ( vl_Texte_out );
                ...
                vl_Eht.AdresseCommande = atoi ( vl_Texte_out );
                ...
                vl_Eht.AdresseDiscordance = atoi ( vl_Texte_out );
                ...
                vl_Eht.AdresseTelealarme = atoi ( vl_Texte_out );
                ...
                */
                ...
                if (pa_FonctionUtil != NULL)
                {
                    ...
                    */
                    ...
                    if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_Eht, vl_num_ligne ) ) != XDC_OK )
                    {    
                ...
                else
                {
                    ...
                    */
                    ...
                    XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao1009: echec de l'appel de la fonction utilisateur");
                    return ( XDC_NOK );
                }
            }
        }
...
/* Fin de la fonction xzao1009_Lire_Config_Eht */
