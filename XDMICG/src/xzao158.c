/*E*/
/*Fichier : $Id: xzao158.c,v 1.3 2016/07/13 12:43:08 devgfi Exp $      Release : $Revision: 1.3 $        Date : $Date: 2016/07/13 12:43:08 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao158.c
------------------------------------------------------
...
static char *version = "$Id: xzao158.c,v 1.3 2016/07/13 12:43:08 devgfi Exp $ : xzao158" ;
...
* SERVICE RENDU : 
*
*    Lit le fichier de configuration des Scenarios Connus et
...
int xzao158_Lire_Config_Scen_Connus ( 	FILE  		*pa_Fd,
...
*       XZAOT_ConfScenCn 	contenu de ligne
*       XDY_Entier 		NumLigne
...
{
   static char *version = "$Id: xzao158.c,v 1.3 2016/07/13 12:43:08 devgfi Exp $ : XZAO158_Lire_Config_Scen_Connus" ;
   
   XZAOT_ConfScenCn	vl_ScenCn;
   char			vl_Lig[255];
   char			*vl_Texte;
   ...
   */
   ...
   if (pa_Fd == NULL)
   {
     XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao158: fichier non existant");
     return ( XDC_NOK );
   }
          ...
          */
...

          {
             ...
             */
             ...
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao158 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao158 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             }
             
             vl_ScenCn.Creation = atoi ( vl_Texte_out );
              
             
             
             vl_Texte = strtok ( NULL, XZAO_TAB_SEPAR );
             
             if ( ( vl_retcode = XZAO000_Verif_Coherence_String ( vl_Texte, XDC_Lon_Scenario, vl_Texte_out ) ) != XDC_OK )
             {  
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao158 : Saisie  non valide");
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao158 : retourne %d",XDC_NOK);
                return ( XDC_NOK );
             ...
             strcpy ( vl_ScenCn.Scenario, vl_Texte_out );
             ...
             strcpy ( vl_ScenCn.NomType, vl_Texte_out );
             ...
             vl_ScenCn.AutoFichier = atoi ( vl_Texte_out );
             ...
             */
             ...
             if (pa_FonctionUtil != NULL)
             {
                ...
                */
                ...
                if ( (vl_retcode = ( *pa_FonctionUtil ) ( vl_ScenCn, vl_num_ligne ) ) != XDC_OK )
                {    
             ...
             else
             {
                ...
                */
                ...
                XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao158: echec de l'appel de la fonction utilisateur");
                return ( XDC_NOK );
             }
          }
       }
