/*E*/
/*Fichier :  $Id: xzao2031.c,v 1.2 2020/11/03 17:57:10 pc2dpdy Exp $      Release : $Revision: 1.2 $        Date : $Date: 2020/11/03 17:57:10 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao2031.c
------------------------------------------------------
...
* HISTORIQUE :
*
* AAZ         09 Nov 1994     : Creation DEM 662
* LCL	23/06/2020		: MOVIS DEM-SAE93
* PNI   19/12/2023      : Parcours de XDY_NomEqt sur XDC_Lon_Nom au lieu de XDC_Lon_NomEqt SAE-563
------------------------------------------------------*/
...
static char *version = "@(#)xzao2031.c    1.1 11/09/07 : xzao2031.c" ;
...
int XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE ( XDY_Basedd                    va_Basedd_in,
...

{
    ...
    static char         *version = "@(#)xzao2031.c    1.10 01/22/98 : XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE" ;
    
    CS_CHAR             *rpc_name = XZAOC_XZAO2031_RPC_NAME;
    CS_CONTEXT          *context;
    ...
    CS_INT              res_type;
    CS_SMALLINT         msg_id;
/*    int                 num_Tab_donnees2 = XZAOC_XZAO2031_NB_PARM_RETURN;
*/
    int                 num_Tab_donnees2 = 2;
    tg_Colonne_donnees2 Tab_donnees2[XZAOC_XZAO2031_NB_PARM_RETURN];
    ...
    */
    ...
    XZST_03EcritureTrace( XZSTC_WARNING,"IN : XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE : Basedd = %s\tMachine = %s",
            va_Basedd_in,
            va_NomMachine_in );
    ...
    */
    ...
    {
         XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031: ct_cmd_alloc() a echoue");
        XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE retourne %d", retcode);
    ...
    */
    ...
    {
        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031: ct_command() a echoue");
        XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE retourne %d", retcode);
        asql_clean_cmd(connection, cmd);
        return (XDC_NOK);
    }
    ...
    */
    ...
    {
           XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031: asql_ctparam_char_input(Basedd) a echoue");
       XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE retourne %d", retcode);
       asql_clean_cmd(connection, cmd);
       return (XDC_NOK);
    }
    ...
    {
           XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031: asql_ctparam_char_input(NomMachine) a echoue");
       XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE retourne %d", retcode);
       asql_clean_cmd(connection, cmd);
       return (XDC_NOK);
    }
...
*/
    ...
    if ((retcode = asql_ctparam_smallint_output(cmd,(CS_SMALLINT *)&vl_Numero,"@va_Numero_out")) != CS_SUCCEED)    

    {
       XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031: asql_ctparam_smallint_output(Numero) a echoue "); 
       XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE retourne %d", retcode);
       asql_clean_cmd(connection, cmd);
       return (XDC_NOK);
    }
...
*/
    Tab_donnees2[1].pt_value = (CS_VOID *)vl_NomServeur;
    
    if ((retcode = asql_ctparam_char_output(cmd,(CS_CHAR *)vl_NomServeur,"@va_NomServeur_out")) != CS_SUCCEED)    

    {
       XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031: asql_ctparam_char_output(NomServeur) a echoue "); 
       XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE retourne %d", retcode);
       asql_clean_cmd(connection, cmd);
       return (XDC_NOK);
    }
    ...
    */
    ...
    {
        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031: ct_send() a echoue");
        XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE retourne %d", retcode);
        asql_clean_cmd(connection, cmd);
           return (XDC_NOK);
    }
                ...
                */
                switch ((int)res_type)
                {
                    case  CS_ROW_RESULT:
                        ...
                        XZST_03EcritureTrace(XZSTC_INFO,"xzao2031: ROW RESULTS");
                        vl_Resultat = 0;
						   ...
						   case 1 :  for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
	   						     {
	         						...
	         						else
	         						{
	            							...
	            							{
	               								XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurOUV s'est mal deroule");
	               								asql_clean_cmd(connection, cmd);
	   									return (XDC_NOK);
	            							}
	        						}
                            ...
                            case 2 :  
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurSIG est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurSIG s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                                ...
                                */ 
                                ...
                                if (retcode != XDC_OK)
                                {
                                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : asql_fetch_row_result: asql_Free_Tab_Ligne_Results n a pu liberer correctement la memoire");
                                    asql_clean_cmd(connection, cmd);
                                    return (XDC_NOK);
                                }    
                            ...
                            case 3 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */ 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurECL est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurECL s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 4 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */ 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurVEN est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurVEN s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 5 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */ 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurENR est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurENR s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 6 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */ 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurEXP est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurEXP s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 8 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */ 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurSYS est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurSYS s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 9 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */ 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurLTN est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurLTN s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 10 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */ 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurEQTSIG est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurEQTSIG s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 11 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */ 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurEQTECL est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurEQTECL s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 12 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */ 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurEQTVEN est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurEQTVEN s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 13 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */ 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurEQTENR est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurEQTENR s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 14 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */ 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurEQTEXP est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurEQTEXP s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 16 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */ 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurEQTSYS est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurEQTSYS s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 17 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */ 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurEQTLTN est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurEQTLTN s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 18 :
								XZST_03EcritureTrace( XZSTC_WARNING, "XZAO2031 : Recuperation des sequences autorisees SIGNALISATION" );
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    /*B
                                    ...
                                    */
									...
									XZST_03EcritureTrace( XZSTC_WARNING, "XZAO2031 : domaine=%s, typeEqt = %d, numero = %d, numero sequence = %d", 
												vl_SEQ.Domaine, 
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurSeqSIG est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurSeqSIG s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 19 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurSeqECL est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurSeqECL s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 20 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurSeqVEN est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurSeqVEN s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 21 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurSeqENR est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurSeqENR s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 22 :
                                for ( i = 0; i < vl_Nb_Ligne_Lue; i++ )
                                {
                                    ...
                                    */
                                    ...
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurSeqINC est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurSeqINC s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                            ...
                            case 23 :
                                ...
                                {
                                    /*B
                                    ** Remplissage de la structure XZAOT_SeqEXP
                                    ** Appel de la fonction utilisateur FonctionUtilisateurSeqEXP
                                    */
                                    ...
                                    if ( va_FonctionUtilisateurSeqEXP_in == NULL)
                                    {
                                        XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : va_FonctionUtilisateurSeqEXP est nulle");
                                        asql_clean_cmd(connection, cmd);
                                        return (XDC_NOK);
                                    }
                                    else
                                    {
                                        if ( ( retcode = (*va_FonctionUtilisateurSeqEXP_in) ( vl_SEQ, vl_Resultat ) ) != XDC_OK )
                                        {
                                            XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : appel de va_FonctionUtilisateurSeqEXP s'est mal deroule");
                                            asql_clean_cmd(connection, cmd);
                                            return (XDC_NOK);
                                        }
                                    }
                    ...
                    case  CS_PARAM_RESULT:
                        XZST_03EcritureTrace(XZSTC_INFO,"xzao2031 : AVANT FETCH");
                        retcode = asql_fetch_param_result (cmd , num_Tab_donnees2, Tab_donnees2);

                        XZST_03EcritureTrace(XZSTC_INFO,"xzao2031 : PARAMETER RESULTS Avant recopie dans structure Numero = %d serveur = %s",vl_Numero, vl_NomServeur);

			va_GTC_NICE_RENOVEE_out->Numero = vl_Numero;
			strcpy(va_GTC_NICE_RENOVEE_out->NomServeur, vl_NomServeur);

                        XZST_03EcritureTrace(XZSTC_INFO,"xzao2031 : PARAMETER RESULTS Numero = %d serveur = %s",va_GTC_NICE_RENOVEE_out->Numero,va_GTC_NICE_RENOVEE_out->NomServeur);
                        XZST_03EcritureTrace(XZSTC_INFO,"xzao2031 : PARAMETER RESULTS");
                        break;

                    case  CS_STATUS_RESULT:
                        retcode = asql_fetch (cmd, &SPstatus);
                        XZST_03EcritureTrace(XZSTC_INFO,"xzao2031 : CS_STATUS_RESULT = %d", retcode);
                        XZST_03EcritureTrace(XZSTC_INFO,"xzao2031 : STATUS RESULT PROCEDURE STOCKEE = %d", SPstatus);
                        
                        if (SPstatus != XDC_OK)
                        {
                            XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE retourne 1");
                            asql_clean_cmd(connection, cmd);
                            return (XDC_NOK);
                        }
else
XZST_03EcritureTrace(XZSTC_INFO,"xzao2031 : CS_STATUS_RESULT = XDC_OK");
                        break;
                }
            ...
            case CS_MSG_RESULT:
                ...
                */
                ...
                {
                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031: ct_res_info(msgtype) a echoue");
                    XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE retourne %d", retcode);
                    asql_clean_cmd(connection, cmd);
                    return (XDC_NOK);
                }
            ...
            case CS_CMD_FAIL:
                ...
                */
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031: ct_results retourne CS_CMD_FAIL.");
                XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE retourne %d", retcode);
                asql_clean_cmd(connection, cmd);
                return (XDC_NOK);
            ...
            default:
                ...
                */
                XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031: ct_results retourne un resultat de type inattendu");
                XZST_03EcritureTrace(XZSTC_INTERFACE, "OUT : XZAO2031_Liste_Eqt_GTC_NICE_RENOVEE retourne %d", retcode);
                asql_clean_cmd(connection, cmd);
                return (XDC_NOK);
        }
    ...
    ** si il y a lieu
    */ 
XZST_03EcritureTrace(XZSTC_WARNING,"xzao2031 : APRES BOUCLE"); 
    
    /* Modification LINUX64 */
    /* Memoire deja liberee */
    /*
