/*E*/
/*Fichier :  $Id: xzao646.c,v 1.2 2010/12/06 19:18:06 gesconf Exp $      Release : $Revision: 1.2 $        Date : $Date: 2010/12/06 19:18:06 $
------------------------------------------------------
* GTIE *  PROJET MIGRAZUR 
------------------------------------------------------
* SOUS-SYSTEME  BASEDD
------------------------------------------------------
* MODULE XZAO * FICHIER xzao646.c
------------------------------------------------------
...
static char *version = "@(#)xzao646.c    1.1 09/26/07 : xzao646" ;
...
int xzao646_Lire_Config_SYS ( FILE            *pa_Fd,
...
*       XZAOT_ConfSYS     contenu de ligne
*       XDY_Entier        NumLigne
...
{
    static char *version = "@(#)xzao646.c    1.1 09/26/07 : xzao646_Lire_Config_SYS" ;

    XZAOT_ConfSYS    vl_SYS;
    char             vl_Lig[255];
    char             *vl_Texte;
    ...
    */
    ...
    if (pa_Fd == NULL)
    {
        XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao646: fichier non existant");
        return ( XDC_NOK );
    }
            ...
            */
            ...
            if (vl_retcode != XDC_OK)
            {
                ...
                */
                ...
                {  
                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao646 : Saisie  non valide");
                    XZST_03EcritureTrace(XZSTC_WARNING,"xzao646 : retourne %d",XDC_NOK);
                    return ( XDC_NOK );
                }
                ...
                */
                ...
                else
                {
                    ...
                    */
                    XZST_03EcritureTrace(XZSTC_MESSAGE,"xzao646: echec de l'appel de la fonction utilisateur");
                    return ( XDC_NOK );
                }
            }
        }
...
/* Fin de la fonction xzao646_Lire_Config_SYS */
